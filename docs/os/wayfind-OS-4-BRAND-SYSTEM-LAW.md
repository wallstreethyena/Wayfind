...
- **L4 · Show, don't tell.** Surfaces lead with the experience (photo, score, distance, "open now"), copy stays benefit-only. Never explain the algorithm on a user surface. **Guide law (owner, 2026-09-22): a guide sells the event/place/experience, not Wayfind. Do not narrate where the idea came from, reference social posts or roundups, explain the research process, or pitch the product inside guide body copy. Use the space for what the visitor gets: what it is known for, what to expect, what to eat/buy/do, timing, parking, crowd strategy, prices, and practical insider tips. The site should sell itself.** Marketing corollary (owner's lane): show the found-the-spot moment, not the app UI.
