...
| Property | Standard |
| --- | --- |
| Card body height | Every normal place card is exactly 268px — rails and stacked lists. Height does not follow content. |
...
| Card gap | 10px |
| Media, title, padding, score and actions | Existing shared IconicPlaceCard styles. At ≤430px the #1302 compact hierarchy. |
| Loading reservation | Rails and stacked-list skeletons are exactly 268px. Stacked skeletons fill the column with 36% media — never a 178px squat or a 235px list ladder. |
