...
| `where-to-eat.jpg`, `hidden-gems.jpg`, `outdoors.jpg`, `family-fun.jpg` | Existing experience-specific shares (`date-night.jpg` was removed once its only reference turned out to be a misassignment on /hidden-gems) |
...
| `tonight-alfonso-scarpa-unsplash.jpg` | Perfect-for-tonight sheet hero. Photo by Alfonso Scarpa, supplied by the owner from Unsplash; resized to 1800px wide for delivery. |
