...
const S = {
  page: { background: "#0D1117", color: "#E6EDF3", minHeight: "100dvh", padding: "40px 20px 80px", fontFamily: "var(--wf-sans)" },
  ...
  return (
    <div style={S.page}>
      <div style={S.wrap}>
        ...
        <p style={S.p}>Wayfind runs on Vercel and uses Google Maps Platform for places and maps, Supabase for accounts and data, Apple for optional Sign in with Apple authentication, PostHog for analytics, Resend for email, and Stay22 and Travelpayouts for booking-link optimization and affiliate tracking. Stay22&rsquo;s booking-link script runs only on the pages where it has a hotel-search link to optimize, not site-wide; Travelpayouts attribution runs through a server-side redirect link rather than a page script. Each may set a cookie on its own domain to attribute a booking and processes only what is needed to provide the service.</p>
