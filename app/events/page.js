...
export default function Page() {
  return (
    <div style={{ background: "#0D1117", minHeight: "60vh", color: "#CBD5E1", fontFamily: "var(--wf-sans)", padding: "48px 24px", textAlign: "center" }}>
      ...
      <a href="/?go=events" style={{ color: "#CBD5E1", fontWeight: 800, textDecoration: "none" }}>Open in Wayfind ›</a>
      <div style={{ maxWidth: 560, margin: "22px auto 0", textAlign: "left", fontSize: 13.5, color: "#94A3B8", lineHeight: 1.65 }}>
        ...
        <p style={{ marginTop: 10 }}>While you are here: <a href="/guides" style={{ color: "#CBD5E1", fontWeight: 700, textDecoration: "none" }}>local guides</a> · <a href="/culture/orlando" style={{ color: "#CBD5E1", fontWeight: 700, textDecoration: "none" }}>Orlando</a> · <a href="/culture/tampa" style={{ color: "#CBD5E1", fontWeight: 700, textDecoration: "none" }}>Tampa</a> · <a href="/culture/sarasota" style={{ color: "#CBD5E1", fontWeight: 700, textDecoration: "none" }}>Sarasota</a></p>
      </div>
    </div>
  );
}
