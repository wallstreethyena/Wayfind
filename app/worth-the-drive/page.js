// /worth-the-drive — on the intent-page template (v6.58). Dynamic + personal, so noindex.
...
export async function generateMetadata({ searchParams }) {
  ...
  const og = SITE_URL + "/api/og/intent?intent=worth-the-drive" + (city ? "&city=" + encodeURIComponent(city) : "") + (refOk ? "&img=" + encodeURIComponent(ref) : "");
