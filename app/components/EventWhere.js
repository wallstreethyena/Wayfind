...
.wfw-acts{display:flex;flex-wrap:wrap;gap:10px;flex:0 0 auto}
.wfw-btn{display:inline-flex;align-items:center;justify-content:center;gap:8px;padding:12px 18px;border-radius:13px;font-size:14.5px;font-weight:800;line-height:1;text-decoration:none;white-space:nowrap;transition:transform .15s ease,box-shadow .15s ease}
...
.wfw-th{position:relative;flex:0 0 auto}
