...
export const WF_RAIL_MENU_CSS =
  ...
  // Date Night owner poster is 2:3 (1024×1536). The shared tile is 9:16 with
  // object-fit:cover, which center-cropped the left-aligned wordmark. This
  // tile matches the source aspect and contains the full frame. Other posters
  // stay on --wf8-ratio:.5625 + cover. Hover zoom is off here because scale
  // plus overflow:hidden re-clips the same left edge.
  `.wf8-tile[data-id="datenight"]{--wf8-ratio:0.666667}.wf8-tile[data-id="datenight"] .wf8-tim{object-fit:contain;object-position:center center}.wf8-tile[data-id="datenight"]:hover .wf8-tim{transform:none}`;
