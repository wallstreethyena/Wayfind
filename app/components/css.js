...
export const WF_SEARCH_CSS = `.wf-search-row{filter:drop-shadow(0 11px 20px rgba(0,0,0,.24));transition:filter .2s ease}.wf-search-row:focus-within{filter:drop-shadow(0 13px 25px rgba(0,0,0,.34)) drop-shadow(0 0 7px rgba(148,163,184,.06))}.wf-search-row>div:first-child{border-radius:14px 0 0 14px}.wf-search-icon{color:#AEB9C8;transition:color .18s ease}.wf-search-row:focus-within .wf-search-icon{color:#E2E8F0}.wf-search-input{background:linear-gradient(135deg,#182130,#111923)!important;border-color:#354153!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.045),inset 0 -1px 0 rgba(0,0,0,.25);transition:border-color .18s ease,background .18s ease,box-shadow .18s ease}.wf-search-input::placeholder{color:#8190A3;opacity:1}.wf-search-input:focus,.wf-search-input:focus-visible{outline:none!important;outline-offset:0!important;border-color:rgba(203,213,225,.72)!important;background:linear-gradient(135deg,#1A2330,#121923)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.075),inset 0 0 0 1px rgba(203,213,225,.08),0 0 0 1px rgba(203,213,225,.14)!important}.wf-search-submit{background:linear-gradient(180deg,#FF9B47 0%,#F97316 55%,#E95A0C 100%)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.34),0 8px 18px rgba(249,115,22,.27);transition:filter .18s ease,transform .18s ease,box-shadow .18s ease}.wf-search-submit:hover{filter:brightness(1.06);transform:translateX(1px);box-shadow:inset 0 1px 0 rgba(255,255,255,.42),0 10px 20px rgba(249,115,22,.34)}@media(min-width:${WF_DESKTOP_BP}px){.wf-topbar{padding-top:18px!important;padding-bottom:16px!important}.wf-topbar-row{margin-bottom:10px!important}.wf-search-row>div:first-child{border-radius:17px 0 0 17px}.wf-search-icon{left:16px!important}.wf-search-input{padding-left:43px!important}}` +
  ...
  `.wf-search-help{margin:7px 2px 0;color:#94A3B8;font-size:11.5px;line-height:1.5}.wf-search-feedback{padding:8px 2px 0;color:#CBD5E1;font-size:13px;line-height:1.5}.wf-search-field:has(.wf-search-clear) .wf-search-input{padding-right:46px!important}.wf-search-clear{position:absolute;right:5px;top:50%;transform:translateY(-50%);display:inline-flex;align-items:center;justify-content:center;width:40px;height:40px;border:0;border-radius:10px;background:transparent;color:#CBD5E1;font-size:25px;line-height:1;cursor:pointer}.wf-search-clear:hover{background:rgba(255,255,255,.08);color:#fff}.wf-search-clear:focus-visible{outline:2px solid #F97316;outline-offset:-2px}.wf-search-loading{max-width:340px;color:#FFBD8A}.wf-search-dots{display:inline-flex;gap:3px;margin-left:5px;vertical-align:middle}.wf-search-dots i{width:4px;height:4px;border-radius:50%;background:currentColor;animation:wfsearchdot 1.2s ease-in-out infinite}.wf-search-dots i:nth-child(2){animation-delay:.15s}.wf-search-dots i:nth-child(3){animation-delay:.3s}.wf-search-track{display:block;height:2px;margin-top:7px;overflow:hidden;border-radius:2px;background:rgba(249,115,22,.15)}.wf-search-track>span{display:block;width:36%;height:100%;border-radius:inherit;background:#FB923C;animation:wfsearchscan 1.6s ease-in-out infinite}@keyframes wfsearchdot{0%,70%,100%{opacity:.35;transform:translateY(0)}35%{opacity:1;transform:translateY(-3px)}}@keyframes wfsearchscan{0%{transform:translateX(-110%)}100%{transform:translateX(390%)}}.wf-search-recovery{display:flex;gap:16px;align-items:center;flex-wrap:wrap;padding:5px 2px 0}.wf-search-recovery button,.wf-search-recovery a{padding:5px 0;background:none;border:0;color:#FB923C;font:inherit;font-size:12px;font-weight:700;text-decoration:underline;text-underline-offset:3px;cursor:pointer}.wf-search-recovery button:focus-visible,.wf-search-recovery a:focus-visible{outline:2px solid #F97316;outline-offset:3px;border-radius:3px}.wf-search-spinner{display:block;width:19px;height:19px;border:2px solid rgba(13,17,23,.3);border-top-color:#0D1117;border-radius:50%;animation:wfsearchspin .75s linear infinite}.wf-city-transition{margin:9px 0 0;padding:9px 12px;border-radius:10px;background:rgba(249,115,22,.1);border:1px solid rgba(249,115,22,.22);color:#FFBD8A;font-size:13px;font-weight:650;animation:wfsearchcity .38s ease-out both}.wf-city-transition span{margin-right:4px}@keyframes wfsearchspin{to{transform:rotate(360deg)}}@keyframes wfsearchcity{from{opacity:0;transform:translateY(-5px)}to{opacity:1;transform:none}}@media(prefers-reduced-motion:reduce){.wf-search-spinner,.wf-city-transition,.wf-search-dots i,.wf-search-track>span{animation:none}.wf-search-dots i{opacity:1}.wf-search-track>span{width:100%;opacity:.65}}` +
...
.wf-place-card{--wf-card-h:${PLACE_CARD_HEIGHT_PX}px;--wf-card-badge-w:104px;--wf-place-card-media:${PLACE_CARD_MEDIA_PERCENT}%;width:var(--wf-place-card-width);max-width:100%;min-width:0;flex:0 1 var(--wf-place-card-width);height:var(--wf-card-h);box-sizing:border-box;position:relative}
.wf-rail .wf-place-card,.wf8-pcrail .wf-place-card{flex:0 0 var(--wf-place-card-width);height:var(--wf-card-h);--wf-place-card-media:${PLACE_CARD_MEDIA_PERCENT}%}
...
@media(max-width:430px){
  ...
  .wf-sheet-card-actions{grid-template-columns:44px 26px 26px minmax(0,1fr);gap:3px!important}
...
.wf-rail-heading h2{margin:0;font-family:inherit;font-size:18px;line-height:1.25;font-weight:850;letter-spacing:normal;color:#F8FAFC;overflow-wrap:anywhere}
.wf-rail-heading-controls{flex:0 1 132px;min-width:0;margin-left:auto}
.wf-rail-heading-controls:empty{display:none}
.wf-rail-heading .wf-rail-nav{margin:0;align-items:flex-end;flex-direction:column-reverse;gap:4px;text-align:right}
.wf-rail-nav{display:flex;align-items:center;justify-content:space-between;gap:10px;margin:0 0 7px}
.wf-rail-deck{margin:4px 0 0;font-size:13px;line-height:1.45;color:#AEB8C6;overflow-wrap:anywhere}
.wf-rail-nav-hint{color:#86EFAC;font-size:12px;line-height:1.35;font-weight:850;letter-spacing:.02em;font-variant-numeric:tabular-nums;text-transform:uppercase}
.wf-rail-nav-hint b{color:inherit;font-weight:850}
...
.wf-place-card-score .wf-rail-when{min-width:var(--wf-card-badge-w);height:40px}
.wf-rail-when{
