...
.wf-event-experience{background:#080909;color:#f5f4ef;font-family:var(--wf-sans);min-height:100dvh}
...
.wf-event-photo{position:relative;background:#141a16;border:1px solid #30372e;border-radius:20px;overflow:hidden;min-width:0}
.wf-event-photo img{display:block;width:100%;height:660px;object-fit:contain;background:#111612}
.wf-event-booking{padding:30px;border:1px solid #30372e;border-radius:20px;background:#151a15;min-width:0}
...
.wf-event-eyebrow{color:#bbceb4;font-size:12px;letter-spacing:1.5px;text-transform:uppercase;font-weight:600}
.wf-event-date{font-size:18px;line-height:1.5;color:#dce7d4;margin:0 0 20px}
.wf-event-price{font-size:24px;line-height:1.4;font-weight:600;margin:24px 0 12px;color:#f5f4ef}
.wf-event-booking-note{font-size:13px;line-height:1.6;color:#b4c0ac;margin:14px 0 0}
.wf-event-summary{border-top:1px solid #343f2f;padding-top:22px;margin-top:22px}
.wf-event-content{max-width:820px;margin:40px auto 0;line-height:1.75}
.wf-event-experience .wfw{margin:40px 0}
.wf-event-experience .wfw-card{background:#141a14;border:1px solid #35402f;box-shadow:none;border-radius:20px}
...
.wf-event-experience .wfw-k{color:#bbceb4;font-weight:600;letter-spacing:1.5px;font-size:12px}
...
.wf-event-experience .wfw-th{display:block;aspect-ratio:9/16;overflow:hidden;border-radius:14px;background:#1c251a}
.wf-event-experience .wfw-p img{width:100%;height:100%;border-radius:14px;object-fit:cover}
.wf-event-experience .wfw-n{left:12px;top:12px;width:30px;height:30px;border:2px solid #fff;background:#dce5d3;color:#192015}
...
.wf-event-experience .wfw-foot{font-size:13px;line-height:1.65;color:#aab69f;padding:0 28px 24px}
.wf-event-experience .wfev-you:before{animation:none}
@media(max-width:800px){.wf-event-wrap{padding:20px 20px 48px}.wf-event-hero{grid-template-columns:1fr;gap:18px;margin:20px 0 30px}.wf-event-photo img{height:auto;max-height:480px;min-height:240px}.wf-event-booking{padding:24px}.wf-event-booking h1{font-size:36px!important}.wf-event-experience .wfw-head{padding:22px}.wf-event-experience .wfw-map{padding:0 8px 8px}.wf-event-experience .wfev-h{height:420px}.wf-event-experience .wfw-near{padding:10px 20px 24px}.wf-event-experience .wfw-grid{display:flex;overflow-x:auto;scroll-snap-type:x mandatory;gap:16px;padding-bottom:16px}.wf-event-experience .wfw-p{flex:0 0 76%;min-width:0;scroll-snap-align:start}.wf-event-content{margin-top:30px}.wf-event-experience .wfw-foot{padding:0 20px 24px}.wf-event-brand{flex-wrap:wrap}.wf-event-experience .wfw-btn{white-space:normal;line-height:1.4}}
