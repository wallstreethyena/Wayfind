...
@media(max-width:800px){.wf-event-wrap{padding:20px 20px 48px}.wf-event-hero{grid-template-columns:1fr;gap:18px;margin:20px 0 30px}.wf-event-photo{flex-basis:216px;width:216px;height:384px}.wf-event-booking{padding:24px}.wf-event-fact{grid-template-columns:86px minmax(0,1fr);gap:10px;font-size:14px}.wf-event-booking h1{font-size:36px!important}.wf-event-experience .wfw-head{padding:22px}.wf-event-experience .wfw-map{padding:0 8px 8px}.wf-event-experience .wfev-h{height:420px}.wf-event-content{margin-top:30px}.wf-event-experience .wfw-foot{padding:0 14px 8px}.wf-event-brand{flex-wrap:wrap}.wf-event-experience .wfw-btn{white-space:normal;line-height:1.4}}
