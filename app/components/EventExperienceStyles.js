...
.wf-event-hero{display:grid;grid-template-columns:minmax(0,1.3fr) minmax(0,1fr);gap:28px;align-items:start;margin:24px 0 40px}
/* The wrapper owns portrait geometry; intrinsic image dimensions cannot stretch the rail. */
.wf-event-media{min-width:0;max-width:100%}
...
.wf-event-experience .wfw-grid{display:flex;align-items:flex-start;gap:22px;overflow-x:auto;overscroll-behavior-x:contain;scroll-snap-type:x proximity;padding-bottom:16px}
.wf-event-experience .wfw-p{flex:0 0 252px;min-width:0;scroll-snap-align:start;display:block;padding:0;border:0;background:transparent;border-radius:14px}
...
@media(max-width:800px){.wf-event-wrap{padding:20px 20px 48px}.wf-event-hero{grid-template-columns:1fr;gap:18px;margin:20px 0 30px}.wf-event-photo{flex-basis:216px;width:216px;height:384px}.wf-event-booking{padding:24px}.wf-event-fact{grid-template-columns:86px minmax(0,1fr);gap:10px;font-size:14px}.wf-event-booking h1{font-size:36px!important}.wf-event-experience .wfw-head{padding:22px}.wf-event-experience .wfw-map{padding:0 8px 8px}.wf-event-experience .wfev-h{height:420px}.wf-event-experience .wfw-near{padding:10px 20px 24px}.wf-event-experience .wfw-grid{display:flex;overflow-x:auto;scroll-snap-type:x proximity;gap:16px;padding-bottom:16px}.wf-event-experience .wfw-p{flex:0 0 76%;min-width:0;scroll-snap-align:start}.wf-event-content{margin-top:30px}.wf-event-experience .wfw-foot{padding:0 20px 24px}.wf-event-brand{flex-wrap:wrap}.wf-event-experience .wfw-btn{white-space:normal;line-height:1.4}}
