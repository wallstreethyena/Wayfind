...
const ICON_PATHS = {
  ...
  thumbup: <><path d="M7 10v11H3V10h4z" /><path d="M7 19c2 0 3.5 2 6.5 2h2.8a2 2 0 0 0 1.9-1.4l2.4-7A2 2 0 0 0 18.7 10H15l.7-3.5A3 3 0 0 0 12.8 3L7 10v9z" /></>,
  thumbdown: <><path d="M7 14V3H3v11h4z" /><path d="M7 5c2 0 3.5-2 6.5-2h2.8a2 2 0 0 1 1.9 1.4l2.4 7a2 2 0 0 1-1.9 2.6H15l.7 3.5a3 3 0 0 1-2.9 3.5L7 14V5z" /></>,
  share: <><circle cx="18" cy="5" r="2.5" /><circle cx="6" cy="12" r="2.5" /><circle cx="18" cy="19" r="2.5" /><path d="M8.2 10.8l7.6-4.6" /><path d="M8.2 13.2l7.6 4.6" /></>,
