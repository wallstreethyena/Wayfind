...
// band; this only draws). Compact horizontal design: dark navy rounded
// surface, 2px band-colored outline, band-colored pin panel left, "WAYFIND"
// label over the big score with a small /10. No gradients, no shadows, no
// animation. Color is never the only signal — the number always renders and
// the accessible name carries score + confidence. Invalid scores never reach
// here (callers gate on isValidScore); if one does, we render nothing.
