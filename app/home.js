...
function PlaceCard({ p, rank, saved, liked, disliked, onDetail, onSave, onLike, onDislike, onShareCard, line, onBadge, selectedBadge, onCuisineTap, beachSignal, city, mc }) {
  ...
  const pcat = mc === "family" ? "Family" : primaryCategory(p);
