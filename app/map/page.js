...
export const metadata = { title: "Map · Wayfind", description: "Every top-rated place near you on one map: food, attractions, beaches, nightlife, and events.", robots: { index: false, follow: true }, alternates: { canonical: "https://www.gowayfind.com/map" } };
export default function Page() {
  return (
    <div style={{ background: "#0D1117", minHeight: "60vh", color: "#CBD5E1", fontFamily: "var(--wf-sans)", padding: "48px 24px", textAlign: "center" }}>
      ...
      <a href="/?go=map" style={{ color: "#CBD5E1", fontWeight: 800, textDecoration: "none" }}>Open in Wayfind ›</a>
      <div style={{ maxWidth: 560, margin: "22px auto 0", textAlign: "left", fontSize: 13.5, color: "#94A3B8", lineHeight: 1.65 }}>
        ...
        <p style={{ marginTop: 10 }}>Prefer reading first? <a href="/guides" style={{ color: "#CBD5E1", fontWeight: 700, textDecoration: "none" }}>Browse the local guides</a>.</p>
      </div>
    </div>
  );
}
