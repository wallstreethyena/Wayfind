...
export const metadata = { title: "Your favorites · Wayfind", description: "Places and lists you have saved in Wayfind. Saved items live on this device; sign in to keep them across devices.", robots: { index: false, follow: true } };
