...
export const metadata = { title: "Your itinerary · Wayfind", description: "Sign in to plan trips and build itineraries. Your plans sync across all your devices.", robots: { index: false, follow: true } };
