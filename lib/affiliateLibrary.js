...
import { eventTicketDeal, SEPARATELY_TICKETED } from "./eventTicketDeals.js";
...
export const COVERAGE = Object.freeze({
  ...
  // not page on it.
  DECIDED_SEPARATELY_TICKETED: "decided-separately-ticketed",
...
export function eventAffiliateCoverage(event) {
  ...
  if (eventId && SEPARATELY_TICKETED.includes(eventId)) return { status: COVERAGE.DECIDED_SEPARATELY_TICKETED, eventId, merchant: m, deal: null, url };
