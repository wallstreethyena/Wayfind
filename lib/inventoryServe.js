...
import { browseChipLibraryCat } from "./browseInventory.js";
import { chipIdentity, CHIP_IDENTITY } from "./chipIdentity.js";
...
export async function serveFromInventory(cat, lat, lng, radiusM, n, sub) {
  ...
  const libraryCat = browseChipLibraryCat(cat, subIdEarly || "all");
