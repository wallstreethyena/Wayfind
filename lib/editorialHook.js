...
const HOOK_DEAL = /\b(?:stubs insider|bundtlet|bundtastic|free (?:large )?popcorn|free scoop|birthday (?:reward|freebie|coupon|treat|gift)|handcrafted beverage)\b/i;
...
export function isUsableCardHook(text, name) {
  ...
  if (HOOK_DEAL.test(s)) return false;
