...
//   1. RAIL_MIN_REVIEWS — a hard eligibility floor (statistical noise removal)
...
export const RAIL_MIN_REVIEWS = 250;
...
export function rankNightlife(places) {
  return (places || [])
    .filter((p) => p && p.rating && (p.reviews || 0) >= RAIL_MIN_REVIEWS)
