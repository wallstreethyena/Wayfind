...
// A room that sells a ticket for a dated thing.
const TICKETED_TYPES = ["performing_arts_theater", "concert_hall", "amphitheatre", "amphitheater",
  "stadium", "arena", "event_venue", "opera_house", "auditorium", "movie_theater",
  "night_club", "casino", "comedy_club", "cultural_center"];
