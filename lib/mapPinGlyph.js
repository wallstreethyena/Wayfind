import { PIN_CATEGORIES } from "./mapPinStandard.js";
...
const FAMILY_COLOR = Object.fromEntries(Object.entries(PIN_CATEGORIES).map(([key, value]) => [key, value.color]));
...
const FAMILY_BY_TYPE = {
  ...
  gift_shop: "shop", thrift_store: "shop", spa: "wellness", gym: "fitness",
...
const FAMILY_BY_CATEGORY = {
  cafe: "cafe", coffee: "cafe", shows: "shows", events: "shows", outdoors: "outdoors", culture: "culture", wellness: "wellness", fitness: "fitness",
