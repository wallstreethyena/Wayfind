...
export const COUPONS = [
  ...
  { id: "cpn-klook-first-hotel-app-5", business: "Klook", area: "Klook app",
    title: "5% off your first hotel booking in the Klook app", details: "First hotel booking made in the Klook mobile app. Download the app, apply the code at checkout.",
    code: "HOTELONAPP", url: "https://www.klook.com/?aid=127667", expires: null,
    cta: "Get the deal", intents: [], match: [] },

  { id: "cpn-klook-europe-rail-5", business: "Klook", area: "Europe travel",
    title: "5% off Europe railway tickets", details: "Planning a Europe trip? 5% off Europe rail tickets booked on Klook. Enter the code at checkout.",
    code: "EUPTPUS5OFF", url: "https://www.klook.com/?aid=127667", expires: "2026-07-31",
    cta: "Book on Klook", intents: [], match: [] },

  { id: "cpn-klook-europe-mobility-5", business: "Klook", area: "Europe travel",
    title: "5% off Europe mobility products", details: "Airport transfers, passes and transport products for Europe trips, booked on Klook. Enter the code at checkout.",
    code: "EUMOBUS5OFF", url: "https://www.klook.com/?aid=127667", expires: "2026-07-31",
    cta: "Book on Klook", intents: [], match: [] },
  ...
  { id: "cpn-viator-hydrocats-craigcat", business: "HydroCats", area: "Sarasota",
    title: "2-hour CraigCat sightseeing tour — $131 (reg. $146)", details: "Drive your own mini catamaran on Sarasota Bay. Free cancellation. Viator special offer — price at checkout.",
