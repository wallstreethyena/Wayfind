...
.wfcr-hero{position:relative;display:grid;grid-template-columns:1fr 1fr;min-height:560px;border-radius:28px;overflow:hidden;background:#181e1d;margin-bottom:32px;border:1px solid #36403a}
.wfcr-hero>img{width:52%;height:100%;position:absolute;inset:0;object-fit:cover;object-position:50% 30%}
.wfcr-hero>div{position:relative;grid-column:2;padding:64px 40px;background:linear-gradient(90deg,rgba(16,28,25,.85),#101c19 12%);display:flex;flex-direction:column;justify-content:center}
.wfcr-eyebrow{font-size:11px;font-weight:800;letter-spacing:.2em;color:#eed4a6}
.wfcr-hero h2{font-family:Georgia,serif;font-size:clamp(34px,4.5vw,58px);font-weight:400;line-height:1.06;letter-spacing:-.04em;margin:24px 0;color:#fff9ed}
.wfcr-hero em{color:#e7c899}.wfcr-hero p{max-width:300px;line-height:1.6;color:#e5e1d9;font-size:14px}
.wfcr-hero a{align-self:flex-start;border-radius:999px;padding:13px 20px;background:#f0dcba;color:#182019;text-decoration:none;font-size:13px;font-weight:800;margin-top:16px}
.wfcr-card{flex:0 0 292px;scroll-snap-align:start;padding:14px;border-radius:22px;background:linear-gradient(150deg,#1c2527,#10171e);border:1px solid #303c40;box-sizing:border-box}
.wfcr-card h3{min-height:42px}.wfcr-card>p{display:-webkit-box;-webkit-line-clamp:3;-webkit-box-orient:vertical;overflow:hidden;min-height:65px}
.wfcr-card a{font-size:12px!important;line-height:1.5}.wfcr-card a+a{margin-left:0!important;display:block!important}
.wfcr-page a:focus-visible,.wfcr-page button:focus-visible{outline:3px solid #eed4a6;outline-offset:4px}
@media(max-width:640px){.wfcr-hero{min-height:610px;display:flex;align-items:flex-end;border-radius:22px}.wfcr-hero>img{width:100%;object-position:40% 35%}.wfcr-hero>div{width:100%;padding:140px 24px 28px;background:linear-gradient(0deg,rgba(8,17,15,.97),rgba(8,17,15,.7) 68%,transparent)}.wfcr-hero h2{font-size:38px;margin:14px 0}.wfcr-hero p{margin:0}.wfcr-card{flex-basis:82vw;max-width:300px}}
`;
