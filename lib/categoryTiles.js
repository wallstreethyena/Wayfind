...
export const TILE_SOURCE = {
  ...
  // Was null because wf_inventory has no 'family' rows. It never needed one:
  // family is a cross-cutting predicate (a park is an attraction AND family),
  // and wf_best_picks now serves it as a virtual category over google_types,
  // the same way it already served things_to_do and eat. 190 places within
  // 25mi of Parrish, 858 statewide -- they were always there, unmapped.
  family: "family",
  hotels: "hotels",
  shopping: "shopping",
};
