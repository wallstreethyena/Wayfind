...
export const KPI_DEFS = {
  live_now: "Distinct devices with at least one first-party event in the last 5 minutes (Wayfind's own event log — no sampling).",
  visitors: "Deduplicated people as counted by the analytics source: PostHog unique persons where connected; otherwise distinct anonymous device ids from the first-party event log (labeled).",
