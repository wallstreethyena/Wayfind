...
export const AWIN_PROGRAMMES = Object.freeze({
  ...
  usghostadventures: { mid: "122270", brand: "US Ghost Adventures", host: "usghostadventures.com", rate: "4–10%", cookie: "30d",
    status: "approved", approvedOn: "2026-08-18",
    note: "Walking ghost tours. Founder approval 2026-08-18. St. Augustine, Tampa and Key West pages name those cities in the H1 — nightlife/tour complement, never a ranking input." },
  ...
  caesarsshows: { mid: "21867", brand: "Caesars Shows & Attractions", host: "caesars.com", rate: "10%", cookie: "30d",
    status: "approved", approvedOn: "2026-08-18",
    note: "Vegas shows only. Founder approval 2026-08-18. The live listing is the Center Strip shows hub — never place on a Florida city page." },
  ...
  rentcars: { mid: "18808", brand: "RentCars", host: "rentcars.com", rate: "4% dom / 7% intl", cookie: "30d",
    status: "approved", approvedOn: "2026-08-18",
    note: "Airport car rental. Founder approval 2026-08-18. Wire only the named airport pages (MCO / TPA / SRQ) — copy must say airport car rental, never pretend it is the attraction." },
