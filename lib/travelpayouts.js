...
export const TP_PROGRAMS = {
  ...
  // ── Wave 2: visitor-utility surfaces ──────────────────────────────────────
  ...
  gocity: {
    brand: "Go City", category: "passes", rate: "3.4–6%",
    home: "https://gocity.com", tpxHost: "gocity.tpx.lu",
    promoId: "1942", campaignId: "62", // ACTIVE + link-builder verified 2026-08-01
    note: "City passes — exact Orlando and New York pass pages only; never a generic city guess.",
  },
