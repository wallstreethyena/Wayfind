...
// Stacked-list first-paint reservation. Measured live Food cards at 390px
// are ~235px tall; a content-only skeleton paints ~178px and jumps on
// hydrate. This is NOT the rail 268 lock — only `.wf-place-card-list`
// skeletons consume it.
export const PLACE_CARD_LIST_RESERVE_PX = 235;
...
export const PLACE_CARD_STANDARD = Object.freeze({
  ...
  listReservePx: PLACE_CARD_LIST_RESERVE_PX,
});
