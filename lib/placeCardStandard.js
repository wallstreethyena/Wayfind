...
// ONE proportional photo column for every card, stacked or rail. Percentage
// geometry keeps the same visual balance at the 320px rail peek and at the
// 440px desktop cap instead of creating a second fixed-pixel card species.
export const PLACE_CARD_MEDIA_PERCENT = 36;
...
export const PLACE_CARD_STANDARD = Object.freeze({
  ...
  mediaPercent: PLACE_CARD_MEDIA_PERCENT,
