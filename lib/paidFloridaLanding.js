...
export const HERO = Object.freeze({
  kicker: "FLORIDA, RANKED",
  h1: "Stop scrolling reviews. Pick a place and go.",
  sub: "Wayfind already did the work: the Florida guides, tickets, tours, stays and events people are opening right now, in one place.",
  primaryLabel: "Open Wayfind",
  primaryHref: "/",
  secondaryLabel: "See what's hot",
  secondaryHref: "#hot",
});
...
// edit the ranking.
export const HOT_SNAPSHOT_HEADING = "Most opened on Wayfind this month";
