...
export const HERO = Object.freeze({
  ...
  h1: "Less searching. More Florida.",
...
// edit the ranking.
export const HOT_SNAPSHOT_HEADING = "Most popular guides";
...
export const HALLOWEEN_HEADING = "Halloween and fall events";
...
export const NATURE_INTRO = "Manatees, kayaks, airboats and sunset cruises.";
...
export const SHOWS_INTRO = "Find your next big night out.";
...
export const STAYS_INTRO = "Stay closer to the parks.";
...
export const INTEREST_LINKS = Object.freeze([
  ...
  { href: "#orlando", label: "Park tickets", detail: "Big days out" },
  { href: "#halloween", label: "Fall events", detail: "What is on this season" },
  { href: "#gulf-coast", label: "Gulf Coast", detail: "Sand & sunset rituals" },
  { href: "#stays", label: "Stays", detail: "Make mornings easier" },
]);
