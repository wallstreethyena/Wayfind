...
export const RON_DUPRAT_TOP7 = Object.freeze({
  ...
  accent: "#F97316",
  // The chef's seven, verbatim (owner-supplied 2026-08-25; array order = his
  ...
  entries: Object.freeze([
    { rank: 1, name: "Cafe La Trova", city: "Miami", state: "FL",
      ...
      whyWorthTheTrip: "Chef Michelle Bernstein's Cuban room in Little Havana, with cantinero Julio Cabrera running the bar the old-Havana way.",
    ...
    { rank: 2, name: "Red Rooster Harlem", city: "New York", state: "NY",
      ...
      whyWorthTheTrip: "Marcus Samuelsson's Harlem flagship — American comfort food that celebrates the neighborhood as much as the plate.",
      signatureDish: null },
    { rank: 3, name: "Le Bernardin", city: "New York", state: "NY",
      ...
      whyWorthTheTrip: "Eric Ripert's three-Michelin-star seafood temple — the standard the rest of fine dining measures itself against.",
      signatureDish: null },
    { rank: 4, name: "Sea Salt", city: "Naples", state: "FL",
      ...
      whyWorthTheTrip: "Venetian-inspired, seafood-first dining in downtown Naples' Third Street South.",
      signatureDish: null },
    { rank: 5, name: "Chef Creole Seasoned Restaurant", city: "Miami", state: "FL",
      ...
      whyWorthTheTrip: "Haitian-Caribbean seafood and Creole cooking at the Little Haiti flagship of a Miami institution.",
      signatureDish: null },
    { rank: 6, name: "Steak 954", city: "Fort Lauderdale", state: "FL",
      ...
      whyWorthTheTrip: "Beachfront luxury steakhouse at the W Fort Lauderdale — Wagyu and seafood beside the signature jellyfish tank.",
    ...
    { rank: 7, name: "Roots Southern Table", city: "Farmers Branch", state: "TX",
      ...
      whyWorthTheTrip: "Top Chef alum Tiffany Derry's flagship — Southern cooking with the duck-fat fried chicken people drive across Texas for.",
