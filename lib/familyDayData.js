...
import { FAMILY_DAY_RAILS, familyRailMatches, familyWeatherSafe, matchesFamilyFilters } from "./familyDayTaxonomy.js";
...
export async function familyDayAnswer(options) {
  ...
  return { ...paged, matched: matched.length, rail: options.rail, radiusMi: options.radiusMi,
