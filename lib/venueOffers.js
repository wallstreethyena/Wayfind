...
export const VENUE_OFFERS = Object.freeze([
  // ── Tampa Bay ───────────────────────────────────────────────────────────
  { provider: "klook", offerId: "tampa-family-florida-aquarium", market: ["tampa"], names: ["the florida aquarium", "florida aquarium"] },
  ...
  // Same Klook products as the primary card pins. No HHN, CityWalk, hotel,
  // Hollywood or individual ride aliases: those are different purchases.
  { provider: "klook", offerId: "merritt-island-klook-kennedy-admission", market: ["orlando", "merritt island", "cape canaveral", "titusville"], names: ["kennedy space center", "kennedy space center visitor complex"] },
  { provider: "klook", offerId: "orlando-klook-universal-admission", market: ["orlando"], names: ["universal orlando resort", "universal studios florida", "universal s islands of adventure", "universal islands of adventure", "universal epic universe", "universal s epic universe"] },
