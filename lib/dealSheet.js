...
const METRO_TOWNS = Object.freeze({
  ...
  // who live nearest them. That is why parrish and ruskin read "stpete": the
  // straight-line model puts both closer to the St. Pete centroid than to
  // Sarasota's or Tampa's, bay or no bay, and the viewer side uses the same
  // math. Locked by scripts/test-coupon-geo.mjs (town-coordinate consistency).
  parrish: "stpete",
  palmetto: "sarasota",
  osprey: "sarasota",
  englewood: "sarasota",
