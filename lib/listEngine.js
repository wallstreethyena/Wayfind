...
export const LIST_SYSTEM_PROMPT = [
  ...
  '{"headline":"","subhead":"","method":"","share_card_headline":"max 60 characters","share_card_teaser":"","og_description":"max 155 characters, must contain the gap","generated_at":"","items":[{"rank":1,"name":"","verdict":"max 12 words","reason":"why it beat the next one, tied to a data field","order_this":"only if the input supports it, otherwise omit","contrarian":false}]}',
  "",
