...
//
// "center"/"centre" added 2026-08-01 (owner report, screenshot: Orlando
// Science Center's detail sheet). "science" was already generic, which left
// "center" as the place's ONLY distinctive token; it then full-matched three
// Kennedy Space Center products ("Kennedy Space Center Express from Orlando",
// confidence 0.80 -- verified against the production booking_integrity_diag
// log for this exact query) and rendered "Book tickets" pointing at an
// unrelated attraction 60+ miles away. Same failure class as the
// science/nature collision above, one generic institutional-name word later:
// "center" names Kennedy SPACE Center, a convention center, a visitor center,
// a shopping center just as readily as a science center, so it can never
// carry entity credit on its own either.
