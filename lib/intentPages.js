...
export const INTENT_PAGES = {
  ...
  "quick-bite": {
    ...
    compose: {
      sections: ["Food"],
      // Quick means counter-serve. The slow-format shapes are excluded so a
      // steakhouse can't wear this heading on a strong score; everything else
      // is decided by the queries' quick-service intent plus the score.
    ...
    queries: (c) => {
      ...
      return [{ cat: "food", q: "fast casual quick eats highly rated" }].concat(byBucket);
    },
    titles: [
