...
export const INTENT_PAGES = {
  ...
  "date-night": {
    ...
    // Owner poster (2026-08-29): 27 miles is a HARD radius for this mode.
    // The decay band matches the cap so a 28-mile restaurant is out, not
    // merely deducted. Other intents keep their existing radii.
