...
export const INTENT_PAGES = {
  ...
  nearby: {
    ...
    title: (h, city) => "What's actually worth your time in " + city,
    sub: (city) => "Every category, ranked by the Wayfind Score. We left off anything under 120 reviews — not enough people to trust the rating.",
  },
  "date-night": {
  ...
  budget: {
    ...
    title: (h, city) => "$ and $$ only, still rated 4.4+",
    sub: (city) => "Google's two lowest price bands in " + city + ", ranked by the Wayfind Score. We left off anything pricier, and anything with no price on record.",
  },
  "hidden-gems": {
    eyebrow: "Hidden gems",
    accent: "#A78BFA",
