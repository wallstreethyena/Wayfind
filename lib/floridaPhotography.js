...
export const FLORIDA_EVENT_PHOTOS = {
  ...
  'seaworld-spooktacular-2026': photo('owner-seaworld.png',1090,758,'Orcas at SeaWorld'),
  'epcot-food-wine-2026': photo('owner-epcot-food-wine.png',460,320,'Food and drinks in front of Spaceship Earth at EPCOT'),
  'mnsshp-2026': photo('owner-mickey-halloween.png',472,382,'Disney Halloween parade in front of Cinderella Castle'),
};
export const FLORIDA_PARK_PHOTOS = {
  'orlando-hook-seaworld': FLORIDA_EVENT_PHOTOS['seaworld-spooktacular-2026'],
