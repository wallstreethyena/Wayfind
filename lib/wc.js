...
const CURATED = {
  sportsandsocial: { copy: "Orlando's marquee World Cup hub — the free Pointe Orlando festival shows all 104 matches with live music and player appearances. Go for the biggest crowd in town; skip it if you want a quiet table.", badge: { icon: "\uD83D\uDCFA", label: "Big screen energy" } },
