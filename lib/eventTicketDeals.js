...
export const NO_EXACT_AFFILIATE_PRODUCT = Object.freeze({
  ...
  // universalorlando.com lists it as a "Separately Ticketed Event" sold on
  // Universal's own web store. The only exact-date listings found (2026-09-23)
  // were TicketNetwork resale, and the owner decided that day not to use a
  // resale listing just to create a monetized button.
  "rock-the-universe-2027": Object.freeze({
    reviewedAt: "2026-09-23",
    reviewBy: "2026-09-30",
    reason: "separately ticketed on Universal's own store; no exact partner product, and owner declined resale listings (2026-09-23)",
  }),
});
