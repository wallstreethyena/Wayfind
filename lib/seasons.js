...
export const SEASON_META = {
  ...
  summer: { label: "Summer", emoji: "☀️", color: "#FBBF24", heroImage: "/cards/best-summer-ever.jpg" },
...
const SEASON_QUERIES = {
  ...
  // v8.13 (owner, 2026-08-18: "when I go on a summer list, everything is just
  // beaches, and that's not really what I'm looking for"). The homepage rail
  // now serves the curated lib/summerUniverse.js registry; THIS list feeds the
  // /seasonal hero experience, and it is diversified for the same reason —
  // springs, snorkeling, night paddles and airboats are what a Florida summer
  // actually peaks on, and one bare beach query was drowning all of them.
  summer: [
    { cat: "beach", keyword: "" },
    { cat: "attractions", keyword: "spring swimming tubing" },
    { cat: "attractions", keyword: "snorkeling kayak tour" },
    { cat: "attractions", keyword: "water park splash pad" },
    { cat: "attractions", keyword: "airboat wildlife tour" },
    { cat: "food", keyword: "ice cream shaved ice" },
    { cat: "attractions", keyword: "sunset cruise dolphin tour" },
  ],
};
...
const SEASON_FIT_RX = {
  ...
  // v8.13 — widened with the diversified summer queries above: a result the
  // "spring swimming tubing" query surfaces must be able to EARN its fit
  // boost, or the boost re-buries exactly what the diversification surfaced.
  summer: /\bbeach\b|water park|splash pad|shaved ice|ice cream|\bpool\b|\blake\b|summer festival|\bsprings?\b|snorkel|kayak|tubing|paddleboard|airboat|dolphin tour|sunset cruise/i,
};
