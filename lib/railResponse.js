...
// These two posters compose their display rails from the shared /api/rails
...
export const SHARED_POOL_COMPOSER_RAILS = Object.freeze(["breakfast", "eat"]);
 ...
 * its own endpoint. Breakfast and Actually Worth Eating render their own
 * subrails but must use the shared /api/rails pager that delivered their
 * source rows. A generic shared-pool rail also uses that pager.
 */
