...
//
// `lunchEnd` / `lateNightStart` do NOT create new TIME_BUCKETS. They are the
// same rail-order edge (1pm): lunch 11:30–13:00, then tonight FIRST through
// 06:00. The two names are the two roles of that minute — lunch ends, the
// night poster takes over. bucketForHour ignores both: greeting, meal window
// and outdoor gate still flip at 17:30. lib/dayparts.js is asserted equal to
// these values so 13:00 cannot live as a private clock.
