...
//
// `lunchEnd` and `lateNightStart` do NOT create new TIME_BUCKETS. They are the
// rail-order refinements inside afternoon and night: lunch 11:30–14:00 vs the
// rest of the afternoon, and dinner-leads 17:30–22:00 vs tonight-leads from
// 22:00. lib/dayparts.js reads them so the 14:00 and 22:00 flips cannot live
// as a private clock. bucketForHour ignores both — greeting, meal window and
// outdoor gate still see three buckets.
