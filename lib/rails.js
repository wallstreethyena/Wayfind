...
// Default ladder is 760×1350 (~9:16), matching --wf8-ratio:.5625 + object-fit
// cover. Date Night's owner poster is 1024×1536 (2:3). Cover-fitting 2:3 into
// 9:16 clipped ~15% of the width — the wordmark, SPEAKEASIES, and
// "WE'LL TAKE YOU UP TO". This tile keeps the source aspect. Other posters
// stay on the default box.
export const RAIL_ART_DEFAULT_SIZE = { width: 760, height: 1350 };
export const RAIL_ART_SIZE = {
  datenight: { width: 760, height: 1140 },
};
