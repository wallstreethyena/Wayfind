...
// reaches a reader again.
  ...
  { id: "trending", title: "Exploding Trends Near You", axis: "signal — the owner's curated trends, creator posts, and genuine demand surges",
    ...
    short: "Everyone's searching this", sub: "The 20 trends taking over, near you",
...
// v15 (2026-08-30): that 3:4 encode was letterboxed inside the shared 9:16
// tile (contain). The locked poster is now width-fit + top/bottom padded
// onto the 760×1350 ladder so cover fills the same box as Tonight / Worth
// the Drive without cropping DATE / NIGHT.
export const RAIL_ART_V = "15";
...
// Default ladder is 760×1350 (~9:16), matching the shared tile box
// (--wf8-ratio:.5625). Date Night's locked poster is 1086×1448 (3:4);
// the encode pads that onto this same 9:16 intrinsic (width-fit, pad
// top/bottom only) so cover fills the tile without cropping DATE/NIGHT.
// Other posters stay on the default box + cover.
export const RAIL_ART_DEFAULT_SIZE = { width: 760, height: 1350 };
export const RAIL_ART_SIZE = {
  datenight: { width: 760, height: 1350 },
};
export function railArtSize(id) {
  return RAIL_ART_SIZE[id] || RAIL_ART_DEFAULT_SIZE;
}
