...
// reaches a reader again.
  ...
  { id: "datenight", title: "Date Night, Perfected", axis: "the night for two — rooms, shows and rooftops within 27 miles",
    emptyWhy: "nothing within 27 miles has the night for it",
    short: "Best night. Every detail.", sub: "Speakeasies, fancy restaurants, clubs & rooftops",
    cta: "See date night", art: "datenight", href: "/date-night", list: true },
...
export const RAIL_TINT = {
  ...
  // v8.93 — pulled from the owner's candlelit poster (dark wood + warm
  // candle + forest window), so the tint that paints before the art decodes
  // is the art's colour.
  datenight: "linear-gradient(165deg,#3A2214,#1A100C 55%,#0B0E1A)",
...
// DETAIL." poster — speakeasies, fancy restaurants, clubs, rooftops, 27 miles.
// Same filenames, same cache-bust reason.
export const RAIL_ART_V = "12";
