...
// (--wf8-ratio:.5625). Date Night's locked poster is 1086×1448 (3:4). The
// TILE BOX is still the shared 9:16 (same width and height as Tonight /
// Worth the Drive). railArtSize here is the <img> intrinsic — source
// aspect + object-fit:contain letterboxes the full frame. Cover-fitting
// this poster into 9:16 is the #1031 left-edge crop. Other posters stay
// on the default box + cover.
export const RAIL_ART_DEFAULT_SIZE = { width: 760, height: 1350 };
export const RAIL_ART_SIZE = {
  datenight: { width: 760, height: 1013 },
};
