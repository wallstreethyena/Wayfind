...
// reaches a reader again.
  ...
  // card, not a ranked-list rail: a plain tap follows the exact place link the
  // owner supplied. `opensPage` is explicit so DaypartRail does not intercept
  // the anchor and open an empty generic drop.
  { id: "lunchcity", title: "Lunch in My City", axis: "challenge — accept one lunch prompt wherever the reader is now",
    ...
    cta: "Accept the challenge", art: "lunchcity", href: "/p/ChIJ9RHZGx6H3YgRnWVYIWsHNPM", opensPage: true },
