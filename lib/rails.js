...
// reaches a reader again.
  ...
  // a curated registry (lib/birthdayUniverse.js), not a category filter, so
  // it cannot collide with datenight (the room) or events (dated tickets).
  // Tile art: owner's "BIRTHDAY PLANS, SOLVED." design.
  { id: "birthday", title: "Birthday Plans, Solved", axis: "the occasion — curated birthday-worthy experiences",
