...
// 2026-08-08 — two more creators, same attestation basis, owner's words on the
// day: "i have agreement on all of them". The standing to-do above applies here
// too and is now three sessions old: none of these rows has an artefact behind
// it. @manateelittlelocals in particular carries twelve places on this one
// sentence, which is the largest single-creator exposure in the file — if one
// person's memory of one conversation is the whole basis, that is worth
// knowing before it is worth more.
const OWNER_ATTESTED_2026_08_08 = Object.freeze({
  photo: true,
  on: "2026-08-08",
  record: "Owner attestation, 2026-08-08 (verbatim: \"i have agreement on all of them\"): permission obtained from @manateelittlelocals and @parrishfloridahomes, whose posts the owner supplied for curation on that date. Underlying DMs/emails to be filed per creator and cited here individually.",
});

// 2026-08-23 — three creators added in one session (120 places between them),
// owner's words on the day: "yes you can get them avatar for them like we had
// done previously — all yes and everything is approved".
//
// THE STANDING TO-DO IS NOW FOUR SESSIONS OLD AND THE EXPOSURE HAS TRIPLED.
// @gabrielaromero11 alone carries 70 places on this one sentence — more than
// twice @manateelittlelocals, which the 2026-08-08 note already flagged as the
// largest single-creator exposure in the file. Three more rows on one person's
// word is three more rows with no artefact behind them, and the biggest of them
// is now the biggest in the library. Getting a DM or email on file from these
// three specifically is worth more than getting one from anybody else here.
const OWNER_ATTESTED_2026_08_23 = Object.freeze({
  photo: true,
  on: "2026-08-23",
  record: "Owner attestation, 2026-08-23 (verbatim: \"yes you can get them avatar for them like we had done previously all yes and everythgi nis approvved\"): permission obtained from @cailincoastal, @gabrielaromero11 and @eatsbylaurr, whose posts the owner supplied for curation on that date. Underlying DMs/emails to be filed per creator and cited here individually.",
});

// 2026-08-23b — @iviethefoodie, added later the same day. The owner reports an
// actual PARTNERSHIP with this creator, not just permission: "i partnered up
// with her and she allowed for us to fetch all of the locations from her
// website".
//
// THAT IS STRONGER CONSENT AND A HARDER QUESTION AT THE SAME TIME, and it is
// the first row here where the two come apart. Consent to be named and pictured
// is clearly satisfied. But lib/trendSignal.js is allowed to read creator
// corroboration into the RANKING on exactly one basis — that no creator input
// is monetized — and app/how-wayfind-ranks/page.js prints that claim to
// readers. A partnership that involves payment, free meals routed through us,
// revenue share, or any other consideration breaks it.
//
// ASK BEFORE THIS SHIPS ANY FURTHER: is money or value moving in either
// direction? If yes, she must be excluded from the corroboration source and
// from the creator-video score term, or that page has to change. Photo consent
// is recorded now because it is not in doubt; the ranking question is recorded
// here because it is.
const OWNER_PARTNERED_2026_08_23 = Object.freeze({
  photo: true,
  on: "2026-08-23",
  record: "Owner attestation, 2026-08-23 (verbatim: \"i partnered up with her and she allowed for us to fetch all fo the locations from her website\"): permission obtained from @iviethefoodie under a stated partnership. UNRESOLVED: whether that partnership involves payment or other consideration — see the note above, which governs whether her posts may feed lib/trendSignal.js.",
});

export const CREATOR_CONSENT = Object.freeze({
  "iviethefoodie": OWNER_PARTNERED_2026_08_23,
  "cailincoastal": OWNER_ATTESTED_2026_08_23,
  "gabrielaromero11": OWNER_ATTESTED_2026_08_23,
  "eatsbylaurr": OWNER_ATTESTED_2026_08_23,
  "manateelittlelocals": OWNER_ATTESTED_2026_08_08,
  "parrishfloridahomes": OWNER_ATTESTED_2026_08_08,
