...
const OWNER_ATTESTED_2026_08_07 = Object.freeze({
  photo: true,
  on: "2026-08-07",
  record: "Owner attestation, 2026-08-07: permission obtained from @tampaiman, @_adatewithkait and @magicalmaddieb, whose posts the owner supplied for curation on that date. Underlying DMs/emails to be filed per creator and cited here individually.",
});
