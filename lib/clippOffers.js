...
export const CLIPP_MERCHANT_OFFERS = Object.freeze([
  ...
  Object.freeze({ offerId: "clipp-m-zellwood-station-golf", icon: "⛳", merchant: "Zellwood Station Golf Club", area: "Zellwood", kind: "activity",
    title: "$45 for green fees for 2 including cart", badge: "50% off",
    dest: "https://www.clipp.com/all-offers/90-for-green-fees-for-2-including-cart-zellwood-fl-deal-8820772",
    placeId: "ChIJvek_yuie54gR1oTGjm9AeOo", // own Google photo; Google calls it "Zellwood Station" (28.7246,-81.5755), 1.5mi from Zellwood
    match: Object.freeze([]),
    verified: Object.freeze({ on: "2026-08-23", seenOn: "orlando" }) }),
  Object.freeze({ offerId: "clipp-m-vicky-bakery-orlando", icon: "🥐", merchant: "Vicky Bakery", area: "Orlando", kind: "dining",
    ...
    match: Object.freeze([]),
    verified: Object.freeze({ on: "2026-08-23", seenOn: "orlando" }) }),
  Object.freeze({ offerId: "clipp-m-dave-busters-orlando", icon: "🕹️", merchant: "Dave & Buster's Orlando", area: "Orlando", kind: "activity",
    title: "$20 for $40 toward game play", badge: "50% off",
    dest: "https://www.clipp.com/all-offers/40-toward-game-play-orlando-fl-deal-12607852",
    placeId: "ChIJ5xePR7N_54gRPdzRWYqTOXA", // own Google photo; Google calls it "Dave & Buster's Orlando" (28.436,-81.4729), 9.1mi from Orlando
    match: Object.freeze([]),
    verified: Object.freeze({ on: "2026-08-23", seenOn: "orlando" }) }),
  ...
  Object.freeze({ offerId: "clipp-m-qdoba-apopka-vineland", icon: "🌮", merchant: "QDOBA - Apopka Vineland", area: "Orlando", kind: "dining",
    ...
    match: Object.freeze([]),
    verified: Object.freeze({ on: "2026-08-23", seenOn: "orlando" }) }),
  Object.freeze({ offerId: "clipp-m-qdoba-ocoee", icon: "🌮", merchant: "QDOBA Mexican Eats", area: "Ocoee", kind: "dining",
    title: "$15 for $30 of Mexican cuisine", badge: "50% off",
    dest: "https://www.clipp.com/all-offers/30-mexican-cuisine-ocoee-fl-deal-12815339",
    placeId: "ChIJ9ZOS6SeD54gRly60LW4WjIc", // own Google photo; Google calls it "QDOBA Mexican Eats" (28.5522,-81.5413), 1.2mi from Ocoee
    match: Object.freeze([]),
    verified: Object.freeze({ on: "2026-08-23", seenOn: "orlando" }) }),
  ...
  Object.freeze({ offerId: "clipp-m-cleaneatz-windermere", icon: "🥗", merchant: "CleanEatz Windermere", area: "Winter Garden", kind: "dining",
    ...
    match: Object.freeze([]),
    verified: Object.freeze({ on: "2026-08-23", seenOn: "orlando" }) }),
  Object.freeze({ offerId: "clipp-m-little-greek-lake-mary", icon: "🥗", merchant: "Little Greek Fresh Grill", area: "Lake Mary", kind: "dining",
    title: "$15 for $30 of casual dining", badge: "50% off",
    dest: "https://www.clipp.com/all-offers/30-casual-dining-lake-mary-fl-deal-12276823",
    placeId: "ChIJ5SwXN_ht54gRFldRvge7mmI", // own Google photo; Google calls it "Little Greek Fresh Grill" (28.7552,-81.3342), 1mi from Lake Mary
    match: Object.freeze([]),
    verified: Object.freeze({ on: "2026-08-23", seenOn: "orlando" }) }),
]);
...
export const CLIPP_INDEX_REVERIFIED = Object.freeze({
  ...
  offerIds: Object.freeze([
    ...
    "clipp-m-zellwood-station-golf",
    "clipp-m-vicky-bakery-orlando",
    "clipp-m-dave-busters-orlando",
    ...
    "clipp-m-little-greek-lake-mary",
  ]),
});
