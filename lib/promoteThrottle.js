...
//                  wf_spend_take saying no). Optional and 0 by default: no
//                  current call site in the promote-index path checks the
//                  ledger per-place (WAYFIND_GATE is checked once, at the top
//                  of the route, before any batch is even claimed — out of
//                  scope to change here). The parameter exists so a future
//                  per-place ledger check has somewhere to report into without
//                  a second throttle function.
