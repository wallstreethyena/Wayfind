...
export const GEMS = [
  ...
  { key: "helenamodernriviera", name: "Helena Modern Riviera", area: "Icon Park", cat: "nightout", note: "Riviera-meets-Bali room where brunch rolls into nightlife and the cocktails are theater. Go for the scene; the kitchen is not the star." },
