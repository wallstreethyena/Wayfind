...
// to match the mi=60 radius the SAME rail's sibling Viator query already
// uses (BookableExpRail, app/home.js) — one rail, one honest "near" radius,
// not two different ones depending on which provider answered.
const DEAL_RADIUS_MI = 60; // must match "near {city}" honestly — see BookableExpRail's mi=60 Viator search in app/home.js
