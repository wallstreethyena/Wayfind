...
const CURATED = [
  ...
  { key: "ryans-coffee-house-parrish", match: { name: "Ryan", city: "Parrish" }, displayName: "Ryan's Coffee House", note: "Root kept to \"Ryan\" — norm() turns the apostrophe in \"Ryan's\" into a space, which can break a longer substring match depending on how Wayfind's own place-name string is punctuated. displayName carries the human label the sheet shows.",
