...
// v9 (2026-09-02, WO9 bundle fix) — PLATFORM/PLATFORM_RGB moved to their own
// file, lib/creatorPlatforms.js, and re-exported here unchanged so every
// existing importer of these two names from THIS module keeps working. See
// that file's header for why: CreatorCardMark.js (eager on "/") only ever
// needed these two small constants, not the registry below.
export { PLATFORM, PLATFORM_RGB } from "./creatorPlatforms.js";
...
const CURATED = [
  // Owner-requested Estefani intake, 2026-09-20. Captions inspected in the
  // visible Instagram browser; branch addresses checked against official sites
  // and existing inventory IDs. See docs/curation/estefani-2026-09-20.md.
  { key: "latin-grill-tampa", placeId: "ChIJlbfJX1HPwogRvvfHRiaRQkA",
    match: { name: "Latin Grill Tampa", city: "Tampa" },
    address: "9331 E Adamo Dr, Tampa, FL 33619", category: "Food",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/estefani.ruizruiz/reel/Dde7EVBMqgn/", creator: "estefani.ruizruiz" }] },
  { key: "darna-mediterranean-grill-temple-terrace", placeId: "ChIJA97liAnHwogRWgNVGLuqV1c",
    match: { name: "Darna Mediterranean Grill", city: "Temple Terrace" },
    address: "10829 N 56th St, Temple Terrace, FL 33617", category: "Food",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/estefani.ruizruiz/reel/DdPvtU3sOXt/", creator: "estefani.ruizruiz" }] },
  {
    key: "spinning-coffee-bradenton", placeId: "ChIJIQGDwpgXw4gRxIJcGmjtyK4",
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  { key: "jabal-coffee-house-orlando", placeId: "ChIJ1RqNFQB954gR3YpxvP7m-Gs", match: { name: "Jabal Coffee House", city: "Orlando" },
  ...
  { key: "seek-first-coffee-shop-orlando", placeId: "ChIJa5cUmp1954gR3E-NDXQ3f8c", match: { name: "Seek First", city: "Orlando" }, /* note: "Formerly \"But First Coffee Shop\" — some directories/ordering pages still carry the old name at the same Pine Castle address.", */
  ...
  { key: "neuroplay-sensory-playroom-orlando", placeId: "ChIJzybHW0dj54gRu_MY96JT_zk", match: { name: "NeuroPlay", city: "Orlando" },
  ...
  { key: "joy-coffee-bradenton", placeId: "ChIJ1U_vFp0Xw4gRGKl6mJGJ9UI", match: { name: "Joy Coffee", city: "Bradenton" },
  ...
  { key: "ro-hyde-park-tampa", placeId: "ChIJe_sgCQTFwogRzB1ctERShiI",
    match: { name: "Ro Hyde Park", city: "Tampa" },
    ...
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/DbDuqRGpOal/", creator: "katelynintampa" },
      { platform: "instagram", url: "https://www.instagram.com/reel/Dc3asu4uUOI/", creator: "influencetampa" }] },
  ...
  { key: "yamashiro-miami", placeId: "ChIJG-Tq3xy32YgR7QyvDubSiLA", match: { name: "Yamashiro", city: "Miami" },
    ...
    videos: [
      { platform: "instagram", url: "https://www.instagram.com/estefani.ruizruiz/reel/DRFWfOqAGRa/", creator: "estefani.ruizruiz" },
  ...
  // Owner removal, 2026-09-11: inactive lifeinparrish account.
  ...
  { key: "nueva-cantina-tampa", placeId: "ChIJmzKZ8InEwogR0PM7xTqUB6M",
    match: { name: "Nueva Cantina", city: "Tampa" },
    // Downtown Tampa, 903 N Franklin St. Resolved 2026-09-02 (parent, via
    // searches on gowayfind.com) — displayName/address verified against the
    // wf_places_cache Details record where present, address cross-checked
    // independently (nuevacantina.com/locations/, Yelp, OpenTable) where it
    // was not. The reel below is the venue's own account and covers all of
    // Nueva Cantina's locations per its caption.
    address: "903 N Franklin St, Tampa, FL 33602", category: "Night out",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/p/DbEgtYDhrLD/", creator: "stufftodointampabay", reach: 306, /* postedAt: "2026-07-21", */ },
      { platform: "instagram", url: "https://www.instagram.com/reel/Dcwmv51CK5T/", creator: "nuevacantina", /* postedAt: "2026-08-31" */ }] },
  ...
  { key: "roasted813-tampa", placeId: "ChIJv30X8SzHwogRVHpiMio-n70",
    ...
    videos: [
      ...
      { platform: "instagram", url: "https://www.instagram.com/reel/Dc1ypmeSIzh/", creator: "foodbytiana", /* postedAt: "2026-09-03" */ }] },
  ...
  { key: "by-brothers-miami", placeId: "ChIJz4Ucz5Lp2YgRG9sCckMPEQ0",
    ...
    videos: [{ platform: "instagram", url: "https://www.instagram.com/p/DW6dkXnDrJO/", creator: "gabrielaromero11", reach: 1541, /* postedAt: "2026-04-09", */ },
      { platform: "instagram", url: "https://www.instagram.com/reel/Dc3WlMLx2iv/", creator: "fashion.eat.travel", /* postedAt: "2026-09-04" — multi-venue fall roundup */ }] },
  ...
  // ── @disneyfoodblog — Disney Food Blog (Phase 1 of the DFB intake, 2026-08-25) ──
  // THE RULE THIS BATCH SHIPS UNDER: only a place whose exact permalink was
  // verified enters here. DFB has 16k+ posts and the public index exposes a
  // fraction; six more places (Cake Bake Shop restaurant + bakery, Olivia's
  // Cafe, Casey's Corner, Gideon's Bakehouse, plus F&W event coverage that
  // belongs in wf_events, not here) have coverage confirmed but permalinks
  // unextracted — queued in docs/CREATOR_DFB_PIPELINE.md. Do not promote any
  // of them into this file without the exact post URL.
  { key: "summer-house-on-the-lake-disney-springs",
    match: { name: "Summer House on the Lake", city: "Lake Buena Vista" },
    address: "1486 Buena Vista Dr, Lake Buena Vista, FL 32830", category: "Food",
    // caption lives in lib/creatorCaptions.js (off-bundle, keyed "<key>|<url>");
    // it is Wayfind's own words, and the dish is confirmed on the restaurant's
    // own menu (2026-08-25).
    videos: [{ platform: "instagram", url: "https://www.instagram.com/p/Dcb6L0nt9tZ/", creator: "disneyfoodblog" }] },

  // ── Owner-submitted Instagram associations (2026-09-10) ──
  // Public native links only. These rows carry the reviewed venue identity;
  // the full source captions remain out of the public client registry.
  { key: "the-edison-disney-springs", placeId: "ChIJDVFcVYZ_3YgRU4PZ5Fw44Ek",
    match: { name: "The Edison", city: "Lake Buena Vista" }, displayName: "The Edison",
    address: "Disney Springs, Lake Buena Vista, FL", category: "Night out",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/DdEXS08Rk_f/", creator: "addyabnormal", /* postedAt: "2026-09-09" */ }] },
  { key: "happy-hangar-cafe-lutz", placeId: "ChIJ3aykOYywwogRzgNrH-W_jBU",
    match: { name: "Happy Hangar Cafe", city: "Lutz" }, displayName: "The Happy Hangar Café",
    address: "4241 Birdsong Blvd, Lutz, FL", category: "Food",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/DdERBhBRAGw/", creator: "toddlerfriendlytampabay", /* postedAt: "2026-09-08" */ }] },
  { key: "joe-the-boar-sarasota", placeId: "ChIJdfcBx1RBw4gRHlEUsS7539U",
    match: { name: "Joe The Boar", city: "Sarasota" }, displayName: "Joe the Boar",
    address: "Sarasota, FL", category: "Food",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/DdAFZJIq-D7/", creator: "eatlocalflorida", /* postedAt: "2026-09-07" */ }] },
  { key: "blooming-floral-cafe-tampa", placeId: "ChIJ9d2y1ivFwogRU2MFLQrwqsc",
    match: { name: "Blooming Floral Cafe", city: "Tampa" }, displayName: "Blooming Floral Cafe",
    address: "Seminole Heights, Tampa, FL", category: "Food",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Dc3xGQTBSp4/", creator: "tampavida", /* postedAt: "2026-09-04" */ }] },
  { key: "nazca-tampa", placeId: "ChIJT4Y7OwDBwogRICfhJkopIHg",
    match: { name: "NAZCA", city: "Tampa" }, displayName: "NAZCA",
    address: "10412 N Dale Mabry Hwy, Tampa, FL 33618", category: "Food",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Dc_2_gehAkP/", creator: "foodbytiana", /* postedAt: "2026-09-07" */ }] },
  { key: "milkshake-factory-brandon", placeId: "ChIJYT6hEfvPwogRXtCm4bU3InA",
    match: { name: "MilkShake Factory Brandon", city: "Brandon" }, displayName: "MilkShake Factory Brandon",
    address: "Brandon, FL", category: "Food",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Dc162pRtU71/", creator: "thefloridaplayground", /* postedAt: "2026-09-03" */ }] },
  { key: "brevard-zoo-melbourne", placeId: "ChIJI0Ja3y4E3ogRoNdEL3xe4Ek",
    match: { name: "Brevard Zoo", city: "Melbourne" }, displayName: "Brevard Zoo",
    address: "8225 N Wickham Rd, Melbourne, FL 32940", category: "Activities",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/DdDGRHSOX3B/", creator: "brevardbanana", /* postedAt: "2026-09-08" */ }] },
  { key: "at-the-diner-orlando", placeId: "ChIJuTGc8gN_54gRwRztnG7fJ-Y",
    match: { name: "@ The Diner", city: "Orlando" }, displayName: "@ The Diner",
    address: "Orlando, FL", category: "Food",
    // Brand roundup: it names several branches and is not represented as a
    // filmed visit to this specific address.
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Dc1JISKOJwM/", creator: "josyinorlando", /* postedAt: "2026-09-03" */ },
      { platform: "instagram", url: "https://www.instagram.com/reel/Dc4GPHqBG6H/", creator: "atthediner" }] },
  { key: "at-the-diner-lake-buena-vista", placeId: "ChIJUTIu2jqB3YgR8YmZ3ILb4gk",
    match: { name: "@ The Diner", city: "Lake Buena Vista" }, displayName: "@ The Diner",
    address: "Lake Buena Vista, FL", category: "Food",
    // Same brand roundup; no branch-specific filming claim.
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Dc1JISKOJwM/", creator: "josyinorlando", /* postedAt: "2026-09-03" */ },
      { platform: "instagram", url: "https://www.instagram.com/reel/Dc4GPHqBG6H/", creator: "atthediner" }] },
  { key: "jw-marriott-tampa-water-street", placeId: "ChIJBwQpZK_FwogRsoz9WgSYnOk",
    match: { name: "JW Marriott Tampa Water Street", city: "Tampa" }, category: "Lodging",
    address: "Tampa, FL",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Dc3asu4uUOI/", creator: "influencetampa", /* postedAt: "2026-09-04" — Tampa fall roundup */ }] },
  { key: "straz-center-tampa", placeId: "ChIJce6XFIjEwogRaNJA6ZKu31c",
    match: { name: "Straz Center", city: "Tampa" }, displayName: "Straz Center for the Performing Arts",
    address: "Tampa, FL", category: "Activities",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Dc3asu4uUOI/", creator: "influencetampa", /* postedAt: "2026-09-04" — Tampa fall roundup */ }] },
  { key: "raglan-road-disney-springs", placeId: "ChIJOcKapod_3YgR90H_S_UKiMA",
    match: { name: "Raglan Road Irish Pub", city: "Lake Buena Vista" }, displayName: "Raglan Road Irish Pub",
    address: "1640 E Buena Vista Dr, Lake Buena Vista, FL 32830", category: "Food",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/DcbOCOcm3qq/", creator: "raglanroadpub", /* postedAt: "2026-08-24" */ }] },

  // ── Owner's fall Instagram batch (2026-09-02) — 26 reels decoded by the
  // parent via the owner's browser. First pass shipped the certain matches;
  // Rosallie Le French Cafe, Haraz House and All Fired Up needed a fresh
  // wf_inventory resolution this session could not run (no Google Places API
  // credentials in this sandbox). Second pass, same day: the parent resolved
  // them live on gowayfind.com and pinned the place_ids below, verified
  // against wf_places_cache's Details record where one was cached, and
  // independently address-cross-checked (the venue's own site, or Yelp/
  // OpenTable/wanderlog, or the US Census geocoder for coordinates) where the
  // cache held only photo references.
  { key: "you-do-the-dishes-tampa-palms", placeId: "ChIJIV9AOfbHwogR5SPjijvBLRM",
    match: { name: "You Do the Dishes", city: "Tampa" }, category: "Shopping",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/DcwZw-WMYwt/", creator: "youdothedishesstudio", /* postedAt: "2026-08-31" */ },
      { platform: "instagram", url: "https://www.instagram.com/reel/Dcbfrz8x1Vx/", creator: "youdothedishesstudio", /* postedAt: "2026-08-08" */ }] },
  { key: "nueva-cantina-palm-harbor", placeId: "ChIJsWDK4QLzwogR0CgPI35zaX0",
    match: { name: "Nueva Cantina", city: "Palm Harbor" }, category: "Night out",
    // Same venue-account reel as the Tampa entry above — it covers all of
    // Nueva Cantina's Florida locations per its caption.
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Dcwmv51CK5T/", creator: "nuevacantina", /* postedAt: "2026-08-31" */ },
      // 2026-09-07 fall Instagram batch — second, independent creator on the
      // same venue.
      { platform: "instagram", url: "https://www.instagram.com/reel/Dc6t-0bBDBy/", creator: "foodbytiana" }] },
  { key: "mangoni-italian-market-winter-garden", placeId: "ChIJRStTdYSD54gRhH5dTvKQLJI",
    match: { name: "MANGONI Italian Market Pizza", city: "Winter Garden" }, category: "Food",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Dcw5cIGNi-a/", creator: "alex_pistorio", /* postedAt: "2026-09-01" */ },
      { platform: "instagram", url: "https://www.instagram.com/p/DcyS5k4gVV5/", creator: "mangoniwg", /* postedAt: "2026-09-02" — Haunted Mangoni menu, Sept 5 */ }] },
  { key: "perfect-press-coffee-tampa", placeId: "ChIJc9TZhGDAwogRRHZ5EzKtJIc",
    match: { name: "The Perfect Press Coffee Co.", city: "Tampa" },
    address: "4526 W Village Dr, Tampa, FL 33624", category: "Food",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/DcmGqrZsOaR/", creator: "perfectpresscoffeeco", /* postedAt: "2026-08-24" */ },
      { platform: "instagram", url: "https://www.instagram.com/reel/Dc3xGQTBSp4/", creator: "tampavida", /* postedAt: "2026-09-04" */ }] },
  { key: "breakfast-company-university-parkway", placeId: "ChIJU-JqYJo5w4gRTKYuKEM5uH0",
    match: { name: "The Breakfast Company", city: "Bradenton" },
    // One of FOUR Sarasota-area "The Breakfast Company" rows in wf_inventory
    // (ChIJs8W2IIlBw4gRG6sbw3bA5OM downtown Sarasota/411 N Orange Ave,
    // ChIJhfYOkRU7w4gRbgYxbOvh5ao north Bradenton, ChIJU-JqYJo5w4gRTKYuKEM5uH0
    // UTC/Cooper Creek Blvd, ChIJiVumzT5Bw4gR7mGqEL-DFQ0 Venice-area). Without
    // Google Places credentials this session, disambiguated by address instead
    // of a Details call: utcsarasota.com lists this location's address as
    // 8491 Cooper Creek Blvd Unit 107, Bradenton, FL 34201 — the Shoppes at
    // UTC, immediately off University Parkway at I-75 — and its lat/lng in
    // inventory (27.39087, -82.45427) is the only one of the four that sits
    // in that corridor. The reel's creator is the owner's spouse.
    address: "8491 Cooper Creek Blvd Unit 107, Bradenton, FL 34201", category: "Food",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Dcwuyx8p6Bo/", creator: "cindy.selects", /* postedAt: "2026-08-31" */ }] },
  { key: "universal-citywalk-orlando-dead-coconut-club", placeId: "ChIJEyMWSOd-54gR-QBrGagmCHw",
    match: { name: "Universal CityWalk Orlando", city: "Orlando" }, category: "Nightlife",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Dcg3_aRix46/", creator: "xandra.orlando", /* postedAt: "2026-08-30" — The Dead Coconut Club: Harvest */ }] },
  { key: "universal-studios-florida-hhn35", placeId: "ChIJdd8VlMN-54gRoaU0d_zYhfk",
    match: { name: "Universal Studios Florida", city: "Orlando" }, category: "Activities",
    // v8.96 (2026-09-02) — re-pointed. The id this entry carried,
    // ChIJ1d7qegB_54gRgM3OALxZy_M, is a wrong-entity wf_inventory row: status
    // EXCLUDED, 119 reviews. This id is the real park — OPERATIONAL,
    // 162,083 reviews — confirmed via Supabase before the swap.
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/DcnDTPduWYP/", creator: "beercutieandfoodie", /* postedAt: "2026-08-29" — Downtown Clowntown scare zone, HHN 35 */ },
      { platform: "instagram", url: "https://www.instagram.com/reel/DcwG71-o9xA/", creator: "hallo.ween365days", /* postedAt: "2026-08-31" — Terrifier/ARTmas scare zone, HHN 35 */ },
      { platform: "instagram", url: "https://www.instagram.com/reel/Dcjae_wqInK/", creator: "xandra.orlando", /* postedAt: "2026-08-28" — HHN 35 opening night */ }] },
  { key: "rosallie-le-french-cafe-winter-garden", placeId: "ChIJ15lqd26D54gR0zik2zNTX4o",
    match: { name: "Rosallie Le French Cafe", city: "Winter Garden" },
    address: "141 W Plant St, Winter Garden, FL 34787", category: "Food",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/DcwynTChrOL/", creator: "cheatdayorlando", /* postedAt: "2026-08-31" */ },
      { platform: "instagram", url: "https://www.instagram.com/reel/DcYfc0hBbp9/", creator: "rosallielefrenchcafe", /* postedAt: "2026-08-14" */ }] },
  { key: "haraz-coffee-house-wesley-chapel", placeId: "ChIJQVp535WxwogR42W828PdPRw",
    match: { name: "Haraz Coffee House", city: "Wesley Chapel" },
    address: "1722 Bruce B Downs Blvd, Wesley Chapel, FL 33544", category: "Food",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/DctUcUexTXR/", creator: "mr.tampa.bay", /* postedAt: "2026-08-27" */ }] },
  { key: "all-fired-up-winter-park", placeId: "ChIJjapVvA9w54gRY4Tpi19HXhI",
    match: { name: "All Fired Up", city: "Winter Park" },
    // A brand-level collaboration post with @allfiredupfl about the
    // studio-wide Halloween pottery collection, not a single-location visit —
    // owner-approved to attach to both Florida studios.
    address: "229 W Fairbanks Ave, Winter Park, FL 32789", category: "Activities",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/DcPT0D5Rwn6/", creator: "oliviashannonwolk", /* postedAt: "2026-08-19" */ }] },
  { key: "all-fired-up-waterford-lakes", placeId: "ChIJhbni_xFn54gR0p89LazzSD8",
    match: { name: "All Fired Up", city: "Orlando" },
    // Same brand-level Halloween-collection post as the Winter Park entry
    // above — owner-approved to attach to both studios.
    address: "709 N Alafaya Trail, Orlando, FL 32828", category: "Activities",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/DcPT0D5Rwn6/", creator: "oliviashannonwolk", /* postedAt: "2026-08-19" */ }] },
  { key: "helena-modern-riviera-icon-park", placeId: "ChIJP1om-VJ-54gRAF-_k_y5cig",
    match: { name: "Helena Modern Riviera", city: "Orlando" },
    address: "8441 International Drive, Orlando, FL 32819", category: "Food",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/DcoNdFxBQEx/", creator: "helenamodernriviera", /* postedAt: "2026-08-30" — Sirens of Helena, opens Sept 5 */ },
      { platform: "instagram", url: "https://www.instagram.com/reel/DcsBOu_tzsf/", creator: "cheatdayorlando", /* postedAt: "2026-09-01" */ },
      { platform: "instagram", url: "https://www.instagram.com/reel/Dc18gHiB0hl/", creator: "miriaminspired" }] },

  // ── WO7 (2026-09-02) — "everything available everywhere" (owner). Curated
  // places from the owner's reels get a card wherever they physically are;
  // automated Google spend stays Florida-first (lib/spendGate.js is
  // unaffected — these placeIds were resolved by the parent on the live
  // product, not by a metered call from this session). Every place_id below
  // is written into wf_place_ids by scripts/data/owner-reels-2026-09-02.sql
  // (Universal Studios Hollywood excepted — already indexed). No
  // market/region field exists in this file's entry shape, so none is
  // invented here; geography is carried honestly in `match.city` and
  // `address` exactly as for every Florida entry above. Seasonal content is
  // marked the same way this file already marks it elsewhere — a trailing
  // comment naming the season, greppable as "— fall".
  { key: "tims-pumpkin-patch-marietta", placeId: "ChIJRyvATuoD2okRJNZ_PpKp6GY",
    match: { name: "Tim's Pumpkin Patch", city: "Marietta" }, category: "Activities",
    address: "2901 Rose Hill Rd, Marietta, NY 13110",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/p/DcqoYzrxq1E/", creator: "timspumpkinpatch", /* postedAt: "2026-08-30" — fall */ }] },
  { key: "harvest-moon-farm-orchard-north-salem", placeId: "ChIJt-i--GutwokRPyo0w5TWmfo",
    match: { name: "Harvest Moon Farm & Orchard", city: "North Salem" }, category: "Activities",
    address: "130 Hardscrabble Rd, North Salem, NY 10560",
    // @whats_in_westchester_ny's reel cites Fall Festival weekends Sept
    // 12-Nov 1, 2026 from the venue's OWN post — a real date range, not
    // invented here, but this file carries no event/date fields (that is
    // lib/creatorEvents.js's job, and this venue is 1,100+ miles outside
    // Wayfind's Florida geo guard, so it does not belong there either).
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/DclgocQuTVU/", creator: "harvestmoonorchard", /* postedAt: "2026-08-25" — fall */ },
      { platform: "instagram", url: "https://www.instagram.com/p/DcwZgXToAQB/", creator: "harvestmoonorchard", /* postedAt: "2026-09-01" — fall */ },
      { platform: "instagram", url: "https://www.instagram.com/reel/DcZbvE0KdKp/", creator: "harvestmoonorchard", /* postedAt: "2026-08-14" — fall */ },
      { platform: "instagram", url: "https://www.instagram.com/reel/DctV5mhulUa/", creator: "harvestmoonorchard", /* postedAt: "2026-08-28" — fall */ },
      { platform: "instagram", url: "https://www.instagram.com/reel/DcoJHBPqXJ2/", creator: "whats_in_westchester_ny", /* postedAt: "2026-08-31" — fall, Fall Festival weekends Sept 12-Nov 1 2026 per the venue's own post */ }] },
  { key: "brother-brunos-pizza-wayne", placeId: "ChIJkSQPf539wokRMWt15Ub6os4",
    match: { name: "Brother Bruno's Pizza", city: "Wayne" }, category: "Food",
    address: "200 Hamburg Tpke, Wayne, NJ 07470",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Daiaveutk6Z/", creator: "_queen.sav_", /* postedAt: "2026-07-19" */ }] },
  { key: "cake-your-way-vaughan", placeId: "ChIJd8uvoLE6K4gRwluO461TMro",
    match: { name: "Cake Your Way", city: "Vaughan" }, category: "Food",
    address: "7007 Islington Ave Unit 10, Vaughan, ON L4L 4T5, Canada",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Da8Yak0Tfrb/", creator: "cakeyourway", /* postedAt: "2026-07-14" */ }] },
  { key: "bates-farm-croft", placeId: "ChIJ08paSdYAe0gR2ACKWXW3m6w",
    match: { name: "Bates Farm", city: "Warrington" }, category: "Activities",
    address: "Warrington Rd, Risley, Croft, Warrington WA3 6BN, UK",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/DcrNp2ys7Yl/", creator: "bates_farm", /* postedAt: "2026-08-29" — fall, pumpkin patch Sept 26-27 + October weekends, pre-booking required */ }] },
  { key: "ryan-bros-coffee-city-heights", placeId: "ChIJmR_bwGZV2YAR13jvyWxggPA",
    match: { name: "Ryan Bros Coffee", city: "San Diego" }, category: "Food",
    address: "4465 University Ave, San Diego, CA 92105",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/DcxaafKMX9w/", creator: "ryanbros.cityheights", /* postedAt: "2026-08-30" — fall, espresso flight Sept 1-Halloween, until 2pm, dine-in */ },
      { platform: "instagram", url: "https://www.instagram.com/reel/DcvuNB0sK_k/", creator: "ryanbros.cityheights", /* postedAt: "2026-08-27" — fall */ }] },
  { key: "blackhawk-hardware-charlotte", placeId: "ChIJ31zKXVOeVogRYKJb06G_c7o",
    match: { name: "Blackhawk Hardware and Garden Center", city: "Charlotte" }, category: "Shopping",
    // "family owned since 1977" checked against the store's own site
    // (blackhawkhardware.com/press-release-coolest-hardware-s/: "family
    // owned and operated in the Park Road Shopping Center since 1977")
    // before use, per the coordinator's flag.
    address: "4225 Park Rd, Charlotte, NC 28209",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/p/DcgUQFTAWHM/", creator: "blackhawkhardware", /* postedAt: "2026-08-28" — fall, Halloween decor collection */ }] },
  { key: "splash-art-liverpool", placeId: "ChIJGbN0dcIhe0gRUXJQlOlTlew",
    match: { name: "Splash Art", city: "Liverpool" }, category: "Activities",
    address: "78 Duke St, Liverpool L1 5AA, UK",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/DcRgcd7x4gd/", creator: "splashartuk", /* postedAt: "2026-08-26" */ }] },
  { key: "horror-vibes-coffee-north-hollywood", placeId: "ChIJ6REWkQ2VwoARTSEKn3Yu6eM",
    match: { name: "Horror Vibes Coffee", city: "North Hollywood" }, category: "Food",
    address: "5251 Lankershim Blvd, North Hollywood, CA 91601",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/DcmtOFDz-rk/", creator: "horrorvibescoffee", /* postedAt: "2026-08-27" — fall */ }] },
  { key: "con-azucar-cafe-sylmar", placeId: "ChIJ8UcgMK6PwoARgStBn3cH5n4",
    match: { name: "Con Azucar Cafe", city: "Sylmar" }, category: "Food",
    // The @conazucarcafe pumpkin-conchas reel (DcOjbP4OBK3) is a brand-level
    // post across a multi-location chain and is deliberately NOT attached
    // here — held, per the coordinator, since it does not identify this
    // location specifically.
    address: "13739 Foothill Blvd, Sylmar, CA 91342",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/DcccFq5skNk/", creator: "conazucarcafelosangeles", /* postedAt: "2026-08-25" */ }] },
  { key: "universal-studios-hollywood-hhn", placeId: "ChIJzzgyJU--woARcZqceSdQ3dM",
    match: { name: "Universal Studios Hollywood", city: "Universal City" }, category: "Activities",
    address: "100 Universal City Plaza, Universal City, CA 91608",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/DcWlM6Ao6qO/", creator: "hallo.ween365days", /* postedAt: "2026-08-30" — fall, Clown Cafe, HHN Hollywood */ }] },
  { key: "disneyland-park-anaheim", placeId: "ChIJa147K9HX3IAR-lwiGIQv9i4",
    match: { name: "Disneyland Park", city: "Anaheim" }, category: "Activities",
    address: "1313 Disneyland Dr, Anaheim, CA 92802",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/DboJBJbpWmZ/", creator: "halloweendiet", /* postedAt: "2026-08-15" — fall */ }] },
  { key: "georgetown-drive-in", placeId: "ChIJYWbd5bFBaYgRO9b4WSc6ET8",
    match: { name: "Georgetown Drive-In", city: "Georgetown" }, category: "Activities",
    address: "8200 IN-64, Georgetown, IN 47122",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/DcWmLXlpA4j/", creator: "anoctobersunday", /* postedAt: "2026-08-29" — fall, Slasher Fest, 35mm */ },
      // 2026-09-07 fall Instagram batch — second, independent creator on the
      // same venue.
      { platform: "instagram", url: "https://www.instagram.com/reel/DcQ7BVoRIth/", creator: "kalenawhite" }] },
  { key: "the-bagel-nook-freehold", placeId: "ChIJqwhQSDXTw4kRpobLnZNWJdI",
    match: { name: "The Bagel Nook", city: "Freehold" }, category: "Food",
    // "All locations" per the reel's own caption — a multi-location brand;
    // attached to this flagship (Freehold) location per the coordinator.
    address: "4345 US-9, Freehold, NJ 07728",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/DcvugMVuslg/", creator: "the_bagel_nook", /* postedAt: "2026-08-31" — fall, pumpkin bagels */ }] },

  // ═══════════════════════════════════════════════════════════════════════════
  // 2026-09-07 — a second fall Instagram batch, rebuilt fresh (not replayed
  // from a stale branch). Two entries above (nueva-cantina-palm-harbor,
  // georgetown-drive-in) already existed on main and got a second, independent
  // creator appended to their `videos` array rather than a duplicate stub.
  // wf_inventory placeIds bound where the place already existed; the rest match
  // by name+city (Google Places discovery unavailable this session).
  // ═══════════════════════════════════════════════════════════════════════════
  { key: "good-fortune-st-pete", placeId: "ChIJ6dc1V8nhwogRILD0R9alDWM",
    match: { name: "Good Fortune", city: "St. Petersburg" }, category: "Food",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Dc6M8rFOU2k/", creator: "thingstodotampabay" }] },
  { key: "corazon-by-baires-orlando", placeId: "ChIJk2lxnh5_54gR4KAHboQfZgI",
    match: { name: "Corazon by Baires", city: "Orlando" }, category: "Food",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Dc7Uc9rN2Pp/", creator: "thefloridaplayground" }] },
  { key: "seaworld-orlando-spooktacular", placeId: "ChIJfyPWjCh-54gR1SvWozmef5k",
    match: { name: "SeaWorld Orlando", city: "Orlando" }, category: "Activities",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Dc7bcsIND2O/", creator: "cheatdayorlando" }] },
  { key: "villatel-resort-orlando", placeId: "ChIJsQagnL9_54gRBssKAR3j6S8",
    match: { name: "Villatel Resort Orlando", city: "Orlando" }, category: "Stays",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/DcMBgNBzTuU/", creator: "theghoulishmortal" }] },
  // Not in wf_inventory — no placeId, Google Places discovery down this
  // session. Matched by name + city; address recorded for a future
  // placeId resolution pass.
  { key: "jacks-pumpkin-popup-chicago", match: { name: "Jack's Pumpkin Pop-Up", city: "Chicago" },
    address: "1265 W Le Moyne St, Chicago, IL 60642", category: "Activities",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Dcw78sENKxu/", creator: "jackspumpkinpopup" },
      { platform: "instagram", url: "https://www.instagram.com/reel/DdAPsV2DI28/", creator: "jackspumpkinpopup" }] },
  { key: "adventure-park-sandy-spring", match: { name: "The Adventure Park at Sandy Spring", city: "Sandy Spring" },
    address: "16701 Norwood Rd, Sandy Spring, MD 20860", category: "Activities",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Db9HHHbT-OX/", creator: "adventureparkmd" }] },
  { key: "halloweenville-warrington", match: { name: "Halloweenville", city: "Warrington" },
    address: "Partridge Lakes, Glaziers Lane, Culcheth, Warrington WA3 4AQ", category: "Activities",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Dc8OFmWMJJS/", creator: "halloweenvilleuk" }] },
  { key: "buffalo-phils-wisconsin-dells", match: { name: "Buffalo Phil's", city: "Wisconsin Dells" },
    address: "150 Gasser Rd, Wisconsin Dells, WI 53965", category: "Food",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Dcyq8WvTRXC/", creator: "whatrvdoing" }] },
  { key: "coffinated-coffee-la-puente", match: { name: "Coffinated Coffee", city: "La Puente" },
    address: "1627 N Hacienda Blvd, La Puente, CA 91744", category: "Food",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/DctVqtUzPNP/", creator: "melissagasia" }] },
  // Remaining reviewed associations from the 2026-09-10 owner intake. Rows
  // without a placeId use the established name+city resolver; no identifier or
  // location is inferred. Seasonal posts remain native links, not date sources.
  { key: "wekiva-island-longwood", match: { name: 'Wekiva Island', city: 'Longwood' },
    address: '1014 Miami Springs Drive, Longwood, FL 32779', category: 'Halloween',
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/DdEpGiVgq9r/", creator: "wekivaisland" }] },
  { key: "taza-cafe-fort-myers", match: { name: 'Taza Cafe Fort Myers', city: 'Fort Myers' },
    address: '4458 Cleveland Avenue, Fort Myers, FL 33901', category: 'Food',
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/DdFAiJevTcn/", creator: "tazacafefm" }] },
  { key: "wolfes-produce-riverview", match: { name: "Wolfe's Produce", city: 'Riverview' }, displayName: "Growing Memories at Wolfe's Produce",
    address: '6005 US Highway 301 S, Riverview, FL 33578', category: 'Farm',
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/DcvnLAkBIyJ/", creator: "toddlerfriendlytampabay" }] },
  { key: "mi-cafecito-tampa", match: { name: 'Mi Cafecito', city: 'Tampa' },
    address: '2202 W Platt Street, Tampa, FL 33606', category: 'Coffee',
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Dc57I18xTbz/", creator: "whenintampa" }] },
  { key: "roosters-cigars-coffee-tampa", match: { name: 'Roosters Cigars & Coffee', city: 'Tampa' },
    address: '3103 N Howard Avenue, Tampa, FL 33607', category: 'Coffee',
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Dc3Vjs7hCYo/", creator: "toddlerfriendlytampabay" }] },
  { key: "cleveland-metroparks-zoo", match: { name: 'Cleveland Metroparks Zoo', city: 'Cleveland' },
    address: 'Cleveland, OH', category: 'Activities',
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/DdBmAipNq-h/", creator: "clewithkids" }] },
  { key: "double-six-cafe-tampa", match: { name: 'Double Six Cafe', city: 'Tampa' },
    address: '815 E 7th Avenue, Tampa, FL 33602', category: 'Coffee',
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Dc3xGQTBSp4/", creator: "tampavida" }] },
  { key: "craftsman-row-saloon-philadelphia", match: { name: 'Craftsman Row Saloon', city: 'Philadelphia' },
    address: 'Philadelphia, PA', category: 'Food',
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/DdEQo4bvl2z/", creator: "koryaversa" }] },
  { key: "frankenstein-bier-keller-edinburgh", match: { name: 'Frankenstein & Bier Keller', city: 'Edinburgh' },
    address: 'Old Town, Edinburgh, Scotland', category: 'Night out',
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Db1EZROASQF/", creator: "travel_worth_telling" }] },
  { key: "pintos-farm-miami", match: { name: "Pinto's Farm", city: 'Miami' },
    address: '14890 SW 216 Street, Miami, FL 33170', category: 'Farm',
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/DdAH96yx1xa/", creator: "pintosfarm" },
      { platform: "instagram", url: "https://www.instagram.com/reel/Dc3WlMLx2iv/", creator: "fashion.eat.travel" }] },
  { key: "little-leopard-coffee-tottington", match: { name: 'The Little Leopard Coffee', city: 'Tottington' },
    address: 'South Royd Street, Tottington, Bury, BL8 3LY, United Kingdom', category: 'Coffee',
    videos: [{ platform: "instagram", url: "https://www.instagram.com/p/Dc5nkpsMH9_/", creator: "thelittleleopardcoffee" }] },
  { key: "maymont-richmond", match: { name: 'Maymont', city: 'Richmond' },
    address: '2201 Shields Lake Dr, Richmond, VA 23220', category: 'Activities',
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Dcwn-ivKvst/", creator: "maymont_rva" }] },
  { key: "filoli-woodside", match: { name: 'Filoli', city: 'Woodside' },
    address: '86 Cañada Rd, Woodside, CA 94062', category: 'Activities',
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/DcNMoDCJnyn/", creator: "marin_mommies" }] },
  { key: "bottoms-up-coffee-columbus", match: { name: 'Bottoms Up Coffee', city: 'Columbus' },
    address: 'Columbus, OH', category: 'Food',
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Dc6LAYQvpOt/", creator: "wanderlusttravelcouple" }] },
  { key: "kulturas-pasadena", match: { name: 'Kulturas Latin Kitchen & Cantina', city: 'Pasadena' },
    address: '187 N Sierra Madre Blvd, Pasadena, CA 91107', category: 'Food',
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Dcy54DOCLJP/", creator: "kulturas.pasadena" }] },
  { key: "at-the-diner-dr-phillips", match: { name: '@ The Diner Dr. Phillips', city: 'Orlando' },
    address: 'Dr. Phillips, Orlando, FL', category: 'Food',
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Dc1JISKOJwM/", creator: "josyinorlando" }] },
  { key: "tinez-farms-miami", match: { name: 'Tinez Farms', city: 'Miami' },
    address: '16405 SW 177th Avenue, Miami, FL 33187', category: 'Farm',
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Dc3WlMLx2iv/", creator: "fashion.eat.travel" }] },
  { key: "the-berry-farm-miami", match: { name: 'The Berry Farm', city: 'Miami' },
    address: '13720 SW 216th Street, Miami, FL 33170', category: 'Farm',
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Dc3WlMLx2iv/", creator: "fashion.eat.travel" }] },
  { key: "flamingo-road-nursery-davie", match: { name: 'Flamingo Road Nursery', city: 'Davie' },
    address: '1655 S Flamingo Road, Davie, FL 33325', category: 'Farm',
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Dc3WlMLx2iv/", creator: "fashion.eat.travel" }] },
  { key: "bedners-farm-boynton-beach", match: { name: "Bedner's Farm Fresh Market", city: 'Boynton Beach' },
    address: '10066 Lee Road, Boynton Beach, FL 33473', category: 'Farm',
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Dc3WlMLx2iv/", creator: "fashion.eat.travel" }] },
  { key: "yesteryear-farm-wilsonville", match: { name: 'Yesteryear Farm', city: 'Wilsonville' },
    address: 'Wilsonville, OR', category: 'Activities',
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Dc2Ha9liyr4/", creator: "mrs.motivateyofitness" }] },
  // These roundup subjects are named as featured brands or venues. They use
  // name+city previews because no exact provider identity was verified here.
  // The post is a seasonal roundup, not proof that the creator visited a branch.
  { key: "urban-kai-tampa-bay-roundup", match: { name: "Urban Kai", city: "Tampa Bay" }, displayName: "Urban Kai", displayCity: "Tampa Bay",
    category: "Activities",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Dc3asu4uUOI/", creator: "influencetampa" }] },
  { key: "jekyll-hyde-park-tampa", match: { name: "Jekyll Hyde Park", city: "Tampa" },
    category: "Night out",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Dc3asu4uUOI/", creator: "influencetampa" }] },
  { key: "kerbys-nursery-seffner", match: { name: "Kerby's Nursery", city: "Seffner" },
    category: "Shopping",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Dc3asu4uUOI/", creator: "influencetampa" }] },
  { key: "florida-avenue-brewing-tampa-bay", match: { name: "Florida Avenue Brewing Co.", city: "Tampa Bay" }, displayName: "Florida Avenue Brewing Co.", displayCity: "Tampa Bay",
    category: "Night out",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Dc3asu4uUOI/", creator: "influencetampa" }] },
  { key: "dead-coconut-club-citywalk-orlando", match: { name: "Dead Coconut Club", city: "Orlando" },
    address: "6000 Universal Boulevard, Orlando, FL 32819", category: "Night out",
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Dc19fW8hFX4/", creator: "somehowimeverywhere" }] },
  { key: "santas-christmas-tree-forest-eustis", match: { name: "Santa's Christmas Tree Forest", city: 'Eustis' },
    address: '35317 Huff Road, Eustis, FL 32736', category: 'Farm',
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/DcmJDFWNQcU/", creator: "santasfarm" }] },
  { key: "blackcraft-coffee-los-angeles", match: { name: 'Blackcraft Coffee', city: 'Los Angeles' },
    address: '457 N Fairfax Ave, Los Angeles, CA 90036', category: 'Food',
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Dc2DrP1vCT4/", creator: "blackcraft" }] },
  { key: "lumleys-farm-plant-city", match: { name: "Lumley's Farm", city: 'Plant City' },
    address: '4810 James L Redman Parkway, Plant City, FL 33567', category: 'Farm',
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Dc1tftaJCal/", creator: "lumleysfarm" }] },
  { key: "valas-pumpkin-patch-gretna", match: { name: "Vala's Pumpkin Patch", city: 'Gretna' },
    address: '12102 S 180th St, Gretna, NE 68028', category: 'Activities',
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Dcy2QiqvUjb/", creator: "midwesttravelmama" }] },
  { key: "linvilla-orchards-cafe-media", match: { name: 'Linvilla Cafe', city: 'Media' },
    address: '137 West Knowlton Road, Media, PA 19063', category: 'Food',
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/DbgKsnLuFoh/", creator: "linvillaorchards" }] },
  { key: "lemos-farm-half-moon-bay", match: { name: 'Lemos Farm', city: 'Half Moon Bay' },
    address: '12320 San Mateo Road, Half Moon Bay, CA 94019', category: 'Farm',
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/Db9L1uGSkGx/", creator: "lemosfarmhmb" }] },
  { key: "van-cortlandt-manor-croton", match: { name: 'Van Cortlandt Manor', city: 'Croton-on-Hudson' },
    address: '525 S Riverside Ave, Croton-on-Hudson, NY 10520', category: 'Activities',
    videos: [{ platform: "instagram", url: "https://www.instagram.com/reel/DcvnnXMxjQL/", creator: "table4onesocially" }] },
];
...
export function creatorStats(handle) {
  ...
  for (const e of CURATED) {
    ...
    if (vids.length) spots.push({ key: e.key, name: e.displayName || (e.match && e.match.name) || e.key, city: e.displayCity || (e.match && e.match.city) || "", video: vids[0] });
  }
...
const CITY_COORDS = {
  ...
  // 2026-08-25 — DFB intake: Disney Springs sits in Lake Buena Vista.
  "Lake Buena Vista": { lat: 28.3772, lng: -81.5707 },
  Bradenton: { lat: 27.4989, lng: -82.5748 },
  Sarasota: { lat: 27.3364, lng: -82.5307 },
  "Palm Harbor": { lat: 28.0781, lng: -82.7626 },
  ...
  "Tampa Bay": { lat: 27.9506, lng: -82.4572 }, // regional sort anchor; never a venue coordinate
  ...
  // v8.96 (2026-09-02, WO7) — "everything available everywhere" (owner):
  // curated places from the owner's reels get cards wherever they physically
  // are, no longer Florida-only. First non-Florida/non-US entries in this
  // table. Same rule as every row above: real published coordinates,
  // sort-only, never shown, never presented as a venue's own position.
  // Non-Google sources throughout (US Census geocoder for US cities; a
  // municipal/OSM-derived source for Vaughan and the two UK cities) — see
  // scripts/data/owner-reels-2026-09-02.sql for the exact citation per city.
  Marietta: { lat: 42.9116, lng: -76.3439 }, // NY (Tim's Pumpkin Patch)
  "North Salem": { lat: 41.3500, lng: -73.6344 }, // NY (Harvest Moon Farm & Orchard)
  Wayne: { lat: 40.95, lng: -74.24 }, // NJ (Brother Bruno's Pizza)
  Vaughan: { lat: 43.7651, lng: -79.5743 }, // ON, Canada (Cake Your Way)
  Warrington: { lat: 53.4419, lng: -2.5223 }, // UK (Bates Farm)
  "San Diego": { lat: 32.7495, lng: -117.0983 }, // CA (Ryan Bros Coffee City Heights)
  Charlotte: { lat: 35.1758, lng: -80.8510 }, // NC (Blackhawk Hardware)
  Liverpool: { lat: 53.4016, lng: -2.9819 }, // UK (Splash Art)
  "North Hollywood": { lat: 34.1661, lng: -118.3754 }, // CA (Horror Vibes Coffee)
  Sylmar: { lat: 34.3092, lng: -118.4325 }, // CA (Con Azucar Cafe)
  "Universal City": { lat: 34.1381, lng: -118.3536 }, // CA (Universal Studios Hollywood)
  Anaheim: { lat: 33.8125, lng: -117.9190 }, // CA (Disneyland Park)
  Georgetown: { lat: 38.2957, lng: -85.9605 }, // IN (Georgetown Drive-In)
  Freehold: { lat: 40.2601, lng: -74.2738 }, // NJ (The Bagel Nook)
  // 2026-09-07 — second fall Instagram batch. Same rule as every row above:
  // real published city-center coordinates, sort-only, never shown, never
  // presented as a venue's own position.
  Chicago: { lat: 41.8781, lng: -87.6298 }, // IL (Jack's Pumpkin Pop-Up)
  "Sandy Spring": { lat: 39.1526, lng: -77.0203 }, // MD (The Adventure Park at Sandy Spring)
  "Wisconsin Dells": { lat: 43.6275, lng: -89.7710 }, // WI (Buffalo Phil's)
  "La Puente": { lat: 34.0200, lng: -117.9495 }, // CA (Coffinated Coffee)
  // 2026-09-10 owner intake. Public city centres used only to order the
  // worldwide creator library; these are never venue coordinates or distance
  // claims and never enter Florida's automated discovery rails.
  "Boynton Beach": { lat: 26.5253, lng: -80.0664 },
  Cleveland: { lat: 41.4993, lng: -81.6944 },
  Columbus: { lat: 39.9612, lng: -82.9988 },
  "Croton-on-Hudson": { lat: 41.2084, lng: -73.8912 },
  Edinburgh: { lat: 55.9533, lng: -3.1883 },
  Eustis: { lat: 28.8528, lng: -81.6854 },
  "Fort Myers": { lat: 26.6406, lng: -81.8723 },
  Gretna: { lat: 41.1408, lng: -96.2397 },
  "Half Moon Bay": { lat: 37.4636, lng: -122.4286 },
  "Los Angeles": { lat: 34.0522, lng: -118.2437 },
  Media: { lat: 39.9168, lng: -75.3877 },
  Melbourne: { lat: 28.0836, lng: -80.6081 },
  Pasadena: { lat: 34.1478, lng: -118.1445 },
  Philadelphia: { lat: 39.9526, lng: -75.1652 },
  "Plant City": { lat: 28.0189, lng: -82.1147 },
  Richmond: { lat: 37.5407, lng: -77.4360 },
  Seffner: { lat: 27.9836, lng: -82.2756 },
  Tottington: { lat: 53.6139, lng: -2.3410 },
  Wilsonville: { lat: 45.2998, lng: -122.7737 },
...
export function allCreators() {
  ...
  for (const e of CURATED) {
    for (const v of renderable(e.videos)) {
      ...
      const spot = { key: e.key, name: e.displayName || (e.match && e.match.name) || e.key, city: e.displayCity || (e.match && e.match.city) || "", platform: v.platform, video: v, placeId: e.placeId || null, address: e.address || null, category: e.category || null };
      if (v.creator) {
  ...
  const creators = Array.from(byHandle.values())
    // `spots` deliberately keeps every post so the library can render each
    // submitted link. The page eligibility count is unique venues: two posts
    // about one place must never manufacture a thin indexable creator page.
    .map((c) => ({ handle: c.handle, count: new Set(c.spots.map((s) => s.key)).size, postCount: c.spots.length, spots: c.spots }))
...
// CODEGEN ONLY — scripts/gen-creator-signals.mjs reads this to regenerate
// lib/creatorSignals.js, the lean (no url/address/category/displayName)
// mirror of CURATED that lib/creatorBoost.js and lib/trendSignal.js import
// instead of this file, so the app-wide ranking law (lib/lawfulOrder.js,
// used by every ranked list, client and server) doesn't have to pull this
// module's ~56KB gz of curated-video text just to read a boolean and a
// reach number. Not imported by any app/client/server code — safe to keep;
// see lib/creatorSignals.js's header for the full story.
export const __CURATED_FOR_CODEGEN__ = CURATED;
