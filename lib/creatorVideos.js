...
const CURATED = [
  ...
  { key: "universal-studios-florida-hhn35", placeId: "ChIJ1d7qegB_54gRgM3OALxZy_M",
    match: { name: "Universal Studios Florida", city: "Orlando" }, category: "Activities",
    // This place_id carries a Wayfind-internal EXCLUDED status in wf_inventory
    // (theme parks are handled outside normal place-card serving) — flagged
    // for whoever next touches ranking so this credit is not silently inert.
