...
export const TOWN_NOTES = {
  parrish: {
    food: { line: "Parrish eats like a small town that knows its neighbors: coffee at DNA, smoked ribs, and dockside fish a short hop down the river.", items: [
      { name: "It's In The DNA Coffee", story: "The town's living room; locals treat it as the default meetup." },
      { name: "Rack City Ribz", story: "The smoked-meat favorite that shows up in every local best-of thread." },
      { name: "Dockside on the Manatee", story: "Ten minutes toward Palmetto puts you at river-dock dining like Woody's River Roo and Riviera Dunes.", query: "waterfront restaurant Palmetto" },
    ], mistake: "Judging Parrish by its chains along 301; the good stuff is one street off and one bridge over." },
    night: { line: "Parrish nights are sunsets, not scenes: Fort Hamer Bridge at golden hour, then Waterside Place or Ellenton when you want lights.", items: [
      { name: "Fort Hamer Bridge sunset", story: "The local photo ritual over the Manatee River; bring a chair, stay past the color.", query: "Fort Hamer Park" },
      { name: "Waterside Place", story: "Lakewood Ranch's lakefront district 20 minutes south: live music nights, restaurants, and the Sunday farmers market." },
    ...
    todo: { line: "Parrish's headliner is real: a working railroad museum with scenic rides, plus river preserves most of Florida forgot.", items: [
      { name: "Florida Railroad Museum", story: "Scenic train rides through old Florida with themed runs all year; kids and rail fans drive in from three counties.", query: "Florida Railroad Museum" },
      { name: "Rye Preserve", story: "Trails and quiet Manatee River access; the hidden-gem pick in every local guide.", query: "Rye Preserve" },
    ...
    events: { line: "Parrish staples: Heritage Day parade and chili cook-off each spring, themed trains at the railroad museum year-round, and the Waterside farmers market every Sunday.", items: [
      { name: "Florida Railroad Museum event trains", story: "Holiday, Wild West, and seasonal themed rides are the town's recurring big draw.", query: "Florida Railroad Museum" },
      { name: "Waterside Place farmers market", story: "Sunday mornings, 20 minutes south; the area's best regular market plus lakefront live music." },
