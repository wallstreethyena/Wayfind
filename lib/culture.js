...
export const CULTURE = {
  ...
  tampa: {
    ...
    see: [
      ...
      { name: "Shell Key Preserve", story: "An undeveloped barrier island off Tierra Verde — paddle or boat out, shell, and pack your own shade. Next door to Fort De Soto, without the park roads.", placeId: "ChIJ5_NkHLUcw4gRndvLQGe_Ox8" },
    ],
    say: [
...
export const TOWN_PROFILES = {
  ...
  "st. petersburg": { title: "St. Petersburg", metro: "tampa", tag: "The arts-and-murals city on the bay",
    ...
    beach: { line: "Not beachfront downtown, but St. Pete Beach and a top-ranked wild state-park beach are 20–30 minutes.", items: [
      ...
      { name: "Shell Key Preserve", story: "The undeveloped island next to Fort De Soto — kayak or boat out, no roads, pack shade.", place: "Shell Key Preserve", placeId: "ChIJ5_NkHLUcw4gRndvLQGe_Ox8", farOk: true },
    ] },
  ...
  "st. pete beach": { title: "St. Pete Beach", metro: "tampa", tag: "Classic Florida sand",
    ...
    todo: { line: "The beach, the iconic 1928 Pink Palace, a walkable avenue of shops with a Sunday market, and an island shell run by boat.", items: [
      ...
      { name: "Shell Key Preserve", story: "The island shell run: paddle or boat to an undeveloped preserve, no roads, pack your own shade.", place: "Shell Key Preserve", placeId: "ChIJ5_NkHLUcw4gRndvLQGe_Ox8", farOk: true },
    ] },
    beach: { line: "Wide, classic Gulf beaches — plus a nearby state-park beach regularly ranked among America's best. This is a true beach destination.", items: [
      ...
      { name: "Shell Key Preserve", story: "The undeveloped island next door — kayak or boat out from Tierra Verde, no roads, pack shade.", place: "Shell Key Preserve", placeId: "ChIJ5_NkHLUcw4gRndvLQGe_Ox8", farOk: true },
    ] },
