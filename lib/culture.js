...
export const CULTURE = {
  ...
  sarasota: {
    ...
    do: [
      ...
      { name: "The Ringling", story: "The circus king's bayfront palace: art museum, mansion, and circus museum in one estate that explains why culture lives here.", query: "Ringling Museum tickets" },
    ],
    see: [
