...
// lib/creatorVideos.js. corroborationTrend() below is called synchronously
// by lib/lawfulOrder.js's governedScoreOf() (client AND server, on every
// ranked row), so this import can never be made lazy without changing sort
// order during the load window. It only needs a creator COUNT, which
// lib/creatorSignals.js answers from a ~17KB-gz lean mirror instead of
// lib/creatorVideos.js's full ~56KB-gz curated registry (url, captions,
// address and all) — see that file's header.
