...
export const PROVIDER_LABELS = {
  ...
  awin_usghostadventures: "US Ghost Adventures",
  awin_rentcars: "Rentcars",
  awin_caesarsshows: "Caesars Shows",
  ...
  // Lane E, 2026-09-16: PROVIDERS.wegotrip went live for 4 curated products.
  // Without a label here the redirect's disclosure would have read "via
  // wegotrip" in lowercase — same class of gap the citypass note above fixed.
  wegotrip: "WeGoTrip",
};
