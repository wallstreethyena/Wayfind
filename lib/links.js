...
export function safeUrl(url) {
  ...
  // 2026-09-02: a host on the quarantine ledger (lib/linkQuarantine.js) is a
  // destination we have SEEN serving hijacked content. It validates as a URL
  // and answers 200 — and it must never be rendered or opened. Null here means
  // every caller hides the control, exactly like a malformed link.
  if (isQuarantinedHost(u.hostname)) return null;
  return u.href;
}
