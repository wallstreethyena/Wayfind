...
export const SUBFILTERS = {
  food: [
    ...
    { id: "brunch", label: "Brunch", query: "best brunch spots" },
    ...
    { id: "dessert", label: "Dessert", query: "best desserts bakeries and ice cream" },
    { id: "drinks", label: "Drinks", query: "best bars and cocktail lounges" },
  ],
  nightlife: [
    ...
    { id: "winebars", label: "Wine bars", query: "wine bars" },
  ...
  beach: [
    ...
    { id: "waterfront", label: "Waterfront dining", query: "waterfront restaurants" },
    { id: "parks", label: "Parks", query: "beachfront parks and boardwalks" },
...
function normalize(p) {
  ...
  try {
    if (p.photos && p.photos.length) {
      ...
      photoAttrs = p.photos.slice(0, 8).map((ph) => { try { const a = ph.authorAttributions && ph.authorAttributions[0]; return (a && (a.displayName || a.display_name)) || ""; } catch (e) { return ""; } });
