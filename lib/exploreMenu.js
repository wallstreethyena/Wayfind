...
// results were unreliable). Its slot becomes "Order In": delivery-worthy food
// ranked by the Wayfind Score, opening the dedicated /order-in page (kind
// "delivery" is handled by openCurated as a route, not a curated list).
...
export const EXPLORE_TILES = {
  ...
  eat: { label: "Order In", sub: "Delivery-worthy food, ranked by our Score.", icon: "food", kind: "delivery" },
...
// always first; at 3:33 PM local, "Night Out" jumps to #2 (and "Order In"
// follows food — delivery intent peaks in the evening).
const ORDER_DAY = ["today", "food", "eat", "stay", "night"];
const ORDER_EVENING = ["today", "night", "eat", "food", "stay"];
