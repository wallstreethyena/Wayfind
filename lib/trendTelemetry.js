...
export const TREND_EVENTS = {
  ...
  // ── Exploding Near You activation experiment ───────────────────────────
  EXPLODING_SECTION_IMPRESSION: "exploding_section_impression",
  TREND_IMPRESSION: "trend_impression",
  TREND_EXPAND: "trend_expand",
  PRIMARY_TREND_CARD_CLICK: "primary_trend_card_click",
  TREND_HORIZONTAL_SCROLL: "trend_horizontal_scroll",
  ADDITIONAL_TREND_PLACE_CLICK: "additional_trend_place_click",
  PLACE_DETAIL_VIEW: "place_detail_view",
  SIGNUP_AFTER_INTERACTION: "signup_after_interaction",
  RETURN_VISIT: "return_visit",
  TIME_TO_FIRST_MEANINGFUL_INTERACTION: "time_to_first_meaningful_interaction",
  INTERACTION_WITHIN_12_SECONDS: "interaction_within_12_seconds",
};
...
export const ALLOWED_PROPS = [
  ...
  "baseline_rank",
  "adjusted_rank",
  "reason_code",       // machine-readable, never free prose from a source row
  "count",
  "status",
  "shadow",
];
 ...
 *
 * `topic_name` is forbidden because the stable `topic_id` carries the same
 * analytical value without sending unnecessary source text to a third-party
 * analytics processor.
 */
...
export const SUCCESS_METRICS = [
  { metric: "exploding_to_place_ctr", numerator: "primary_trend_card_click + additional_trend_place_click", denominator: "exploding_section_impression" },
  { metric: "visitor_place_click_rate", numerator: "sessions with primary_trend_card_click or additional_trend_place_click", denominator: "sessions with exploding_section_impression" },
  { metric: "interaction_within_12_seconds_rate", numerator: "interaction_within_12_seconds where within_12_seconds=true", denominator: "exploding_section_impression" },
  { metric: "median_time_to_first_meaningful_interaction", numerator: "time_to_first_meaningful_interaction elapsed_ms", denominator: "sessions with exploding_section_impression" },
