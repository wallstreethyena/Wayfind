...
export const DEFAULT_COLLAPSED_RAILS = ["best", "eat", "quickbite", "todo", "gems", "creators", "tonight", "drive", "budget", "events", "trends"];
...
export function readCollapsed() {
  ...
  try {
    ...
    return raw == null ? DEFAULT_COLLAPSED_RAILS.slice() : parseCollapsed(raw);
  } catch (e) { return DEFAULT_COLLAPSED_RAILS.slice(); }
}
...
export const RAIL_IDS = ["exploding", "best", "eat", "todo", "gems", "creators", "tonight", "drive", "budget", "events", "trends"];
