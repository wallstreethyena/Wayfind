...
// Do not import inventoryServe (chipIdentity graph) or google.js (Next
// extensionless imports break the Node exploding test). This file is
// homepage JS; the 496.2 CI fail was inventoryServe pulling identity
// tables into the route chunk.
...
// 2026-08-11 (owner): every supplied trend with verified local inventory earns
// its module — the cap is the size of the licensed universe, not a head-of-3.
export const EXPLODING_NEARBY_MAX_TRENDS = 20;
...
export function inventoryDistanceMi(place, center) {
  ...
  return haversineMeters(center.lat, center.lng, place.lat, place.lng) / 1609.344;
}
