...
export const BIRTHDAY_RAIL_DEFS = [
  { id: "gifts", title: "Birthday Free Gifts", deck: "Free birthday treats worth claiming." },
  { id: "upscale", title: "Upscale Birthday Dinner", deck: "Celebration dinners that feel genuinely special." },
  { id: "private", title: "Private Dining Rooms", deck: "Your own room for the celebration." },
  { id: "rooftops", title: "Rooftops", deck: "Skyline views with open-air celebration energy." },
  { id: "beachfront", title: "Beachfront Birthdays", deck: "Celebrate with sand, water, and sunset views." },
  { id: "clubs", title: "Dance Clubs", deck: "Dance floors made for birthday energy." },
  { id: "speakeasies", title: "Speakeasies", deck: "Hidden rooms, low light, serious cocktails." },
];
...
// distance ASC, then place_id ASC. Same name-dedupe shape this file always
// had — kept in rankRailPlaces so nightOutIntent and this file stop carrying
// two copies of one rule.
const uniqueRankedPlaces = rankRailPlaces;
