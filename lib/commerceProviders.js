...
import { clippDeepLink, hasCjPid } from "./deals.js";
...
export const PROVIDERS = {
  ...
  ticketnetwork: curatedTpProvider("ticketnetwork", [/(^|\.)ticketnetwork\.com$/i]),
  ...
  citypass: {
    ...
    track: (url) => {
      ...
      return row ? cityPassTrackedUrl(row.offerId, "intent_partner") : null;
    },
