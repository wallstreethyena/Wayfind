...
export const PROVIDERS = {
  viator: {
    ...
    // Registry-first, table-second. Hand-verified exact product URLs (the
    // 2026-08-19 place-card pin batch) live in partnerOfferRegistry under
    // provider "viator". Product-code hooks (412732P1, …) are NOT in that
    // registry and still resolve against wf_experiences. A resolve miss
