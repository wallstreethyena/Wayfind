...
// verifiable claims only, affiliate links disclosed. bookQuery is editorial
// search text for a render-time product upgrade — it must not paint as Book
// when the dest is still a search. hotel:true drives a Booking.com rate link.
...
// DATED archive — expire promotion after the event window; never delete this
// file or /guides/tonights-move-tampa-september-12-2026.
import { TONIGHTS_MOVE_TAMPA_2026_GUIDES } from "./guidesTonightsMoveTampa2026.js";
import { FLORIDA_LOVEBUG_GUIDES } from "./guidesFloridaLovebug.js";
import { FOOD_CITY_2026_GUIDES } from "./guidesFoodCities2026.js";
// DATED archive, Red Bull Dance Your Style weekend (Sept 18 and 19, 2026).
// Expire promotion after the event; never delete the file or URL.
import { RED_BULL_TAMPA_2026_GUIDES } from "./guidesRedBullTampa2026.js";
import { PINTOS_FARM_2026_GUIDES } from "./guidesPintosFarm2026.js";

import { COVERAGE_2026_GUIDES } from "./guidesCoverage2026.js";
...
export const GUIDES = {
  "swim-with-manatees-crystal-river": {
    ...
    picks: [
      ...
      { name: "Homosassa Springs Wildlife State Park", indoor: false, appQuery: "Ellie Schiller Homosassa Springs Wildlife State Park", placeId: "ChIJTTHiI8w_6IgR89hvVjSS-vc", blurb: "Fifteen minutes south, this state-park refuge is the year-round answer: a spring-fed viewing setup with daily programs built around rehabbing manatees and a floating underwater observatory. It delivers a guaranteed sighting on the summer days when the wild springs are quiet.", tip: "It is the fallback that holds up when the season or the weather is against you." },
  ...
  "bioluminescence-kayak-tour-space-coast": {
    ...
    picks: [
      ...
      { name: "The dark water inside Merritt Island refuge", indoor: false, appQuery: "Merritt Island National Wildlife Refuge", placeId: "ChIJ5RBa1A604IgR0u0SUVMbBQE", blurb: "The least light-polluted water sits inside the wildlife refuge north of the Kennedy Space Center, which is exactly why the glow reads brightest there. It is also some of the calmest, shallowest paddling on the lagoon.", tip: "If a rocket launch lands on your night, the refuge gives you a dark-sky seat for both.", bookQuery: "Cocoa Beach bioluminescence kayak tour" },
  ...
  "florida-scalloping-crystal-river-homosassa": {
    ...
    picks: [
      { name: "A guided scallop trip from Crystal River or Homosassa", indoor: false, appQuery: "Crystal River", placeCard: false, blurb: "The easy way in: a captain runs you to the productive flats, hands you a mask and a mesh bag, and already knows which grass beds are holding scallops that week. Best for anyone without their own boat.", tip: "Book early; summer weekend trips fill fast and the best captains sell out.", bookQuery: "Crystal River scalloping tour" },
  ...
  "weeki-wachee-kayak-mermaids-guide": {
    ...
    picks: [
      { name: "Paddle the Weeki Wachee River (reserve ahead)", indoor: false, appQuery: "Weeki Wachee Springs State Park", placeId: "ChIJz3OOrDIg6IgRMKjzAPsV3NI", blurb: "The main event: a 2.8-mile paddle down a spring-clear river over white sand, shuttled back to the launch. The park caps launches at 280 people a day to protect the river, so it books out well ahead in summer.", tip: "Reserve your launch weeks ahead in season; walk-ups are routinely turned away once the cap is hit.", bookQuery: "Weeki Wachee kayak" },
      { name: "The live mermaid show", indoor: false, appQuery: "Weeki Wachee Springs State Park", placeId: "ChIJz3OOrDIg6IgRMKjzAPsV3NI", blurb: "The 1947 underwater theater still runs: performers breathing from hidden air hoses inside the spring, on a first-come seating basis at set showtimes. It is the reason the park became a Florida landmark.", tip: "Seating is first-come; claim seats before the first show on a busy summer day." },
      { name: "Buccaneer Bay, the spring-fed water park", indoor: false, appQuery: "Weeki Wachee Springs State Park", placeId: "ChIJz3OOrDIg6IgRMKjzAPsV3NI", blurb: "The only spring-fed water park in Florida: slides that drop you into 74-degree spring water and a sandy swimming beach, open in the summer season. Park admission covers it along with the mermaid show.", tip: "It is the built-in cool-down after the paddle; the spring water stays cold straight through August." },
  ...
  "winter-park-scenic-boat-tour": {
    ...
    picks: [
      { name: "What the hour actually covers", indoor: false, appQuery: "Winter Park Scenic Boat Tour", placeId: "ChIJ4XkjoBtw54gRGiqFxtWvbM8", blurb: "Three lakes and two hand-dug canals barely wider than the pontoon, with Spanish moss brushing overhead. The narration mixes mansion gossip, Rollins College history, and genuine old-Florida knowledge.", tip: "Left side of the boat gets the best canal shade and photo angles.", bookQuery: "Winter Park scenic boat tour" },
      { name: "Tickets, timing, and the cash catch", appQuery: "Winter Park Scenic Boat Tour", placeId: "ChIJ4XkjoBtw54gRGiqFxtWvbM8", blurb: "Tours leave hourly from the Morse Boulevard dock; no reservations, first-come. The famous quirk: the ticket window is cash or check only, and the ATM walk will cost you your boat slot on busy days.", tip: "Weekday mornings walk right on; weekend afternoons can mean an hour wait." },
      { name: "Make it a Winter Park day", appQuery: "Winter Park, FL", placeCard: false, blurb: "The dock sits two blocks off Park Avenue: Tiffany glass at the Morse Museum, lunch on the Avenue, and the boat tour makes the single best non-park day in Orlando.", tip: "SunRail from downtown stops three blocks from the dock, making this Orlando's easiest car-free outing." },
    ],
    faq: [
  ...
  "siesta-key-drum-circle": {
    ...
    picks: [
      { name: "When and exactly where", indoor: false, appQuery: "Siesta Beach", exactNames: ["Siesta Beach", "Siesta Key Beach"], blurb: "Sundays year-round, starting roughly two hours before sunset and peaking as the sun drops. Walk south from the main Siesta Beach pavilion about 200 yards; follow the drums.", tip: "Check the sunset time for your date and arrive 90 minutes early for a decent spot on busy season Sundays." },
      { name: "Parking without the meltdown", appQuery: null, blurb: "The free main lot fills by mid-afternoon on Sundays. The move is the free Siesta Key Breeze trolley, which runs the length of the island and drops at the beach entrance.", tip: "Park once in the Village, dinner after, trolley both ways." },
      { name: "The unwritten rules", appQuery: null, blurb: "Anyone can drum, dance, or watch; the circle is participatory. What draws stink-eye: flash photography in people's faces, standing dead center, and leaving trash on the sand.", tip: "Bring a drum if you have one; nobody auditions." },
    ],
    faq: [
  ...
  "pinecraft-sarasota-amish-village": {
    ...
    picks: [
      { name: "Yoder's Restaurant", indoor: true, placeId: "ChIJIwZqEutAw4gR-1cOUgiln24", blurb: "The anchor since 1975. Fried chicken, real mashed potatoes, and the peanut butter cream pie that draws the line out the door. Featured on national food TV and somehow still underrated.", tip: "Closed Sundays, cash-friendly, and the pie counter next door skips the restaurant wait." },
      { name: "Der Dutchman", indoor: true, placeId: "ChIJSxtyZcBAw4gRrgOGwbkWXIU", blurb: "The bigger Amish kitchen up the street: broasted chicken, a bakery the size of a gift shop, and breakfast that ends any diet.", tip: "The bakery's cinnamon rolls sell out on winter weekends by late morning." },
      { name: "The village itself", indoor: false, appQuery: "Pinecraft Park", exactNames: ["Pinecraft Park"], blurb: "Walk Pinecraft Park at dusk in season and you'll find shuffleboard leagues, bocce, and tricycles parked twenty deep. Big Olaf's ice cream, founded by an Amish family, closes the evening properly.", tip: "Season peaks January through March, when the Pioneer Trails buses arrive from Ohio and Indiana weekly." },
      { name: "How to visit respectfully", appQuery: null, blurb: "This is a residential neighborhood, not an attraction. Photograph the place, not the people, without asking; dress modestly in the restaurants; and remember Sunday is genuinely quiet.", tip: "If you're respectful, conversation comes easy; residents are famously warm with visitors." },
    ],
    faq: [
  ...
  "siesta-key-vs-lido-key": {
    ...
    picks: [
      { name: "Siesta Key: the sand", indoor: false, appQuery: "Siesta Beach", exactNames: ["Siesta Beach", "Siesta Key Beach"], blurb: "The 99% quartz sand is genuinely different, powder-cool even at noon, and the beach is vast. It's also the busy one: spring break energy, packed village bars, and a parking hunt after 10am.", tip: "The free lot fills early; ride the open-air Breeze trolley instead of circling." },
      { name: "Lido Key: the balance", indoor: false, appQuery: "Lido Beach", exactNames: ["Lido Beach", "Lido Key Beach"], blurb: "Softer crowds, easy parking, and St. Armands Circle's restaurants a five-minute walk from the sand. The sand is fine white, not quartz, and nobody sober complains.", tip: "North Lido is the quiet stretch locals keep to themselves." },
      { name: "The verdict", appQuery: null, blurb: "First visit or beach-obsessed: Siesta, the sand earns the hassle once. Staying several days, dining well, or traveling with people who hate crowds: Lido wins the week.", tip: "Do Siesta's Sunday sunset drum circle regardless of where you base." },
    ],
    faq: [
  ...
  "things-to-do-sarasota": {
    ...
    picks: [
      { name: "The Ringling", indoor: true, placeId: "ChIJ6y2dx9g_w4gRWoZIRhLk-JI", blurb: "John Ringling's 66-acre bayfront estate: a serious art museum, the Ca' d'Zan mansion, and the circus museum with the world's largest miniature circus.", tip: "Mondays the art museum is free; the grounds alone justify the trip.", bookQuery: "Ringling Museum" },
      { name: "Kayak Lido's mangrove tunnels", indoor: false, appQuery: "Ted Sperling Nature Park", placeId: "ChIJJ3XVfEhrw4gRY3oXQ874Cco", blurb: "Paddle shaded tunnels where manatees and dolphins turn up regularly, minutes from downtown.", tip: "Morning glass-calm water beats afternoon wind.", bookQuery: "Sarasota mangrove kayak tour" },
      { name: "Pinecraft", indoor: false, placeCard: false, blurb: "A genuine Amish and Mennonite winter village inside the city, tricycles, shuffleboard, and Yoder's pie. One of Florida's most unexpected neighborhoods.", tip: "Yoder's is cash-friendly and closed Sundays." },
      { name: "Marie Selby Botanical Gardens", indoor: false, placeId: "ChIJPTvxtmpAw4gReToYD5mTNwE", blurb: "Bayfront gardens with the world's best epiphyte collection, orchids and air plants in open air.", tip: "The banyan grove is the photo." },
      ...
      { name: "Sarasota Farmers Market", indoor: false, placeId: "ChIJyWJV1WxAw4gRv8El830m2PY", blurb: "Saturday mornings downtown since 1979, produce to live music; the town shows up." },
      // v5.36 picks 7–10 (owner-approved 2026-07-11). Same voice, real
      // operating places.
      { name: "Myakka River State Park", indoor: false, placeId: "ChIJxaeEtGVMw4gRd5SI3lZDqnY", blurb: "One of Florida's oldest and largest state parks, twenty minutes east: a canopy walkway over the treetops, airboats on the Upper Lake, and more wild alligators than you'll count.", tip: "The weir near the south entrance is the reliable gator sighting when the lake boats aren't running.", bookQuery: "Myakka River State Park" },
      { name: "Sarasota Jungle Gardens", indoor: false, placeId: "ChIJ_37IauQ_w4gRz03lc0QInIE", blurb: "Ten acres of old Florida running since 1939 — flamingos that eat from your hand, bird shows, and a mercifully un-modernized charm no new attraction can fake.", tip: "The flamingo feeding is the memory; buy the food cup on the way in.", bookQuery: "Sarasota Jungle Gardens" },
      { name: "Ride the Legacy Trail", indoor: false, appQuery: "The Legacy Trail", placeId: "ChIJRzUAPopDw4gR8YbL_V5iSWo", blurb: "A paved rail-trail rolling south from Sarasota toward Venice through parks and pine flatwoods. Locals commute-cruise it; visitors get the county without a windshield.", tip: "Rent at the Sarasota trailhead and turn around at Osprey Junction; the full run to Venice is a real ride.", bookQuery: "Legacy Trail Sarasota bike rental" },
      { name: "The Celery Fields", indoor: false, appQuery: "Celery Fields", placeId: "ChIJ7-I5X4tHw4gRAK6g4JEha7M", blurb: "The county's birding mecca: boardwalks over restored wetlands where 200-plus species turn up, plus a climbable hill — a genuine rarity in flat Florida — with the best free view around.", tip: "Go at golden hour; the Audubon boardwalk on Palmer is where the spoonbills are." },
    ],
    faq: [
  ...
  "best-cuban-sandwich-tampa": {
    ...
    picks: [
      ...
      { name: "La Segunda Central Bakery", indoor: true, placeId: "ChIJXTeLe0XEwogR-wheRdFeKEY", blurb: "Baking Tampa's Cuban bread since 1915 with the palmetto leaf scored down each loaf; most great Cubans in town start here anyway, so go to the source.", tip: "Take a loaf to go; it doesn't survive the drive home uneaten." },
      { name: "West Tampa Sandwich Shop", indoor: true, placeId: "ChIJPbUnl43DwogRz7WNKvF2Avw", blurb: "A no-frills counter that beat celebrity chefs in citywide Cuban contests; presidents have detoured here.", tip: "Cash, weekday mornings, order the Cuban with a cafe con leche." },
  ...
  "st-armands-circle-restaurants": {
    teaser: "Café on St. Armands serves coffee and dinner, but the Wet Bar is the more casual stop.",
    region: "Sarasota",
    ...
    picks: [
      { name: "Columbia Restaurant", placeId: "ChIJaTQEjpFqw4gRnHJU2Klfw0o", blurb: "The Sarasota outpost of Tampa's 1905 institution; the 1905 Salad tossed tableside and the Cuban bread travel perfectly across the bay.", tip: "The courtyard tables are the seat." },
      { name: "Café on St. Armands", indoor: true, appQuery: "Café on St. Armands", exactNames: ["Café on St. Armands"], placeId: "ChIJ8_xGlpFqw4gRpBDnt0x_mdg", blurb: "The former Café L'Europe space now serves coffee, lunch, and dinner with patio seating on the Circle.", tip: "The Wet Bar gives the room a more casual stop-in option." },
      ...
      { name: "Crab & Fin", indoor: true, placeId: "ChIJrS5xlJFqw4gR6kPVXoSwct0", blurb: "The seafood splurge with the raw bar and live piano on the patio.", tip: "Stone crab in season is why you're here." },
      { name: "Kilwins", indoor: true, placeId: "ChIJrdrmAJJqw4gRcHU7hwuv-3c", blurb: "Yes, the fudge chain, but the after-dinner waffle-cone stroll around the lit Circle is the actual Sarasota ritual.", tip: "One scoop; the cones are enormous." },
      { name: "Blue Dolphin Café", indoor: true, placeId: "ChIJ-REJt5Fqw4gRLOdF-9RkZe4", blurb: "The locals' breakfast counter hiding among the boutiques; beach-day fuel without resort pricing.", tip: "Before 9am on weekends beats the wait." },
    ],
    faq: [
      ...
      { q: "What if I want brunch, or a date-night table that is not on the Circle?", a: "Use the Gulf Coast brunch and date night guide. It starts with Original Word of Mouth in Venice for morning and Ophelia's on the Bay for dinner, then a short rail of Atlas cards." },
    ],
    sources: [
      { label: "Café on St. Armands official site", url: "https://cafeonstarmands.com/" },
    ],
  },
  "best-restaurants-disney-springs": {
    ...
    region: "Orlando",
    // SEO recovery (2026-09-23) — low-CTR fix: 1,732 impressions / 1 click,
    // query "best restaurants disney springs" (the `keyword` field below).
    // Old title buried that phrase after "The 7 ... Ranked by a Local"; this
    // leads with it and states the count as the value, not the byline. The
    // description names real top picks from this guide's own `picks` array
    // below — data the page already renders, no new lookup.
    title: "Best Restaurants at Disney Springs (2026): Top 7",
    description: "The 7 best restaurants at Disney Springs, ranked locally: The Boathouse, Morimoto Asia, and Homecomin' top the list, with what to order at each.",
    ...
    picks: [
      { name: "The Boathouse", indoor: true, placeId: "ChIJyWaYUYd_3YgR7gx9sx98KI0", blurb: "Steak and seafood on the water with the amphicar launch as dinner theater. The filet and the baked Alaska are the plays; ask for dock seating at sunset.", tip: "Walk-up bar seating is the locals' workaround when reservations are gone." },
      { name: "Morimoto Asia", indoor: true, placeId: "ChIJF7KJye5-3YgR0mRAbGMtS10", blurb: "Iron Chef Masaharu Morimoto's pan-Asian flagship. The Peking duck for two is the signature and worth planning around.", tip: "Lunch menu carries several dinner items at lower prices." },
      { name: "Homecomin'", indoor: true, placeId: "ChIJk5xl2oZ_3YgRg7yR_vn87h4", blurb: "Chef Art Smith's Florida comfort food. The fried chicken and doughnuts made this the Springs' hardest table; hummingbird cake to finish.", tip: "The bar pours moonshine cocktails without the dining wait." },
      { name: "Wine Bar George", indoor: true, appQuery: "Wine Bar George - A Restaurant & Bar", exactNames: ["Wine Bar George - A Restaurant & Bar"], placeId: "ChIJ_7j9pYd_3YgRmJkanPMuZ0k", blurb: "The only Master Sommelier-led wine bar in Florida, 140+ wines by the glass and ounce, and the frozen wine slushies are better than they have any right to be.", tip: "Go for the burger; it quietly competes with the wine." },
      { name: "Jaleo by José Andrés", indoor: true, appQuery: "Jaleo", exactNames: ["Jaleo"], placeId: "ChIJ0_My9aR_3YgRQnilGsmaCps", blurb: "Spanish tapas from a legendary chef; the paella cooked over wood fire and the gin and tonics carry the menu.", tip: "Weekday lunch is the value window." },
      { name: "Gideon's Bakehouse", indoor: true, placeId: "ChIJPd6UAfJ_3YgRP-V0GS5jS8I", blurb: "The half-pound cookies with the cult line. The virtual queue opens in the morning and caps fast.", tip: "Join the virtual line before noon, then shop while you wait." },
      { name: "T-REX Cafe", indoor: true, appQuery: "T-Rex Cafe", exactNames: ["T-Rex Cafe"], placeId: "ChIJO3vjMIF_3YgRqb3SdwzbyII", blurb: "If you're with kids who need spectacle, T-REX delivers animatronic dinosaurs and a menu built for them. Adults dining without kids should trade it for any pick above.", tip: "Ask for the Ice Cave room." },
    ],
    faq: [
  ...
  "best-hotels-near-magic-kingdom": {
    ...
    picks: [
      { name: "Disney's Contemporary Resort", indoor: true, placeId: "ChIJ96XKNOZ-3YgR21T9j0Kq8Qc", blurb: "The only hotel you can walk to Magic Kingdom from, ten minutes gate to gate, with the monorail running through the lobby.", tip: "Garden wing rooms cost meaningfully less than the tower.", hotel: true },
      { name: "Disney's Polynesian Village Resort", indoor: true, placeId: "ChIJy-qcFhl-3YgRMvawaCwY1RE", blurb: "Monorail access, the best resort beach on Seven Seas Lagoon, and fireworks views from the sand with the soundtrack piped in.", tip: "Capt. Cook's quick service is a budget saver inside a deluxe resort.", hotel: true },
      { name: "Disney's Grand Floridian", indoor: true, placeId: "ChIJAZ2Ywx1-3YgRMOY_HCjnAXk", blurb: "The flagship. Monorail plus a walking path to Magic Kingdom, afternoon tea, and the highest polish on property.", tip: "Outer building rooms beat main building on price.", hotel: true },
      { name: "Disney's Wilderness Lodge", indoor: true, placeId: "ChIJk56jVSZ-3YgRn_VPMtC9CdI", blurb: "Boat to Magic Kingdom through pine forest; the lobby alone is an attraction. Usually the cheapest deluxe with direct water access.", tip: "Courtyard view rooms give the geyser show for less.", hotel: true },
      { name: "Disney's Fort Wilderness Cabins", indoor: true, placeId: "ChIJ-8Eajc5_3YgRnNnghOJqkrc", blurb: "Full cabins with kitchens, boat access, and the campfire sing-along; the sleeper pick for families of five-plus.", tip: "The Hoop-Dee-Doo Revue here is Disney's longest-running show for a reason.", hotel: true },
      { name: "Four Seasons Orlando", indoor: true, placeId: "ChIJZQAgqdt_3YgRnCLWjBzzC28", blurb: "Off the monorail but the best pure hotel in the area, with a lazy river kids don't want to leave and adult luxury everywhere else.", tip: "Character breakfast here skips park crowds entirely.", hotel: true },
    ],
    faq: [
  ...
  "gatorland-vs-wild-florida": {
    ...
    picks: [
      { name: "Gatorland: the classic park", indoor: false, appQuery: "Gatorland", placeId: "ChIJ9RHZGx6H3YgRnWVYIWsHNPM", blurb: "The 'Alligator Capital of the World' since 1949. Stronger shows (Gator Jumparoo), a breeding marsh boardwalk with wild birds, the white leucistic gators, and a zip line over the alligator pens for the brave.", tip: "The Screamin' Gator zip line sells out; book it, not just admission.", viatorUrl: "https://www.viator.com/tours/Orlando/Gatorland-General-Admission-Ticket/d663-3458ENTRY" },
  ...
  "things-to-do-orlando-not-theme-parks": {
    ...
    picks: [
      { name: "Airboat the Everglades headwaters", indoor: false, appQuery: "Boggy Creek Airboat Adventures", exactNames: ["Boggy Creek Airboat Adventures"], placeId: "ChIJE1158xWa3YgRyxYmba83M0o", blurb: "Take an airboat onto the headwaters south of Orlando, where the ride crosses open marsh and wildlife habitat rather than a staged park course.", tip: "Reserve ahead and allow for weather delays; wildlife sightings are not guaranteed.", bookQuery: "Orlando airboat tour" },
      { name: "Winter Park scenic boat tour", indoor: false, appQuery: "Scenic Boat Tour", exactNames: ["Scenic Boat Tour"], placeId: "ChIJ4XkjoBtw54gRGiqFxtWvbM8", blurb: "A pontoon glide through chain-of-lakes mansions and moss canals, running since 1938. Pair it with Park Avenue lunch and the Morse Museum's Tiffany glass.", tip: "Cash or check only at the dock; it's part of the charm.", bookQuery: "Winter Park boat tour" },
      { name: "Kayak a natural spring", indoor: false, appQuery: "Kelly Park - Rock Springs", exactNames: ["Kelly Park - Rock Springs"], placeId: "ChIJw5hmHut154gRI1LE7BjQiEg", blurb: "Launch from Camp Joy through the Kelly Park gate to paddle Rock Springs Run. This is separate from the park's tubing and swimming area.", tip: "The county lists an 8am to noon launch window, a 5pm return deadline, and no shuttle service. Capacity closures can still affect entry.", bookQuery: "Rock Springs kayak" },
      { name: "Watch a rocket launch", indoor: false, appQuery: "Playalinda Beach", exactNames: ["Playalinda Beach"], placeId: "ChIJdeCS1uW54IgRqG67_UFPInI", blurb: "Playalinda Beach can put you close to launches from Kennedy Space Center, but access depends on park hours and launch operations.", tip: "Check the official schedule and Canaveral National Seashore alerts. The park can close at capacity or without notice, and the road closes 30 minutes before launch." },
      { name: "Lake Eola and Thornton Park", indoor: false, appQuery: "Lake Eola Park", exactNames: ["Lake Eola Park"], placeId: "ChIJu3hNU-N654gR0x0I9_3iNvc", blurb: "Downtown's swan boats, Sunday farmers market, and the city's best sunset walk, free.", tip: "Swan boats stop seating 45 minutes before close." },
      { name: "ICON Park's wheel at night", indoor: false, appQuery: "The Orlando Eye", exactNames: ["The Orlando Eye"], placeId: "ChIJU7bqHVV-54gRJAwZAp5qCpk", blurb: "The 400-foot observation wheel earns its ticket after dark when the parks corridor lights up.", tip: "Combo tickets with Madame Tussauds or SEA LIFE cut the per-attraction price.", bookQuery: "ICON Park wheel" },
      // v5.36 picks 7–12 (owner-approved 2026-07-11). Same voice, real
      // operating places.
      { name: "Kennedy Space Center Visitor Complex", indoor: true, appQuery: "Kennedy Space Center Visitor Complex", exactNames: ["Kennedy Space Center Visitor Complex"], placeId: "ChIJiTHKxDOu4IgRgAU6btoqIsU", blurb: "An hour east and the best full day in Central Florida that isn't a theme park: a real Saturn V, the shuttle Atlantis hanging mid-bank, and the bus out to the working launch pads.", tip: "Do the bus tour first — lines only grow — and save Atlantis for the afternoon.", bookQuery: "Kennedy Space Center tickets" },
      { name: "Blue Spring State Park in manatee season", months: [11, 12, 1, 2, 3], indoor: false, appQuery: "Blue Spring State Park", exactNames: ["Blue Spring State Park"], placeId: "ChIJyYEUav8P54gRatuv_zQzm20", blurb: "November through March the spring run fills with hundreds of wild manatees escaping the cold St. Johns River — a boardwalk view of megafauna no aquarium can sell you.", tip: "Cold snaps bring the biggest counts; gates close by mid-morning on winter weekends.", bookQuery: "Blue Spring State Park" },
      { name: "Swim at Wekiwa Springs", indoor: false, appQuery: "Wekiwa Springs State Park", exactNames: ["Wekiwa Springs State Park"], placeId: "ChIJd_yTxUh054gR9cGD0gI_yHw", blurb: "A 72-degree spring pool twenty minutes north of downtown, ringed by real Florida forest with canoes and kayaks for rent at the top of the run.", tip: "Summer weekends hit capacity before 10am; weekdays it's yours.", bookQuery: "Wekiwa Springs State Park" },
      { name: "Harry P. Leu Gardens", indoor: false, appQuery: "Harry P Leu Gardens", exactNames: ["Harry P Leu Gardens"], placeId: "ChIJCRCYGrx654gR3G9qoVbWlpY", blurb: "Fifty acres of camellias, roses, and shaded lakefront paths minutes from downtown — the exhale Orlando doesn't advertise.", tip: "Camellia season peaks in the cooler months when everything else up north is grey.", bookQuery: "Leu Gardens Orlando" },
      { name: "Day-trip to Mount Dora", indoor: false, appQuery: "Mount Dora Historic District", exactNames: ["Mount Dora Historic District"], placeId: "ChIJGSMzu2Oi54gR-rlDDL6V3Qs", blurb: "A hilly (for Florida) lakefront town 45 minutes northwest: antique district, an inland lighthouse, and a downtown built for slow afternoons.", tip: "First Fridays and the fall festivals are the town at full wattage.", bookQuery: "Mount Dora" },
      { name: "East End Market", indoor: true, appQuery: "East End Market", exactNames: ["East End Market"], placeId: "ChIJz4eUs7N654gRiMJs2630XVc", blurb: "Audubon Park's neighborhood food hall — a dozen local makers under one roof and the antidote to the I-Drive chain gauntlet.", tip: "Gideon's cookies here mean skipping the Disney Springs line for the same thing." },
    ],
    faq: [
    ...
    sources: [
      { label: "Boggy Creek Airboat Adventures FAQ", url: "https://bcairboats.com/faq/" },
      { label: "Orange County Parks: Kelly Park and Camp Joy launch rules", url: "https://www.orangecountyfl.net/DesktopModules/OCFL/CountyParks/OCPark.aspx?d=117&m=dtlvw" },
      { label: "Canaveral National Seashore: rocket launch viewing", url: "https://www.nps.gov/cana/planyourvisit/rocket-launch-viewing.htm" },
    ],
  },
  ...
  "sarasota-half-price-dining": {
    ...
    picks: [
      { name: "Clipp half-price certificates", placeCard: false, blurb: "The main event: prepaid certificates, typically $15 for $30 of food, at Sarasota-area restaurants. Inventory rotates weekly, which is the part worth planning around — the restaurant you want may not be listed today and may be listed on Friday. Buy on Clipp, redeem in the restaurant.", tip: "Check the list before you decide where to eat, not after. Choosing the restaurant first and hoping it is covered is how people end up eating somewhere they didn't want to." },
  ...
  "orlando-in-the-rain": {
    ...
    picks: [
      { name: "SEA LIFE Orlando Aquarium", indoor: true, placeId: "ChIJmy7U4VJ-54gRi1LoS6wwFj0", blurb: "The 360-degree ocean tunnel is the reason to come — you stand inside the tank while rays pass overhead. 4.4 stars across more than 13,000 reviews, the most-reviewed indoor attraction in the city. Skip it if you've been to a major coastal aquarium recently; this is a compact one, and the tunnel is the highlight rather than the standard.", tip: "It sits at ICON Park with Madame Tussauds and the wheel, and the combo ticket costs less than the three bought separately — worth it only if the rain is staying put.", bookQuery: "SEA LIFE Orlando Aquarium ticket" },
      { name: "WonderWorks Orlando", indoor: true, placeId: "ChIJRdxzRk1-54gRJvqlZQbtpE4", blurb: "The upside-down building on International Drive, and the most reliable rainy-afternoon energy burn for restless kids — indoor and air-conditioned throughout. 4.3 from nearly 11,000 reviews. Worth knowing the ropes course, laser tag and the magic dinner show are separate add-ons, so the sticker price isn't the whole price.", tip: "If the kids still have energy, the ropes course is the part they'll talk about afterwards.", bookQuery: "WonderWorks Orlando ticket" },
      { name: "Crayola Experience Orlando", indoor: true, placeId: "ChIJ73yw37J954gRDwQad4ih7Wk", blurb: "Sits inside The Florida Mall, which is the practical point in a storm: you park in the garage and never go outside again, with a food court and the rest of the mall as overflow if the rain outlasts the kids' patience. 4.4 from over 10,000 reviews. Some activities run on tokens.", tip: "Do Wrap It Up early — kids want to carry the crayon they named around for the rest of the visit. The Crayola store itself is free to walk into.", bookQuery: "Crayola Experience Orlando ticket" },
      { name: "Museum of Illusions Orlando", indoor: true, placeId: "ChIJc1x01Xl_54gR3yyWFYterI4", blurb: "A compact, photo-driven hour rather than a half-day, 4.4 across roughly 3,500 reviews. Right size for a storm that's forecast to pass, wrong choice if you need to fill an entirely washed-out afternoon.", tip: "Best paired with something else on this list rather than treated as the whole plan.", bookQuery: "Museum of Illusions Orlando ticket" },
      { name: "Madame Tussauds Orlando", indoor: true, placeId: "ChIJm-1TQ1N-54gRtKSCx6hQ8SU", blurb: "Also at ICON Park, and the highest-rated of the I-Drive indoor cluster at 4.6. It's built entirely around the photograph — if nobody in your group wants pictures with wax celebrities, this is the one to skip without guilt.", tip: "Same ICON Park bundle logic as SEA LIFE: three tickets separately costs noticeably more.", bookQuery: "Madame Tussauds Orlando ticket" },
      { name: "Orlando Science Center", indoor: true, placeId: "ChIJo2bql5B654gR_ITN9PGhBbU", blurb: "Four floors in Loch Haven Park, 4.6 from more than 7,500 reviews, and the best value here for a genuinely long rainy day. The on-site parking garage matters more than it sounds when you're arriving in a downpour.", tip: "The Crosby Observatory opens for public viewing on select Saturday nights — check first, because the rooftop telescope is the one thing here you can't get at a mall science stop, and it needs clear sky.", bookQuery: "Orlando Science Center" },
      { name: "The Great Escape Room Orlando", indoor: true, placeId: "ChIJgWr-M_x654gRRd7J_Abj-SY", blurb: "A straight 5.0 across more than 4,700 reviews, which is the most unusual number on this page — nothing else in Orlando's indoor set holds a perfect average at that volume. Books by time slot, so it works when you know roughly how long the rain has left.", tip: "Time-slotted rather than walk-in: check availability before you drive over.", bookQuery: "Orlando escape room" },
      { name: "Orange County Regional History Center", indoor: true, placeId: "ChIJyRaIJPx654gRhAbigeu9AMg", blurb: "Downtown, 4.7 from about 1,000 reviews, and the quietest room on this list. This is the adult option — if your group is mostly children, everything above will land better.", tip: "Downtown parking is garage-based, which is the point when it's raining.", bookQuery: "Orange County Regional History Center" },
      { name: "Arcade Monsters International Drive", indoor: true, placeId: "ChIJlUpNP_9_54gRQKh-tw2ZX1s", blurb: "4.8 across roughly 3,000 reviews, and the cheapest way here to turn a washed-out hour into a good one. No timed ticket, no reservation — useful precisely when the storm wasn't in the plan.", tip: "Walk-in, so it's the fallback when everything else needs a booking you didn't make.", bookQuery: "Arcade Monsters Orlando" }
    ],
    faq: [
  ...
  "birthday-freebies-bradenton-sarasota": {
    ...
    region: "Bradenton",
    title: "26 Birthday Freebies in Bradenton & Sarasota: Free Treats Worth Signing Up For",
    description: "The birthday rewards that are actually free near Bradenton and Sarasota — verified against each brand's own terms or received in person: Starbucks, Sephora, AMC popcorn, a free Bundtlet, Chick-fil-A tiers, a $15 Cooper's Hawk reward, Toast app credits at local restaurants, and what to skip.",
    keyword: "birthday freebies bradenton sarasota",
    published: "2026-08-19",
    updated: "2026-09-01",
    intro: "Chain birthday rewards are real money if you play them right — a handcrafted Starbucks drink, a Sephora gift set, a month of free AMC popcorn — and mostly noise if you don't, because half the offers need a sign-up weeks in advance, some need a purchase, and a few famous ones quietly ended this year. We verified every chain offer on this page against the brand's own rewards terms (last verified August 19, 2026), and the three newest entries — Cooper's Hawk, Wahlburgers, and the Toast app credits — arrived on our own phone the first week of September and are quoted exactly as issued. Each one is matched to a real location near Bradenton and Sarasota, and labeled every reward honestly: free with no purchase, free with a purchase, or gated behind a loyalty tier. The one rule that matters: sign up 30–45 days before your birthday, because the best programs check how early you joined — then plan the birthday-month offers around the ones that are good for a single day. Offers and participation change; confirm in each brand's app before you drive over.",
    picks: [
      ...
      // v8.52 (owner, 2026-09-01: "add this information to the birthday rail
      // and the blog"). These three are not read off a terms page: the owner
      // received each one on his own phone this week and the screenshots are
      // in the session record. Dollar amounts and windows are what the
      // reward itself said. Toast is one entry because it is one mechanism
      // that several independent local restaurants share.
      { name: "Cooper's Hawk at UTC: a $15 birthday reward, at the table", indoor: true, appQuery: "Cooper's Hawk Winery & Restaurant Sarasota", placeId: "ChIJg3dcWgZHw4gRXN7pMNzP_pA", blurb: "Wine Club members get a $15 birthday reward that appears in the Cooper's Hawk app about a month out. Two rules from the reward itself: it is dine-in only (it cannot be applied to online ordering), and the app tells you to make a reservation to use it. So book a table for your birthday week, tell your server you are using the birthday reward, and $15 comes off the bill. The catch is the Wine Club membership, which is a paid monthly bottle program, so this one is for people who were already in it.", tip: "Reserve for a weeknight, order the pretzel bread and a flight, and let the $15 cover the appetizer round." },
      { name: "Wahlburgers in Sarasota: a free shake, show the email", indoor: true, appQuery: "Wahlburgers Sarasota", placeId: "ChIJz5Lpb5c_w4gRivPISVkQG3A", blurb: "A free birthday shake, delivered by email: join the Wahlburgers list with your birthdate and the birthday offer lands on the day itself. No app, no points, no purchase stated: the email says to show it when you visit. The only clock is a short one, 14 days from the day it lands.", tip: "It comes in at 9am on your birthday. Screenshot it, because a 14-day email is easy to lose under everything else that day." },
      { name: "Toast birthday credits: real dollars at local restaurants (Turmeric, Wheat + Water, Riviera French Café)", indoor: true, appQuery: "Riviera French Café Sarasota", placeId: "ChIJ32YG_ao5w4gRpzcR49e5sMo", blurb: "The Toast app has a birthday reward section most people never open, and it pays in real dollars at independent restaurants. Toast is the point-of-sale system a lot of them run on. Add your birthday to your Toast profile and, for about a week around it, participating restaurants you have ordered from post a credit you tap to redeem at checkout. What showed up on one Sarasota phone this week: $10 at Turmeric Indian Bar & Grill, $10 at Wheat + Water Italian Kitchen in Lakewood Ranch, and $8 at Riviera French Café at UTC, plus $5 each at K-Bob Korean Street Food and Melao Bakery down in Orlando. These are credits, not a set item, so they stack on whatever you were going to order anyway.", tip: "Open the Toast app the week of your birthday and check Happy Birthday before you pick a restaurant. The list is personal to where you have ordered, so it grows the more local places you use it at." },
    ],
    faq: [
      ...
      { q: "What are the Toast app birthday credits?", a: "Toast is the checkout system many independent restaurants use, and its app has a Happy Birthday section. Add your birthday to your Toast profile and, for about a week around it, restaurants you have ordered from through Toast can post a dollar credit ($5 to $10 in our case) that you tap to redeem when you pay. Which restaurants appear depends on where you have ordered, so use Toast at local places during the year and the birthday list fills in on its own." },
  ...
  "anna-maria-island-day-trip": {
    ...
    picks: [
      { name: "Bean Point, the island's secret-that-isn't", indoor: false, appQuery: "Bean Point Beach Anna Maria", placeId: "ChIJFy96TuUPw4gRr3IUjLXDXfM", blurb: "The northern tip where Tampa Bay meets the Gulf: no facilities, no crowds to speak of, and the best sunset vantage on the island. You reach it by walking in from quiet residential streets.", tip: "No restrooms and little parking by design — arrive on the trolley or by bike and pack out what you bring." },
      { name: "Pine Avenue and the City Pier", indoor: false, appQuery: "Pine Avenue Anna Maria", placeCard: false, blurb: "The island's main street does old-Florida properly: local shops and cafés in cottage buildings, ending at the rebuilt Anna Maria City Pier looking back across the bay to the Skyway bridge.", tip: "Morning is the move — breakfast on Pine, pier walk after, beach by 11." },
      { name: "The free trolley, your parking cheat code", appQuery: "Anna Maria Island", placeCard: false, blurb: "Beach parking on the island is a knife fight by mid-morning in season. The free trolley runs the length of the island from Coquina Beach to the north end, every 20 minutes or so, all day.", tip: "Park once at the big Coquina Beach lot on the south end and ride the trolley everywhere else." },
    ],
    faq: [
  ...
  "tampa-riverwalk-guide": {
    ...
    picks: [
      { name: "Armature Works, the north anchor", indoor: true, appQuery: "Armature Works Tampa", placeId: "ChIJYWj9iZ_PwogRQebjN7pJ_Nw", blurb: "A restored streetcar warehouse turned food hall and hangout — dozens of vendors, river-lawn seating, and the best people-watching in the city.", tip: "Weekend brunch hours are a crush; weekday afternoons are easy." },
      { name: "The museum middle", indoor: true, appQuery: "Tampa Museum of Art", placeId: "ChIJy6ESWITDwogReu72OLauRMM", blurb: "The riverwalk's midsection stacks the Tampa Museum of Art, the Glazer Children's Museum, and Curtis Hixon Waterfront Park — the lawn between them is downtown's living room.", tip: "Curtis Hixon at golden hour, with the University of Tampa's silver minarets lighting up across the river, is the postcard." },
      { name: "Sparkman Wharf and the water taxi", indoor: false, appQuery: "Sparkman Wharf Tampa", placeId: "ChIJD0N73GTFwogRuJTf5jAk5B8", blurb: "The south end lands at Sparkman Wharf's shipping-container eateries and lawn, next to the Florida Aquarium. The Pirate Water Taxi turns the walk back into a boat ride.", tip: "Walk one way, boat the other — the skyline from the water is the view you came for.", bookQuery: "Tampa river cruise" },
    ],
    faq: [
  ...
  "de-soto-national-memorial-bradenton": {
    ...
    picks: [
      { name: "The mangrove shoreline trail", indoor: false, appQuery: "De Soto National Memorial", placeId: "ChIJVcqB2MUQw4gRbN_T0WF8QEw", blurb: "A short nature trail loops through mangrove tunnels and along the river where the expedition landed — shady, flat, and genuinely pretty at high tide.", tip: "Go at high tide for the mangrove-tunnel effect; low tide trades it for wading birds on the flats." },
      { name: "Camp Uzita's living history", indoor: false, appQuery: "De Soto National Memorial", placeId: "ChIJVcqB2MUQw4gRbN_T0WF8QEw", blurb: "In the winter season, rangers and volunteers in period kit demonstrate 16th-century weapons, armor, and camp life at the recreated Camp Uzita — history you can smell (the campfire) rather than read.", tip: "The living-history season runs roughly December into spring; check the park's calendar before making it the day's centerpiece." },
      { name: "Pair it with Robinson Preserve", indoor: false, appQuery: "Robinson Preserve", placeId: "ChIJR0i18icRw4gRbyGIoLLoSo0", blurb: "The memorial sits minutes from Robinson Preserve's flats, towers, and kayak trails — together they make Bradenton's best free outdoor half-day.", tip: "Memorial first for the shade and history, preserve after for the miles." },
    ],
    faq: [
  ...
  "magical-dining-orlando-2026": {
    ...
    picks: [
      { name: "ÔMO by Jônt, Winter Park", indoor: true, appQuery: "ÔMO by Jônt", exactNames: ["ÔMO by Jônt"], placeId: "ChIJO3PrEmdx54gRW1c11w1Yxlo", blurb: "The Winter Park rec is the 16-seat chef's counter at 115 E Lyman Ave. Official menus price The Journey at $195 a person — four snacks, four savory courses, one plated sweet, and a magic box, a little over two hours — and The Jaunt at $375 for more than 20 preparations. Visit Orlando's listing assigns the same address the $60 Magical Dining three-course menu. Those are different meals. Book the one you actually want.", tip: "Hours on the restaurant's information page are Wednesday–Sunday, 5:00pm–9:30pm; reservations are on OpenTable. The Salon next door is wine and à la carte small bites, not the tasting." },
      { name: "Kaya, Mills 50", indoor: true, appQuery: "Kaya", exactNames: ["Kaya"], placeId: "ChIJ3YuEdVp754gRoWwBx528kNc", blurb: "The Orlando rec is the Filipino neighborhood restaurant at 618 N Thornton Ave. Official story names chef Lordfer Lalicon and GM Jamilyn Salonga Bailey. Visit Orlando lists the $60 Magical Dining option here. The homepage still defines kaya as capable and kaya natin as we can.", tip: "Printed summer hours: Tuesday–Thursday open 6pm with last kitchen at 9:30pm; Friday–Saturday open 5pm, last kitchen 10pm; Sunday open 5pm, last kitchen 8:45pm. Happy hour Tuesday–Thursday 6–7pm and Friday–Saturday 9pm–close." },
      { name: "AVA MediterrAegean, Park Avenue", indoor: true, appQuery: "AVA MediterrAegean Winter Park", placeId: "ChIJLWQ9xoZx54gRgT08_-0eAM4", blurb: "Official about dates the Winter Park Greek agora to 2022. Visit Orlando lists the $60 menu at 290 S Park Ave. The Winter Park menus page prints Golden Hour at the bar Sunday–Thursday 5–7pm and a $45 prix-fixe brunch Saturday and Sunday 11:30am–2:30pm.", tip: "The same CMS still carries Coconut Grove hours and a Miami phone — use the Winter Park listing number, (407) 794-9896." },
      { name: "The Pinery, Ivanhoe Village", indoor: true, appQuery: "The Pinery Orlando", placeId: "ChIJwQne8wd754gRvBfDab1krMk", blurb: "Official about: Carol Sizer Holladay opened this Lake Ivanhoe room after 26 years in hospitality, back in her native Orlando. Visit Orlando lists the $40 Magical Dining option at 295 NE Ivanhoe Blvd, Suite A.", tip: "Posted hours: Monday–Thursday 4–10pm, Friday–Saturday 4–11pm, Sunday 11am–9pm." },
      { name: "The Ravenous Pig, Winter Park", indoor: true, appQuery: "The Ravenous Pig Winter Park", placeId: "ChIJg433znRw54gRBeLC7eymGVw", blurb: "Visit Orlando lists the $40 menu at 565 West Fairbanks Avenue and calls the room a MICHELIN Bib Gourmand gastropub for dinner and brunch. The restaurant's own site did not load on this pass, so that is all this page will claim.", tip: "Listing phone (407) 628-2333. Confirm hours on a page you can actually open before you drive." },
      { name: "Kabooki Sushi, East Colonial", indoor: true, appQuery: "Kabooki Sushi East Colonial", placeId: "ChIJpegta8x654gRmUI2JGqYuus", blurb: "Visit Orlando lists the $60 menu at 3122 East Colonial Drive — the East Colonial room, not Sand Lake. Official location hours: Monday–Wednesday and Sunday 5–10pm, Thursday 5–11pm, Friday–Saturday 5pm–12am.", tip: "The official site also runs 7705 Turkey Lake Road. This listing and this rail are Colonial only." },
      { name: "Maxine's on Shine, Colonialtown", indoor: true, appQuery: "Maxine's on Shine", placeId: "ChIJFUZKhud654gR90uHGsWRxHQ", blurb: "The restaurant's own homepage advertises Magical Dining as three courses for $40, August 14–September 30, Tuesday–Saturday. Visit Orlando lists the same $40 option at 337 N Shine Ave. Dinner on that homepage is Wednesday–Saturday 5–9pm; brunch Friday–Sunday 10am–3pm.", tip: "The Magical Dining banner says Tuesday–Saturday; dinner hours on the same page start Wednesday. Confirm the night you want." },
      { name: "Otto's High Dive, Milk District", indoor: true, appQuery: "Otto's High Dive Orlando", placeId: "ChIJOwkr93R754gRwukRdzlSJgM", blurb: "Visit Orlando lists the $40 menu at 2304 E Robinson St and calls the room a Cuban/Floridian neighborhood rum bar and restaurant. Official hours: dinner Monday–Thursday 4–10:30pm, Friday–Saturday 4–11:30pm, Sunday 4–9:30pm; lunch Friday–Saturday 11am–3:30pm; brunch Sunday 11am–3:30pm.", tip: "Official parking: a private lot first-come, plus street parking on Plaza Terrace, Bumby, and nearby side streets. Happy hour Monday–Friday 4–6pm." },
      { name: "Osteria Ester, Thornton Park", indoor: true, appQuery: "Osteria Ester Orlando", placeId: "ChIJr8ttJtR754gRK0m2p7YmVN4", blurb: "Visit Orlando lists the $40 menu at 629 E Central Blvd. Official hours: dinner Tuesday–Saturday 5–10pm, brunch Sunday 11am–4pm. The dinner menu is Italian-American pasta and secondi — pappardelle Bolognese, spaghetti alle vongole, sea bream — not a hotel trattoria.", tip: "Official parking note: free and metered street parking around Thornton Park, or the paid Thornton Park Central Garage. Near E Central and Summerlin." },
      { name: "The Chapman, Park Avenue", indoor: true, appQuery: "The Chapman Winter Park", placeId: "ChIJZwpmWwVw54gRK5HD5FqlBfU", blurb: "Visit Orlando lists the $60 menu at 500 S Park Ave. Official copy is Florida steaks, fish, pasta, and cocktails. Happy hour is weekdays 3–6pm in the Chase Lounge. Dinner hours were not posted on the pages that loaded.", tip: "Phone (407) 635-1967. Confirm dinner hours before you treat the $60 menu as a walk-in." },
    ],
    faq: [
  ...
  // Evergreen restaurant discovery guides. Exact place IDs feed article cards and map pins.
  ...FOOD_CITY_2026_GUIDES,

  // Evergreen statewide decision guide. Kept out of dated seasonal modules.
  ...FLORIDA_LOVEBUG_GUIDES,
  ...
  // DATED archive — one Tampa night. Expire promotion; keep the slug, file,
  // and /guides/tonights-move-tampa-september-12-2026 permanently.
  ...TONIGHTS_MOVE_TAMPA_2026_GUIDES,
  // DATED archive — Red Bull Dance Your Style Tampa weekend. Keep the slug.
  ...RED_BULL_TAMPA_2026_GUIDES,
  // 2026 Pinto's Farm planning guide. Keep the URL; refresh seasonal facts annually.
  ...PINTOS_FARM_2026_GUIDES,
  ...COVERAGE_2026_GUIDES,
};
