...
export const GUIDES = {
  ...
  "things-to-do-sarasota": {
    ...
    picks: [
      ...
      // operating places.
      { name: "Myakka River State Park", blurb: "One of Florida's oldest and largest state parks, twenty minutes east: a canopy walkway over the treetops, airboats on the Upper Lake, and more wild alligators than you'll count.", tip: "The weir near the south entrance is the reliable gator sighting when the lake boats aren't running.", bookQuery: "Myakka River State Park" },
      { name: "Sarasota Jungle Gardens", blurb: "Ten acres of old Florida running since 1939 — flamingos that eat from your hand, bird shows, and a mercifully un-modernized charm no new attraction can fake.", tip: "The flamingo feeding is the memory; buy the food cup on the way in.", bookQuery: "Sarasota Jungle Gardens" },
      { name: "Ride the Legacy Trail", blurb: "A paved rail-trail rolling south from Sarasota toward Venice through parks and pine flatwoods. Locals commute-cruise it; visitors get the county without a windshield.", tip: "Rent at the Sarasota trailhead and turn around at Osprey Junction; the full run to Venice is a real ride.", bookQuery: "Legacy Trail Sarasota bike rental" },
      { name: "The Celery Fields", blurb: "The county's birding mecca: boardwalks over restored wetlands where 200-plus species turn up, plus a climbable hill — a genuine rarity in flat Florida — with the best free view around.", tip: "Go at golden hour; the Audubon boardwalk on Palmer is where the spoonbills are." },
    ],
    faq: [
  ...
  "things-to-do-orlando-not-theme-parks": {
    ...
    picks: [
      ...
      // operating places.
      { name: "Kennedy Space Center Visitor Complex", blurb: "An hour east and the best full day in Central Florida that isn't a theme park: a real Saturn V, the shuttle Atlantis hanging mid-bank, and the bus out to the working launch pads.", tip: "Do the bus tour first — lines only grow — and save Atlantis for the afternoon.", bookQuery: "Kennedy Space Center tickets" },
      { name: "Blue Spring State Park in manatee season", blurb: "November through March the spring run fills with hundreds of wild manatees escaping the cold St. Johns River — a boardwalk view of megafauna no aquarium can sell you.", tip: "Cold snaps bring the biggest counts; gates close by mid-morning on winter weekends.", bookQuery: "Blue Spring State Park" },
      { name: "Swim at Wekiwa Springs", blurb: "A 72-degree spring pool twenty minutes north of downtown, ringed by real Florida forest with canoes and kayaks for rent at the top of the run.", tip: "Summer weekends hit capacity before 10am; weekdays it's yours.", bookQuery: "Wekiwa Springs State Park" },
      { name: "Harry P. Leu Gardens", blurb: "Fifty acres of camellias, roses, and shaded lakefront paths minutes from downtown — the exhale Orlando doesn't advertise.", tip: "Camellia season peaks in the cooler months when everything else up north is grey.", bookQuery: "Leu Gardens Orlando" },
      { name: "Day-trip to Mount Dora", blurb: "A hilly (for Florida) lakefront town 45 minutes northwest: antique district, an inland lighthouse, and a downtown built for slow afternoons.", tip: "First Fridays and the fall festivals are the town at full wattage.", bookQuery: "Mount Dora" },
      { name: "East End Market", blurb: "Audubon Park's neighborhood food hall — a dozen local makers under one roof and the antidote to the I-Drive chain gauntlet.", tip: "Gideon's cookies here mean skipping the Disney Springs line for the same thing." },
    ],
    faq: [
  ...
  "sarasota-half-price-dining": {
    ...
    picks: [
      ...
      { name: "Gecko's Grill & Pub", blurb: "Runs the most consistently useful free offers in the area, no certificate required. The Ultimate Happy Hour is daily 3–6pm: $1 off drafts, wells and wines, $5 off 750ml bottles, and $5 small plates. Local chain rather than a one-off, so the offer holds across locations.", tip: "The 19th Hole is the one people miss — a free well drink, domestic draft or house wine with any appetizer or entrée, if you bring a same-day golf scorecard." },
      { name: "Bar Bingo at Gecko's Hillview", blurb: "Mondays 7–9pm and free to play. Not a discount at all, which is the point of including it — a free Monday night out costs less than half price on a meal you were not going to buy.", tip: "Hillview location specifically, not the whole chain." },
      { name: "Pie On Main", blurb: "Weekday lunch special plus a sub of the day, on Main Street downtown. The most walkable of these if you are already in the city centre rather than driving out to Lakewood Ranch.", tip: "Weekdays only — the special does not run at weekends." },
    ],
    faq: [
...
=======
  "orlando-in-the-rain": {
    ...
    picks: [
      ...
      { name: "Orange County Regional History Center", blurb: "Downtown, 4.7 from about 1,000 reviews, and the quietest room on this list. This is the adult option — if your group is mostly children, everything above will land better.", tip: "Downtown parking is garage-based, which is the point when it's raining.", bookQuery: "Orange County Regional History Center" },
      { name: "Arcade Monsters International Drive", blurb: "4.8 across roughly 3,000 reviews, and the cheapest way here to turn a washed-out hour into a good one. No timed ticket, no reservation — useful precisely when the storm wasn't in the plan.", tip: "Walk-in, so it's the fallback when everything else needs a booking you didn't make.", bookQuery: "Arcade Monsters Orlando" }
    ],
    faq: [
...
>>>>>>> 360052b (feat(guides): Orlando in the rain — indoor-only, nine picks, live Viator terminal)
  },
