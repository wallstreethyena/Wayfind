...
export const GUIDES = {
  ...
  "things-to-do-sarasota": {
    ...
    picks: [
      ...
      { name: "Kayak Lido's mangrove tunnels", indoor: false, blurb: "Paddle shaded tunnels where manatees and dolphins turn up regularly, minutes from downtown.", tip: "Morning glass-calm water beats afternoon wind.", bookQuery: "Sarasota mangrove kayak tour" },
      ...
      { name: "Mote Marine Laboratory", indoor: true, blurb: "A working marine research lab with an aquarium attached; the shark tank and manatee rehab give it substance a tourist aquarium lacks.", tip: "Pair it with north Lido beach across the road.", bookQuery: "Mote Marine aquarium" },
  ...
  "gatorland-vs-wild-florida": {
    ...
    picks: [
      { name: "Gatorland: the classic park", indoor: false, blurb: "The 'Alligator Capital of the World' since 1949. Stronger shows (Gator Jumparoo), a breeding marsh boardwalk with wild birds, the white leucistic gators, and a zip line over the alligator pens for the brave.", tip: "The Screamin' Gator zip line sells out; book it, not just admission.", viatorUrl: "https://www.viator.com/tours/Orlando/Gatorland-General-Admission-Ticket/d663-3458ENTRY" },
      { name: "Wild Florida: the airboat experience", indoor: false, blurb: "Built around real airboat rides on Lake Cypress headwaters, wild gators in wild water, plus a compact gator park and drive-through safari. The airboat is the product; the park is the bonus.", tip: "Morning rides see more wildlife before boat traffic picks up.", bookQuery: "Wild Florida airboat" },
