...
export const GUIDES = {
  "winter-park-scenic-boat-tour": {
    ...
    picks: [
      { name: "What the hour actually covers", blurb: "Three lakes and two hand-dug canals barely wider than the pontoon, with Spanish moss brushing overhead. The narration mixes mansion gossip, Rollins College history, and genuine old-Florida knowledge.", tip: "Left side of the boat gets the best canal shade and photo angles.", bookQuery: "Winter Park scenic boat tour" },
      { name: "Tickets, timing, and the cash catch", blurb: "Tours leave hourly from the Morse Boulevard dock; no reservations, first-come. The famous quirk: the ticket window is cash or check only, and the ATM walk will cost you your boat slot on busy days.", tip: "Weekday mornings walk right on; weekend afternoons can mean an hour wait." },
      { name: "Make it a Winter Park day", blurb: "The dock sits two blocks off Park Avenue: Tiffany glass at the Morse Museum, lunch on the Avenue, and the boat tour makes the single best non-park day in Orlando.", tip: "SunRail from downtown stops three blocks from the dock, making this Orlando's easiest car-free outing." },
    ],
    faq: [
  ...
  "siesta-key-drum-circle": {
    ...
    picks: [
      { name: "When and exactly where", blurb: "Sundays year-round, starting roughly two hours before sunset and peaking as the sun drops. Walk south from the main Siesta Beach pavilion about 200 yards; follow the drums.", tip: "Check the sunset time for your date and arrive 90 minutes early for a decent spot on busy season Sundays." },
  ...
  "pinecraft-sarasota-amish-village": {
    ...
    picks: [
      ...
      { name: "How to visit respectfully", blurb: "This is a residential neighborhood, not an attraction. Photograph the place, not the people, without asking; dress modestly in the restaurants; and remember Sunday is genuinely quiet.", tip: "If you're respectful, conversation comes easy; residents are famously warm with visitors." },
    ],
    faq: [
