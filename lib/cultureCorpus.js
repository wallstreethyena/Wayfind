// lib/cultureCorpus.js — metro culture cards for server-rendered pages.
// Not imported by app/home.js. Re-exporting from lib/culture.js would
// put this corpus back on the homepage JS ratchet.
...
export const CULTURE = {
  ...
  tampa: {
    ...
    see: [
      ...
      { name: "Shell Key Preserve", story: "Undeveloped island next to Fort De Soto — kayak or boat out, no roads, pack shade.", placeId: "ChIJ5_NkHLUcw4gRndvLQGe_Ox8" },
    ],
    say: [
