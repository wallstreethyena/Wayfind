...
// assigned by reading the row's venue/kind/city in
...
// `venue` is the PLACE the ticket admits you to (MOSI, Raymond James Stadium),
// never the seller. The seller is `provider`, printed through
// lib/providerLabels.js. Repo-wide, `merchant` means the seller
// (lib/placePartnerPicks.js, lib/intentPartnerPicks.js: "Viator", "Tiqets"),
// and the first cut of this file used that word for the venue — so the browse
// rail's "via {merchant}" badge read "via The Dalí Museum" on production
// (2026-09-16, live check), telling the reader they were buying from the
// museum when the seller was Tiqets. Naming the field for what it is closes
// that class of confusion; scripts/check-menu-partner-offers.mjs executes the
// route and asserts the seller label is what leaves it.
const offer = (offerId, provider, venue, title, market, lat, lng, image, fits) =>
  Object.freeze({ offerId, provider, venue, title, placeId: null, lat, lng, image, market, fits: Object.freeze(fits) });
...
export const MENU_PARTNER_OFFERS = Object.freeze([
  ...
  offer("stpete-venue-jannus-live", "ticketnetwork", "Jannus Live", "Jannus Live", "St. Petersburg", 27.7676, -82.6403, "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b1/Jannus_Live.jpg/1280px-Jannus_Live.jpg", ["nightlife:clubs", "nightlife:music"]),
  ...
  offer("tampa-venue-steinbrenner-field", "ticketnetwork", "George M. Steinbrenner Field", "George M. Steinbrenner Field", "Tampa", 27.9506, -82.4572, "https://thumb.wikimedia.org/wikipedia/commons/thumb/e/ef/MacDill_Aircrew%2C_service_members_kick_off_opening_day_ceremony_for_TB_Rays_%28250328-F-YW699-1029%29.jpg/1280px-MacDill_Aircrew%2C_service_members_kick_off_opening_day_ceremony_for_TB_Rays_%28250328-F-YW699-1029%29.jpg", ["nightlife:sports"]),
  ...
  offer("stpete-venue-al-lang-stadium", "ticketnetwork", "Al Lang Stadium", "Al Lang Stadium", "St. Petersburg", 27.7676, -82.6403, "https://thumb.wikimedia.org/wikipedia/commons/thumb/7/7a/Rowdies_Soccer_Config_2015.jpg/1280px-Rowdies_Soccer_Config_2015.jpg", ["nightlife:sports"]),
  offer("stpete-venue-tropicana-field", "ticketnetwork", "Tropicana Field", "Tropicana Field", "St. Petersburg", 27.7676, -82.6403, "https://thumb.wikimedia.org/wikipedia/commons/thumb/5/5e/PXL_20220528_205520913.jpg/1280px-PXL_20220528_205520913.jpg", ["nightlife:sports"]),
  ...
  offer("orlando-venue-kia-center", "ticketnetwork", "Kia Center", "Kia Center", "Orlando", 28.5383, -81.3792, "https://thumb.wikimedia.org/wikipedia/commons/thumb/8/83/Kia_Center_12-22-24.jpg/1280px-Kia_Center_12-22-24.jpg", ["nightlife:sports"]),
  offer("orlando-venue-camping-world-stadium", "ticketnetwork", "Camping World Stadium", "Camping World Stadium", "Orlando", 28.5383, -81.3792, "https://thumb.wikimedia.org/wikipedia/commons/thumb/b/b9/Camping_World_Stadium.jpg/1280px-Camping_World_Stadium.jpg", ["nightlife:sports"]),
  ...
  offer("orlando-best-gocity-pass", "gocity", "Go City Orlando All-Inclusive Pass", "Go City Orlando All-Inclusive Pass", "Orlando", 28.5383, -81.3792, "https://thumb.wikimedia.org/wikipedia/commons/thumb/e/e8/Orlando%2C_Florida_%28cropped%29.jpg/1280px-Orlando%2C_Florida_%28cropped%29.jpg", ["attractions:all"]),
  offer("nyc-best-gocity-explorer", "gocity", "Go City New York Explorer Pass", "Go City New York Explorer Pass", "New York", 40.7128, -74.006, "https://thumb.wikimedia.org/wikipedia/commons/thumb/7/7a/View_of_Empire_State_Building_from_Rockefeller_Center_New_York_City_dllu_%28cropped%29.jpg/1280px-View_of_Empire_State_Building_from_Rockefeller_Center_New_York_City_dllu_%28cropped%29.jpg", ["attractions:all"]),
...
// section I / SUMMARY.
// Image hosts that refuse a Wayfind page: see lib/imageHostPolicy.js.
export { HOTLINK_REFUSED_IMAGE_HOSTS } from "./imageHostPolicy.js";

export const DELIBERATELY_UNPLACED = Object.freeze({
  // 2026-09-17 production photo audit: the partner's image host refuses a
  // gowayfind.com Referer (403), so all three cards rendered a broken image
  // (Tampa Ghost Tour on 12 menu surfaces). Unplaced until the partner
  // supplies a licensed creative we may serve; see HOTLINK_REFUSED_IMAGE_HOSTS.
  "tampa-ghost-usghostadventures": "partner image host refuses a gowayfind.com referer (403); needs a licensed creative",
  "keywest-ghost-usghostadventures": "partner image host refuses a gowayfind.com referer (403); needs a licensed creative",
  "staug-ghost-usghostadventures": "partner image host refuses a gowayfind.com referer (403); needs a licensed creative",
