            ...
            <div key={p.id || i} style={S.card}>
              ...
              <div style={{ display: "flex", gap: 12, justifyContent: "space-between", alignItems: "flex-start" }}>
                ...
                {(() => {
                  ...
                  return (
                    <div style={{ minWidth: 58, padding: "9px 8px", borderRadius: 14, background: "#1C2230", color: "#1C2230", textAlign: "center", fontWeight: 900, lineHeight: 1 }}>
              ...
              {(() => {
                ...
                const wq = sig && sig.water ? (sig.water.advisory ? { t: "Advisory — check before swimming", c: "#EF4444" } : sig.water.result === "Good" ? { t: "Water quality: Good", c: "#22C55E" } : sig.water.result === "Moderate" ? { t: "Water quality: Moderate", c: "#FBBF24" } : sig.water.result ? { t: "Water quality: Poor", c: "#EF4444" } : null) : null;
