...
// in a new costume, so restaurant surfaces use a distinct food-only intent
// and never inherit activities that are valid on the broader date-night page.
...
export const LANDING_RAIL_INTENT = Object.freeze({
  ...
  restaurants: { intent: "food", why: "A restaurant ranking may sell a food-led tour, tasting, cooking class, or dining experience. It must not borrow the broader date-night catalogue, where kayaks and attractions are valid." },
...
export const GUIDE_RAIL_INTENT = Object.freeze({
  restaurant: { intent: "food", why: "A restaurant guide may sell a food-led tour, tasting, cooking class, or dining experience. It must not borrow the broader date-night catalogue, where activities are valid." },
