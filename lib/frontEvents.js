...
export const EVENT_WEIGHT = { concerts: 4, sports: 3, comedy: 2, theater: 2, community: 0 };
...
export function bestFirst(usable, bucketOf, featured) {
  ...
  return byWhen(list).sort((a, b) => eventStature(b, bucketOf) - eventStature(a, bucketOf));
}
