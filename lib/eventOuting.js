...
export const SLOT_TABLE = {
  ...
  club_night: [
    ...
    { key: "after_hours", label: "Keep the night going", timing: "after", primary: NIGHTCLUB_PRIMARY, any: NIGHTCLUB_ANY, exclude: [], maxMi: 1.0, quota: 2 },
  ...
  sports_day: [
    ...
    { key: "ice_cream_after", label: "Something sweet after", timing: "after", primary: SWEET_PRIMARY, any: SWEET_ANY, exclude: [], maxMi: 0.8, quota: 1 },
  ],
  sports_night: [
