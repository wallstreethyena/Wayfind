...
// The owner-supplied top-20 FLORIDA trend list (2026-08-11), in the OWNER'S
...
export const EXPLODING_NEARBY_UNIVERSE = [
  { key: "smash_burgers", rank: 1, primaryBucket: "night", alsoBuckets: ["afternoon"], label: "Smash burgers", headline: "Smash burgers are exploding", dek: "Crisp-edged, griddled burgers are becoming the order people seek out, not just another menu option.", stat: "Global searches up 650% — 1.5M a month; \u201csmash burger near me\u201d up 50%." },
  { key: "elevated_ramen", rank: 2, primaryBucket: "night", alsoBuckets: ["afternoon"], label: "Elevated ramen and noodle bowls", headline: "Elevated ramen is exploding", dek: "Rich, chef-level ramen and noodle bowls are becoming the warm, satisfying dinner people plan around.", stat: null },
  { key: "caribbean_curry_bowls", rank: 3, primaryBucket: "afternoon", alsoBuckets: ["night"], label: "Caribbean curry bowls", headline: "Caribbean curry bowls are exploding", dek: "Curry chicken, goat, roti, and oxtail are turning island comfort food into a destination order.", stat: null },
  { key: "miso_umami_seafood", rank: 4, primaryBucket: "night", alsoBuckets: ["afternoon"], label: "Miso and umami seafood", headline: "Umami seafood is exploding", dek: "Miso-glazed fish and umami-rich plates are becoming the coastal dinner order people seek out.", stat: null },
  { key: "functional_smoothie_acai", rank: 5, primaryBucket: "morning", alsoBuckets: ["afternoon"], label: "Functional smoothies and a\u00e7a\u00ed bowls", headline: "Functional smoothie bowls are exploding", dek: "Smoothies and a\u00e7a\u00ed bowls built for how you actually feel are becoming the morning and post-workout stop.", stat: null },
  { key: "high_protein_grab_and_go", rank: 6, primaryBucket: "morning", alsoBuckets: ["afternoon"], label: "High-protein grab-and-go", headline: "High-protein grab-and-go is exploding", dek: "Protein shakes and bowls people can grab fast are becoming the default breakfast and gym-day fuel.", stat: null },
  { key: "gut_health_food", rank: 7, primaryBucket: "morning", alsoBuckets: ["afternoon"], label: "Fiber and gut-health food", headline: "Gut-health food is exploding", dek: "Kombucha, kefir, and gut-friendly bowls are moving from a niche habit into the daily routine.", stat: null },
  { key: "fermented_pickled", rank: 8, primaryBucket: "night", alsoBuckets: ["afternoon"], label: "Fermented and pickled flavors", headline: "Fermented flavors are exploding", dek: "Kimchi, miso, and house pickles are showing up as the flavors people order on purpose.", stat: null },
  { key: "matcha_specialty_coffee", rank: 9, primaryBucket: "morning", alsoBuckets: ["afternoon"], label: "Matcha and specialty coffee", headline: "Matcha and specialty coffee are exploding", dek: "Matcha lattes and carefully sourced coffee are turning the daily caffeine run into the destination itself.", stat: null },
  { key: "mocktail_bar", rank: 10, primaryBucket: "night", alsoBuckets: ["afternoon"], label: "Zero-proof and low-ABV cocktails", headline: "Zero-proof cocktails are exploding", dek: "Full cocktail craft with less or no alcohol is making a night out easier to say yes to.", stat: null },
  { key: "savory_cocktails", rank: 11, primaryBucket: "night", alsoBuckets: ["afternoon"], label: "Savory cocktails", headline: "Savory cocktails are exploding", dek: "Dirty martinis and savory builds are the orders defining the current cocktail-bar moment.", stat: null },
  { key: "food_hall", rank: 12, primaryBucket: "afternoon", alsoBuckets: ["night"], label: "Food halls", headline: "Food halls are exploding", dek: "Multi-concept halls let one visit cover lunch, browsing, happy hour, and dinner.", stat: null },
  { key: "immersive_dining", rank: 13, primaryBucket: "night", alsoBuckets: ["afternoon"], label: "Experiential dining", headline: "Experiential dining is exploding", dek: "Chef events, themed menus, and food-and-music nights are turning dinner into the occasion itself.", stat: "Global searches up 1,040%." },
  { key: "pilates_reformer", rank: 14, primaryBucket: "morning", alsoBuckets: ["afternoon"], label: "Reformer Pilates and Lagree", headline: "Reformer Pilates is exploding", dek: "Low-impact resistance training is becoming a go-to studio workout.", stat: "Global searches up 393% — 450K a month." },
  { key: "cold_plunge_sauna", rank: 15, primaryBucket: "morning", alsoBuckets: ["afternoon"], label: "Cold plunge and sauna recovery", headline: "Hot-cold recovery is exploding", dek: "Sauna-and-plunge sessions are becoming a social recovery ritual, not just athlete rehab.", stat: "Global searches up 6,700%; \u201cnear me\u201d searches up 14%." },
  { key: "social_wellness_clubs", rank: 16, primaryBucket: "morning", alsoBuckets: ["afternoon"], label: "Social wellness clubs", headline: "Social wellness clubs are exploding", dek: "People are pairing recovery, movement, and community in one place.", stat: "Global searches up 3,500%; \u201csocial wellness club near me\u201d up 175%." },
  { key: "soft_clubbing", rank: 17, primaryBucket: "morning", alsoBuckets: ["afternoon"], label: "Soft clubbing and coffee raves", headline: "Soft clubbing is exploding", dek: "Earlier, lower-pressure dance events are making a night out easier to say yes to.", stat: "Global searches up 7,200%; \u201csoft clubbing near me\u201d up 2,900%." },
  { key: "listening_bar", rank: 18, primaryBucket: "night", alsoBuckets: ["afternoon"], label: "Listening bars", headline: "Listening bars are exploding", dek: "Hi-fi rooms and intimate music nights are becoming the more intentional way to go out.", stat: null },
  { key: "pickleball", rank: 19, primaryBucket: "afternoon", alsoBuckets: ["morning", "night"], label: "Pickleball and padel", headline: "Pickleball and padel are exploding", dek: "Social court sports are becoming the default way to meet up, from sunrise sessions to lit-court nights.", stat: null },
  { key: "golf_simulators", rank: 20, primaryBucket: "night", alsoBuckets: ["afternoon"], label: "Golf simulators and social play", headline: "Golf simulators are exploding", dek: "Simulator lounges with food and drinks are turning a round of golf into a group night out.", stat: null },
];
