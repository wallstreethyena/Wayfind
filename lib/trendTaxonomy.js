...
export const EXPLODING_NEARBY_UNIVERSE = [
  { key: "smash_burgers", label: "Smash burgers", headline: "Smash burgers are exploding", dek: "Crisp-edged, griddled burgers are becoming the order people seek out, not just another menu option.", stat: "Global searches up 650% — 1.5M a month; \u201csmash burger near me\u201d up 50%." },
  { key: "soft_clubbing", label: "Soft clubbing", headline: "Soft clubbing is exploding", dek: "Earlier, lower-pressure dance events are making a night out easier to say yes to.", stat: "Global searches up 7,200%; \u201csoft clubbing near me\u201d up 2,900%." },
  { key: "cold_plunge_sauna", label: "Cold-plunge saunas", headline: "Hot-cold recovery is exploding", dek: "Sauna-and-plunge sessions are becoming a social recovery ritual, not just athlete rehab.", stat: "Global searches up 6,700%; \u201cnear me\u201d searches up 14%." },
  { key: "social_wellness_clubs", label: "Social wellness clubs", headline: "Social wellness clubs are exploding", dek: "People are pairing recovery, movement, and community in one place.", stat: "Global searches up 3,500%; \u201csocial wellness club near me\u201d up 175%." },
  { key: "puppy_yoga", label: "Puppy yoga", headline: "Puppy yoga is exploding", dek: "Yoga classes with adoptable puppies turn a workout into an actual occasion.", stat: "Global searches up 725% — 135K a month; \u201cpuppy yoga classes near me\u201d up 815%." },
  { key: "hojicha_lattes", label: "Hojicha lattes", headline: "Hojicha lattes are exploding", dek: "Roasted Japanese tea is giving the usual latte run a toastier, less-sweet alternative.", stat: "Global searches up 615% — 60.5K a month; \u201chojicha latte near me\u201d up 50%." },
  { key: "candlelight_concerts", label: "Candlelight concerts", headline: "Candlelight concerts are exploding", dek: "Live music in candlelit rooms is turning familiar songs into a more atmospheric night out.", stat: "Global searches up 417% — 201K a month." },
  { key: "immersive_gamebox", label: "Immersive Gamebox", headline: "Immersive Gamebox is exploding", dek: "Room-scale games are making group play feel more active than another arcade stop.", stat: "Global searches up 4,600% — 27.1K a month." },
  { key: "dubai_chocolate", label: "Dubai chocolate", headline: "Dubai chocolate is exploding", dek: "Pistachio, chocolate, and crisp kunafa are drawing lines at dessert counters.", stat: "Global searches up 2,000% — 673K a month." },
  { key: "black_sesame_lattes", label: "Black-sesame lattes", headline: "Black-sesame lattes are exploding", dek: "Nutty black sesame is moving from specialty menus into a signature café order.", stat: "Global searches up 1,080%; \u201cnear me\u201d searches up 81%." },
  { key: "hwachae", label: "Hwachae", headline: "Hwachae is exploding", dek: "Korean fruit punch is turning a bright, shareable dessert into a destination order.", stat: "Global searches up 1,500% — 110K a month." },
  { key: "tanghulu", label: "Tanghulu", headline: "Tanghulu is exploding", dek: "Glass-crisp candied fruit is becoming a snack people will travel across town to try.", stat: "Global searches up 400% — 201K a month." },
  { key: "kunafa", label: "Kunafa", headline: "Kunafa is exploding", dek: "The crisp, cheese-filled Middle Eastern dessert is finding a much wider audience.", stat: "Global searches up 308% — 450K a month." },
  { key: "protein_ice_cream", label: "Protein ice cream", headline: "Protein ice cream is exploding", dek: "Dessert shops are giving high-protein treats a place beyond the freezer aisle.", stat: "Global searches up 470% — 90.5K a month; \u201cnear me\u201d up 19%." },
  { key: "immersive_dining", label: "Immersive dining", headline: "Immersive dining is exploding", dek: "Dinner is becoming a staged, multisensory experience instead of only a reservation.", stat: "Global searches up 1,040%." },
  { key: "pilates_reformer", label: "Pilates reformer", headline: "Reformer Pilates is exploding", dek: "Low-impact resistance training is becoming a go-to studio workout.", stat: "Global searches up 393% — 450K a month." },
  { key: "rucking", label: "Rucking", headline: "Rucking is exploding", dek: "Weighted group walks are turning a simple route into a social strength workout.", stat: "Global searches up 229%; \u201crucking events near me\u201d up 57%." },
  { key: "breathwork", label: "Breathwork", headline: "Breathwork is exploding", dek: "Guided breathing sessions are becoming a bookable way to reset, recover, and focus.", stat: "Global searches up 258% — 49.5K a month." },
  { key: "forest_bathing", label: "Forest bathing", headline: "Forest bathing is exploding", dek: "Guided time in nature is becoming a deliberate wellness plan rather than an ordinary park walk.", stat: "Global searches up 148% — 33.1K a month." },
  { key: "kintsugi", label: "Kintsugi", headline: "Kintsugi is exploding", dek: "Hands-on workshops are bringing the Japanese art of visible repair to local studios.", stat: "Global searches up 132% — 368K a month." },
];
