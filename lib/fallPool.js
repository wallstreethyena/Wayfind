...
export const FALL_OFFERING_SOURCES = Object.freeze({
  ...
  "ChIJ1U_vFp0Xw4gRGKl6mJGJ9UI": { offering: "current online menu lists Spiced Pumpkin Flat White, Classic Spiced Pumpkin Latte, Pumpkin Bread, Pumpkin Cloud Cold Brew, Pumpkin Shaken Espresso, Spiced Pumpkin Chai and Spiced Pumpkin Matcha Latte; confirm availability before visiting", source: "https://joycoffeebradenton.square.site/?fulfillment=PICKUP&location_id=LMTGQ2Y8V9RM8", verified: "2026-09-10" },
  "ChIJA-QkamE7w4gRfdzcxEHyPls": { offering: "current menu: Pumpkin Spice Latte, Vermont Maple Latte, Apple Pie French Toast, Thanksgiving Chicken Club and Autumn Seared Chicken Salad", source: "https://order.toasttab.com/online/atria-cafe-lwr", sourceType: "official_menu_platform", verified: "2026-09-23" },
  ...
  "ChIJwZ_GK-d-54gRm5Ahg7PZYeY": { offering: "seasonal Halloween takeover: Dead Coconut Club 'Harvest', HHN 35 nights Aug 28-Nov 1 2026", source: "https://hauntedattractionnetwork.com/dead-coconut-club-harvest-hhn-2026/", until: "2026-11-01" },
...
// v8.85 (2026-09-23, WS4 fall-discovery re-verification — full evidence in
// docs/audits/fall-discovery/2026-09-23.{json,md}). New rule: lib/
// fallEvidence.js. Nine entries above got a fresh `verified: "2026-09-23"`
// (Ghost Party Haunted Tours also got a corrected source URL — its old
// ghostpartytours.com domain no longer resolves reliably). The other EIGHT
// were run through the same rules and did NOT clear them — left UNCHANGED
// here on purpose (this pass edits no entry out; that decision is the
// orchestrator's), but flagged with exactly what the evidence showed:
//   - Gasparilla Distillery (ChIJVQB8l1PEwogRfNZtGI6suIc): the ONLY Ghost of
//     Gasparilla event page found is dated 10/19/2024-11/3/2024 — EXPIRED,
//     no 2026 iteration published as of this run; homepage doesn't mention it.
//   - Paradeco / Oxford Exchange / On Swann (ChIJTzoiienhwogRbPa3GpuvBQU,
//     ChIJ11hsiYXEwogRjDBv39F04J8, ChIJ5crCip3EwogRQnhkbw_Ir6U): their only
//     source, tampabaydatenightguide.com's seasonal-menus roundup, is dated
//     2025-09-22 / updated 2025-10-06 — a PREVIOUS-YEAR page, never touched
//     for 2026. Paradeco's own site (paradecocoffee.com/menu) lists no fall
//     items; Oxford Exchange's own menu page renders as images only.
//   - Joy Coffee (ChIJ1U_vFp0Xw4gRGKl6mJGJ9UI): the live Square page still
//     lists all seven pumpkin items, but every one is marked Unavailable.
//   - Ice Screamin (ChIJB2B8mYzHwogRkZIDCDARWww): its Square storefront is a
//     JS-rendered shell; neither icescreamin.com nor icescreamin.shop yields
//     Halloween/horror text via a free fetch.
//   - Mortem Manor (ChIJd6lmgVh_3YgREzqTBf28i6U): the operator's own live
//     site never uses a fall-evidence term ("haunted house", "scares",
//     "creepiest" — no "Halloween"/"spooky"/etc.) — a real gap between the
//     term list and a legitimate year-round haunt's own copy.
//   - Red Coconut / Dead Coconut Club (ChIJwZ_GK-d-54gRm5Ahg7PZYeY): its
//     source article confirms the 2026 event with real dates (Aug 28-Nov 1,
//     which cover today), but the ARTICLE was published 2026-07-22, before
//     the fall season starts — the mechanical rule reads that as outside the
//     season window. Worth a policy call: should a dated OFFERING's own
//     start/end override its covering article's publish date?
...
export const FALL_PLACE_RAIL = Object.freeze({
  ...
  "ChIJTzoiienhwogRbPa3GpuvBQU": "food",             // Paradeco fall menu
  ...
  "ChIJ11hsiYXEwogRjDBv39F04J8": "food",             // Oxford Exchange fall menu
  "ChIJ5crCip3EwogRQnhkbw_Ir6U": "food",             // On Swann fall menu
  "ChIJB2B8mYzHwogRkZIDCDARWww": "date-night",       // Ice Screamin
