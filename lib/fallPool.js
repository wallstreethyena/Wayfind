...
export const FALL_PLACE_IDS = Object.freeze({
  ...
  "ChIJ3xa3znR_54gRR3bePMYdOfg": "Fall menu in Dr. Phillips — pumpkin spice and apple-cinnamon lattes, hot or iced.", // CFS Coffee Dr. Phillips, Orlando
  "ChIJC9pvtLN654gR6F0GZH-G-8I": "September-only Pumpkin Bread Chocolate Crumb cookie plus Pumpkin Caramel Double Frosted Cake at the East End Market shop.", // Gideon's Bakehouse East End, Orlando
  "ChIJEUd8H-Nj54gRq59RRWIA6mI": "Current limited-time fall brunch drinks include Pumpkin Pie Cold Brew, Pumpkin Brunch Old Fashioned and Cranberry Pomegranate Fizz.", // Another Broken Egg, Orlando
  "ChIJ-ZFB15jtwogRpEcx2izoHr8": "Fall Menu 2026 — Pumpkin Roll Latte, Apple Cinnamon Crumble Latte and Maple Brown Sugar Matcha.", // Charlie Coffee, Palm Harbor
  "ChIJJWzJr9232YgR6jjHElv8mjc": "Pumpkin Spice Cloud — espresso with a creamy pumpkin topper, served hot or iced.", // Pura Vida Miami
  "ChIJsRAN-H5Bw4gRl0sAl0587IY": "Fall Menu — Cinnful Cider, real-pumpkin spiced coffee, pumpkin smoothie and seasonal pumpkin bites.", // CROP Juice, Sarasota
  "ChIJYVbXKAC32YgRUVddTqA46Kg": "Fall menu — Pumpkin Spice Latte, followed by a limited Halloween Ube Chai Latte.", // Crema Gourmet Coconut Grove
...
export const FALL_OFFERING_SOURCES = Object.freeze({
  ...
  // Astra 2026-09-25 — current-source refresh for the owner's thin Fall Drinks
  // & Seasonal Bites rail. Each row below has an exact OPERATIONAL wf_inventory
  // identity with an owned photo_ref; no neighbor photo and no name-only match.
  "ChIJ3xa3znR_54gRR3bePMYdOfg": { offering: "Fall menu: hot or iced Pumpkin Spice Latte, hot or iced Apple Cinnamon Latte, and seasonal chai", source: "https://order.toasttab.com/online/cfs-dr-philips-7535-west-sand-lake-road/item-iced-pumpkin-spice-latte_4b166539-76d4-4f17-9f58-36aaa6acff12", sourceType: "official_menu_platform", verified: "2026-09-25" },
  // Astra 2026-09-26 — Orlando fill, exact OPERATIONAL identities with owned
  // photo refs. Both claims were re-checked against the venues' live official
  // pages before promotion; no social caption or prior-year menu is used.
  "ChIJC9pvtLN654gR6F0GZH-G-8I": { offering: "September-only Pumpkin Bread Chocolate Crumb cookie plus Pumpkin Caramel Double Frosted Cake at East End Market", source: "https://gideonsbakehouse.com/bakery-menu/", sourceType: "official_site", verified: "2026-09-26", starts: "2026-09-01", until: "2026-09-30" },
  "ChIJEUd8H-Nj54gRq59RRWIA6mI": { offering: "limited-time fall menu with Pumpkin Pie Cold Brew, Pumpkin Brunch Old Fashioned and Cranberry Pomegranate Fizz Mocktail", source: "https://anotherbrokenegg.com/", sourceType: "official_site", verified: "2026-09-26" },
  "ChIJ-ZFB15jtwogRpEcx2izoHr8": { offering: "Fall Menu 2026: Pumpkin Roll Latte, Apple Cinnamon Crumble Latte and Maple Brown Sugar Matcha Latte", source: "https://charliecoffeefl.com/", sourceType: "official_site", verified: "2026-09-25" },
  "ChIJJWzJr9232YgR6jjHElv8mjc": { offering: "Fall flavors menu: Pumpkin Spice Cloud with double espresso, milk and a creamy pumpkin topper, hot or iced", source: "https://www.puravidamiami.com/", sourceType: "official_site", verified: "2026-09-25" },
  "ChIJsRAN-H5Bw4gRl0sAl0587IY": { offering: "Fall Menu: Cinnful Cider, Real Pumpkin Sp'iced Coffee, Pumpkin Spice Smoothie, Pumpkin Pie Chia Pudding and pumpkin seasonal bites", source: "https://www.cropjuice.com/menus/", sourceType: "official_site", verified: "2026-09-25" },
  "ChIJYVbXKAC32YgRUVddTqA46Kg": { offering: "Fall menu: Pumpkin Spice Latte Sep 14-Nov 29 plus Halloween Ube Chai Latte Oct 5-Nov 1", source: "https://premierguidemiami.com/article/crema-gourmet-fall-2026", sourceType: "reputable_secondary", verified: "2026-09-25", until: "2026-11-29" },
...
// 2026-09-26 Astra current-source refresh: food now has 10 verified places.
 // Orlando gains Gideon's East End and Another Broken Egg after exact-place,
 // live-official-source verification. The earlier five additions remain CFS
 // Dr. Phillips, Charlie Coffee, Pura Vida Miami, CROP Juice and Crema Coconut
 // Grove. ATRIA remains excluded; nothing stale was revived to pad the rail.
 // Other primary-intent counts stay unchanged: date-night 5, haunts 2, farms 1.
export const FALL_PLACE_RAIL = Object.freeze({
  ...
  "ChIJ3xa3znR_54gRR3bePMYdOfg": "food",             // CFS Coffee Dr. Phillips fall menu
  "ChIJC9pvtLN654gR6F0GZH-G-8I": "food",             // Gideon's East End September pumpkin menu
  "ChIJEUd8H-Nj54gRq59RRWIA6mI": "food",             // Another Broken Egg limited-time fall menu
  "ChIJ-ZFB15jtwogRpEcx2izoHr8": "food",             // Charlie Coffee Fall Menu 2026
  "ChIJJWzJr9232YgR6jjHElv8mjc": "food",             // Pura Vida Pumpkin Spice Cloud
  "ChIJsRAN-H5Bw4gRl0sAl0587IY": "food",             // CROP Juice Fall Menu
  "ChIJYVbXKAC32YgRUVddTqA46Kg": "food",             // Crema Gourmet fall drinks
