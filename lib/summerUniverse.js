...
// midday entries are water, museums, dining or covered parks. That `why`
// is registry / selection copy. It is NOT the place-card hook (owner,
// 2026-08-20): the card shows Atlas knownFor/whyGo or wf_editorial, or
// nothing. The `why` must still stay evidence-true and verifiable.
//
...
export const SUMMER_UNIVERSE = [
  ...
  { key: "ami_coquina", rank: 61, label: "Anna Maria Island, Coquina Beach",
    ...
    months: [6, 7, 8], rails: ["beach"],
    // v8.19 — placeId RESOLVED (owner screenshot: "Coquina Beach Parking as a
    // place card?"). The null id let the name-reuse path hand this entry the
    // PARKING LOT's pool row ("Coquina Beach Parking", 273 reviews) instead
    // of the beach (6,457 reviews). This is the real Coquina Beach row in
    // wf_inventory, verified by type (beach/natural_feature) and volume.
    venue: { name: "Coquina Beach", city: "Bradenton Beach", lat: 27.4568, lng: -82.6965, placeId: "ChIJ5eLMVXE9w4gR15l0tMZGkMY" } },
