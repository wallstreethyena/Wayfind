...
export async function fetchTodaysBest({ lat, lng, localHour, tempF, condition, category, limit = 4, boostIds = null, events = null }) {
...
export async function fetchThingsToDo({ lat, lng, localHour, tempF, condition, radiusMi = 30, limit = 10, events = null }) {
  if (!supabase || !isFinite(lat) || !isFinite(lng)) return [];
  try {
