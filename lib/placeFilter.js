...
export const CAT_ALLOW = {
  ...
  food: /restaurant|food|cafe|coffee|bakery|\bbar\b|pub\b|brewery|breweries|winery|distillery|pizzeria|pizza|taco|taqueria|bbq|barbecue|grill|diner|deli|ice_cream|ice cream|gelato|dessert|donut|doughnut|bagel|sandwich|burger|chicken|seafood|sushi|steak|buffet|bistro|eatery|kitchen|cantina|creperie|juice|smoothie|tea ?house|boba|brunch|breakfast|meal_|food_truck|food truck|market|gastropub|noodle|ramen|pho\b|thai|mexican|italian|chinese|indian|cuban|caribbean|mediterranean|greek|japanese|korean|vietnamese|wings|pancake|waffle|creamery|cheesecake|taproom|tavern|ale ?house|oyster|crab|fish/i,
  nightlife: /\bbar\b|pub\b|night_club|nightclub|lounge|brewery|breweries|taproom|tavern|speakeasy|cocktail|wine|karaoke|billiard|pool hall|comedy|live music|music venue|club\b|distillery|ale ?house|saloon|cigar|hookah|dance|dive_bar|sports_bar|gastropub|restaurant|casino/i,
  hotels: /lodging|hotel|motel|resort|\binn\b|suites|bed_and_breakfast|bed and breakfast|guest_house|guesthouse|vacation rental|campground|rv_park|villa|bungalow|boutique hotel|extended stay/i,
