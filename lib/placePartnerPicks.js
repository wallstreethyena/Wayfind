...
export const PLACE_PARTNER_PICKS = Object.freeze([
  ...
  placePick("5", "undercover_tourist", "Undercover Tourist", ["Disney World", "Walt Disney World Resort", "Walt Disney World", "Magic Kingdom Park", "Magic Kingdom", "EPCOT", "Disney's Hollywood Studios", "Disney's Animal Kingdom Theme Park", "Disney's Animal Kingdom"], { placeIds: ["ChIJ96XKNOZ-3YgRoPEc0B85Hqc"] }),
  ...
  placePick("orlando-klook-universal-admission", "klook", "Klook", ["Universal Orlando Resort", "Universal Studios Florida", "Universal's Islands of Adventure", "Universal Islands of Adventure", "Universal Epic Universe", "Universal's Epic Universe", "Universal Volcano Bay", "Universal's Volcano Bay"]),
