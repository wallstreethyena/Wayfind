...
export const PLACE_PARTNER_PICKS = Object.freeze([
  ...
  placePick("22211P1", "viator", "Viator", ["TreeUmph! Adventure Course", "TreeUmph Adventure Course"]),
  placePick("237533P5", "viator", "Viator", ["Egmont Key State Park", "Egmont Key", "Fort De Soto Park"]),
  ...
  // ══ 2026-08-20 cash-register factory batch 1 ══
  // Live page named the place (H1/title or meeting-point line). Final path
  // stayed that product — never searchResults, never 236862P2. offerId is
  // the wf_experiences product_code. Exact-name aliases only. Rank untouched.
  // Fort De Soto shares 237533P5 above: the ferry page is "Egmont Key Ferry
  // from Ft. DeSoto Park" and boards at the Fort De Soto boat ramp.
  placePick("86301P8", "viator", "Viator", ["Bioluminescence Tours - Cocoa Beach"]),
  placePick("203023P2", "viator", "Viator", ["Anna Maria Island Dolphin Tours"]),
  placePick("246569P5", "viator", "Viator", ["John Pennekamp Coral Reef State Park"]),
