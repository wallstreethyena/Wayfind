...
// the other half of this gate lives in scripts/check-inventory-integrity.mjs:
// it reads production with real credentials and FAILS when a pinned code has no
// catalogue row and is not recorded here. A new death becomes a red build
// before it becomes a customer clicking a dead Book button. Do not delete that
// check and leave this list behind — on its own the list is a cache with no
// invalidation.
//
 ...
 * @param {object} [catalog]      optional, from viatorCatalogFromRows()
