...
export const PLACE_PARTNER_PICKS = Object.freeze([
  ...
  // RETIRED 343215P2 — Viator answered INACTIVE (dead_confirmed) 2026-09-11; see RETIRED_VIATOR_PINS.
  // Re-pinned 2026-09-15 to 169791P1 "Glass Bottom Kayak Eco Tour through
  // Rainbow Springs" (Get Up And Go Kayaking, KP Hole Park, Dunnellon).
  // Browser-verified on the live product page the same day: product code on
  // page, itinerary names "Rainbow Springs State Park", $125 InStock with a
  // Check Availability widget; wf_experiences link_ok:true, 4.9★/963 reviews.
  placePick("169791P1", "viator", "Viator", ["Rainbow Springs State Park"]),
  ...
  // RETIRED 350214P1 — Viator answered INACTIVE (dead_confirmed) 2026-09-14; see RETIRED_VIATOR_PINS.
  // Re-pinned 2026-09-15 to 242020P5 "Tiki Boat - St. Pete Pier - The Only
  // Authentic Floating Tiki Bar" (departs 300 2nd Ave NE, the Pier itself).
  // Browser-verified on the live product page the same day: product code on
  // page, itinerary names "St. Pete Pier", $59.95 InStock with a Check
  // Availability widget; wf_experiences link_ok:true, 4.8★/101 reviews.
  placePick("242020P5", "viator", "Viator", ["St. Pete Pier"]),
  ...
  // placeIds pin the existing product to the inventoried venue. No new SKU.
  // Display-name drift must not drop a verified Book hop, and a same-brand
  // card in another city must not inherit it by name alone when an id is set.
  placePick("tampa-family-florida-aquarium", "klook", "Klook", ["The Florida Aquarium", "Florida Aquarium"], {
    placeIds: ["ChIJCXAq5_DEwogRjTPE2xlsZtE"],
  }),
  ...
  placePick("tampa-date-dali-museum", "tiqets", "Tiqets", ["The Dalí Museum", "The Dali Museum", "Salvador Dalí Museum", "Salvador Dali Museum"], {
    placeIds: ["ChIJyaCQzpHhwogRBdPcZI6UOyc"],
  }),
  ...
  placePick("orlando-tonight-sealife", "tiqets", "Tiqets", ["SEA LIFE Orlando Aquarium", "SEA LIFE Orlando"], {
    placeIds: ["ChIJmy7U4VJ-54gRi1LoS6wwFj0"],
  }),
  ...
  placePick("tampa-hook-busch-gardens", "tiqets", "Tiqets", ["Busch Gardens Tampa Bay", "Busch Gardens", "Busch Gardens Tampa"]),
  ...
  placePick("orlando-hook-wonderworks", "tiqets", "Tiqets", ["WonderWorks Orlando", "WonderWorks"], {
    placeIds: ["ChIJRdxzRk1-54gRJvqlZQbtpE4"],
  }),
  ...
  placePick("winterhaven-hook-legoland", "tiqets", "Tiqets", ["LEGOLAND Florida Resort", "LEGOLAND Florida", "LEGOLAND Florida Park", "LEGOLAND", "LEGOLAND® Florida Resort"]),
  placePick("orlando-hook-gatorland", "tiqets", "Tiqets", ["Gatorland"]),
  placePick("orlando-hook-seaworld", "tiqets", "Tiqets", ["SeaWorld Orlando", "SeaWorld"]),
  placePick("orlando-hook-crayola", "tiqets", "Tiqets", ["Crayola Experience Orlando", "Crayola Experience"]),
  placePick("winterhaven-hook-peppa-pig", "tiqets", "Tiqets", ["Peppa Pig Theme Park", "Peppa Pig Theme Park Florida", "Peppa Pig"]),
  ...
  placePick("5", "undercover_tourist", "Undercover Tourist", ["Walt Disney World Resort", "Walt Disney World", "Walt Disney World® Resort", "Magic Kingdom Park", "Magic Kingdom", "EPCOT", "Disney's Hollywood Studios", "Hollywood Studios", "Disney's Animal Kingdom Theme Park", "Disney's Animal Kingdom", "Animal Kingdom"]),
  ...
  // Browser verified 2026-09-12: Klook includes Volcano Bay admission packages.
  // The former offer 6 excludes that water park. HHN and CityWalk never match.
  placePick("orlando-klook-universal-admission", "klook", "Klook", ["Universal Orlando Resort", "Universal Orlando", "Universal Studios Florida", "Universal Studios", "Universal Studios Orlando", "Universal's Islands of Adventure", "Universal Islands of Adventure", "Islands of Adventure", "Universal Epic Universe", "Universal's Epic Universe", "Epic Universe", "Universal Volcano Bay", "Universal's Volcano Bay", "Volcano Bay"]),
...
export const RETIRED_VIATOR_PINS = Object.freeze([
  ...
  // 2026-09-15 — the nightly sweep (cron/experiences-link-health) got an
  // explicit non-ACTIVE status from Viator's product endpoint: dead_confirmed,
  // link_ok:false, fail_count:1. The live quarantine had already pulled both
  // Book buttons (/api/partner/pin-health listed exactly these two as
  // link-dead); this records the verdict so neither code is ever re-pinned.
  // Both names carry a replacement pin above.
  { offerId: "343215P2", names: ["Rainbow Springs State Park"] },
  { offerId: "350214P1", names: ["St. Pete Pier"] },
]);
