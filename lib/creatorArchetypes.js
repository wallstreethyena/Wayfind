...
export const ASSIGNMENTS = Object.freeze({
  ...
  "cindy.selects": Object.freeze({
    summary: "A specialist, not a generalist: ten of her eleven finds are coffee shops, cafés and bakeries, from Bradenton and Parrish up to Orlando. Slow mornings, a good pastry case, and the rare room that still works with a toddler in tow.",
    archetype: "food_expert",
    provisional: false,
    ...
    evidence: "11 spots, 10 of them coffee/café/bakery by primary_type: Spinning Coffee, Jabal Coffee House, Seek First, Ryan's Coffee House, Joy Coffee, Root & Seed and Hashtag Café are coffee_shop; Tuscan Hills is cafe; Dolce and Bake is cafeteria (a bakery-café); Maple Street Biscuit Company is restaurant but is a breakfast house. The single non-food spot is NeuroPlay, an indoor_playground — and two of the coffee captions mention toddler play areas, so the family signal is real but secondary. Cities: Orlando 5, Bradenton 3, Parrish 2, Sarasota 1.",
  }),
