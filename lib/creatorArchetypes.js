...
export const ASSIGNMENTS = Object.freeze({
  ...
  // ── 2026-08-23 — added with her 38-spot Miami batch ──
  // The only creator in the library whose feed is mostly NOTABLE rooms rather
  // than neighbourhood finds, and the only one whose batch had to be filtered
  // for sponsored content before it could be curated at all.
  // ── 2026-08-25 — added with the Disney Food Blog intake (Phase 1, one verified spot) ──
  // provisional:true on purpose: one curated spot is not a corpus. The archetype
  // still is not guessed from the handle — DFB is a 16k-post food-coverage
  // publication whose entire feed is Disney-property dining, and the one entry
  // shipped (Summer House on the Lake) is a dessert review confirmed against the
  // restaurant's own menu. Revisit when the permalink-extraction backlog in
  // docs/CREATOR_DFB_PIPELINE.md lands the next batch.
  disneyfoodblog: Object.freeze({
    summary: "The Disney dining beat — every new menu, booth and bakery case across the parks and Disney Springs, reviewed dish by dish.",
    archetype: "food_expert",
    provisional: true,
    evidence: "One verified spot so far: Summer House on the Lake at Disney Springs, the six-layer chocolate chip cookie cake post (permalink verified 2026-08-25, dish cross-checked on the restaurant's own menu). The account is a long-running Disney food publication with 16k+ posts; six more places with confirmed coverage but unextracted permalinks are queued in docs/CREATOR_DFB_PIPELINE.md, and the file's own rule holds: nothing enters lib/creatorVideos.js without the exact post URL.",
  }),
  iviethefoodie: Object.freeze({
    summary: "Books the rooms Miami is arguing about — two Michelin kitchens, a wagyu omakase, a caviar tasting menu — then tells you the one dish to order and whether the wait is worth it.",
    archetype: "food_expert",
    provisional: false,
    evidence: "38 spots and the highest reach in the library (287 to 9,493 likes). What separates her from the other food_experts is ALTITUDE, not geography: two Michelin-starred kitchens (Boia De, MAASS at the Four Seasons), two omakase counters, a caviar-on-everything tasting menu, and Bern's — at 9,868 Google reviews the single most-reviewed venue in the whole library. She pairs that with genuine cheap finds (a backyard taco stand in Homestead with no website, a $17 pan con chicharron) so it is not simply a luxury feed. Almost every caption ends in a numbered 'here's what I recommend' list, which is why so many of these entries could be captioned with a specific dish. Her posts also carry the library's first real SPONSORED-CONTENT problem: seven of the 57 supplied were brand deals and are deliberately excluded, because a paid post is not an organic find and lib/trendSignal.js's licence to read creator data into the ranking depends on that distinction. Four of her spots corroborate places other creators found independently — Bern's, Yamashiro, Tres Leches Factory, and Pronto, which she makes the library's first THREE-creator place.",
  }),
  // ── 2026-08-23 — added with her 27-spot Tampa Bay batch ──
  // food_expert on the same test as gabrielaromero11: the axis is the MEAL.
  // What separates her from the others is that she is early — five of her
  // twenty-seven were filmed at or before an opening.
  eatsbylaurr: Object.freeze({
    summary: "Works Tampa Bay's new openings and food trucks — barbecue on Nebraska, halal on Fowler, a bodega bus downtown — and is usually there in the first week.",
    archetype: "food_expert",
    provisional: false,
    evidence: "27 spots, 25 of them food. The pattern is NEWNESS and format rather than cuisine: 'now open', 'new', 'opening this Friday' or a grand-opening date appears in 8 of the captions, and 6 of the venues are trucks, buses or food-hall counters rather than dining rooms. Cuisine is deliberately wide underneath that — Thai, Egyptian, Lebanese, Peruvian, Indian, Venezuelan, Japanese, Detroit pizza, Neapolitan pizza, barbecue, halal. Geography is the Bay area proper: Tampa 15, Temple Terrace 3, then St. Pete, Brandon, Dunedin, Clearwater Beach, Apollo Beach, Sarasota and Tierra Verde. Five of her spots corroborate places other creators found independently — Tommy's Chophouse, Roasted813, Madison Avenue Pizza, Farooj Abo AlAbed and Slap Burger — the highest overlap rate of any creator in the library, which is what you would expect from someone who covers the same metro as three of the others.",
  }),
  // ── 2026-08-23 — added with the 70-spot Miami batch that introduced her ──
  // The largest single creator in the library, and the only one whose captions
  // are not in English. food_expert is unambiguous here in a way it was not for
  // cailincoastal: the axis is the FOOD and, under it, the diaspora kitchen.
  gabrielaromero11: Object.freeze({
    summary: "Eats her way through Miami's immigrant kitchens — Venezuelan arepas and street hot dogs, Cuban pizza, Dominican chicharrón, Brazilian rodizio — and posts the address and the price with every one.",
    archetype: "food_expert",
    provisional: false,
    evidence: "70 spots, 60 of them food, and the through-line is national cuisine rather than neighbourhood: Venezuelan runs through 20 of them (arepas, cachapas, pepitos, four separate street-hot-dog stands, a coastal seafood house), then Italian 8, Brazilian rodizio 2, plus Cuban, Dominican, Ecuadorian, Peruvian, Lebanese, Portuguese, French, Mexican, Chinese and Japanese. PRICE is named in most captions and is often the headline itself — '$35 all you can eat', 'comidas por solo $10', 'brunch por $35 p/p'. Geography is secondary and wide: Miami proper, Doral, Medley, Hialeah, Coral Gables, Miami Beach, and out to Hollywood, Davie and Southwest Ranches. The 10 non-food entries are outings rather than a second interest — an ATV night, an immersive art house, a farm for kids, an arena. Reach is the highest in the library by an order of magnitude (239 to 9,835 likes). Three of her spots corroborate places other creators found independently: Boûlan, Pronto Café and El Churrascaso.",
  }),
  // ── 2026-08-23 — added with the 23-spot batch that introduced her ──
  // Non-provisional for the same reason the three below are: 23 posts read end
  // to end is a pattern, not a first impression. The archetype is travel_guide
  // rather than food_expert even though 16 of the 23 are food, because the
  // through-line is a COUNTY, not a cuisine — see the evidence.
  cailincoastal: Object.freeze({
    summary: "Covers St. Pete and the rest of Pinellas the way a local would — the Italian room downtown, the speakeasy on Central, the sunset dinner cruise — and names the street address in the caption more often than not.",
    archetype: "travel_guide",
    provisional: false,
    evidence: "23 spots, and the axis is geography: 18 of them are in Pinellas County (12 in St. Petersburg proper), with 4 in Tampa and 1 in Brandon. Category is deliberately mixed under that — 16 food and coffee, 3 nightlife rooms (an arcade bar, a Central Avenue speakeasy, a Carrollwood margarita patio), and 3 on-the-water or wellness outings (a dining yacht, a dolphin run, a holistic clinic) — which is what separates this from food_expert: she is not chasing a cuisine, she is working through one county. The framing is occasion-led rather than dish-led ('date night', 'the perfect way to start a morning', 'shopping small on a Sunday'), and roughly two thirds of the captions carry a literal street address, which is why almost every entry in her batch could be resolved to a real placeId. Two of her spots corroborate places other creators found independently — Heights Drive-Thru and Atomic Cat.",
  }),
  ...
  "cindy.selects": Object.freeze({
    // COUNT-FREE ON PURPOSE (v8.95). This line read "ten of her eleven finds"
    // and shipped to production the day she reached TWELVE — a summary that
    // states a total is a fact with an expiry date, and the expiry is silent.
    // The evidence note below still carries exact numbers because it is an
    // internal, dated research record that nothing renders; the summary is what
    // a reader sees, so it says what stays true. check-creator-summary-counts
    // now fails the build on any rendered summary that claims a total the
    // curation file disagrees with.
    summary: "A specialist, not a generalist: nearly every place she posts is a coffee shop, café or bakery, from Bradenton and Parrish up to Orlando. Slow mornings, a good pastry case, and the rare room that still works with a toddler in tow.",
    archetype: "food_expert",
    provisional: false,
    // v8.94 — REWRITTEN AGAINST THE DATA, because the old line had gone stale
    // and was understating her. It said "7 spots" and named only Bradenton and
    // Sarasota; she is at ELEVEN across four cities, and ORLANDO is now her
    // largest single market (5). Every type below is the primary_type
    // wf_inventory actually holds, not a guess from the name.
    evidence: "As of 2026-09-04: 12 spots, 11 of them coffee/café/bakery/breakfast by primary_type. Spinning Coffee, Jabal Coffee House, Seek First, Ryan's Coffee House, Joy Coffee, Root & Seed and Hashtag Café are coffee_shop; Tuscan Hills is cafe; Dolce and Bake is cafeteria (a bakery-café); Maple Street Biscuit Company and The Breakfast Company are restaurant but are both breakfast houses. The single non-food spot is NeuroPlay, an indoor_playground — and two of the coffee captions mention toddler play areas, so the family signal is real but secondary. Cities: Orlando 5, Bradenton 4, Parrish 2, Sarasota 1. Eleven of the twelve are TikTok; The Breakfast Company is an Instagram reel.",
  }),
  ...
  // 2026-09-02 — owner's fall Instagram batch. Each of these is a single post;
  // same rule as every provisional row above: one post is not a pattern.
  youdothedishesstudio: Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "2 spots, both the studio's own account posting its own Tampa Palms pottery-painting room. Not an independent creator voice — held provisional on that basis alone.",
  }),
  nuevacantina: Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 post (attached to two Nueva Cantina locations, Tampa and Palm Harbor, since the post covers all of the brand's Florida rooms). The venue's own account, not an independent creator voice.",
  }),
  alex_pistorio: Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 spot (MANGONI Italian Market Pizza, Winter Garden). Insufficient evidence for a role.",
  }),
  perfectpresscoffeeco: Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 spot, the shop's own account posting its own West Tampa counter. Not an independent creator voice.",
  }),
  "xandra.orlando": Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "2 spots (Dead Coconut Club: Harvest at Universal CityWalk; Halloween Horror Nights 35's opening night). Insufficient evidence for a role.",
  }),
  beercutieandfoodie: Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 spot (the Downtown Clowntown scare zone at Halloween Horror Nights 35). Insufficient evidence for a role.",
  }),
  cheatdayorlando: Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "2 spots (Rosallie Le French Cafe, Winter Garden; Helena Modern Riviera's ICON Park pop-up). Insufficient evidence for a role.",
  }),
  rosallielefrenchcafe: Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 spot, the cafe's own account posting its own Winter Garden room. Not an independent creator voice.",
  }),
  "mr.tampa.bay": Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 spot (Haraz Coffee House, Wesley Chapel). Insufficient evidence for a role.",
  }),
  oliviashannonwolk: Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 post (a brand collaboration with All Fired Up about its studio-wide Halloween pottery collection, attached to both Florida studios). Insufficient evidence for a role.",
  }),
  "hallo.ween365days": Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "2 spots (the Terrifier/ARTmas scare zone at Halloween Horror Nights 35; the Clown Cafe at Universal Studios Hollywood). Insufficient evidence for a role.",
  }),
  mangoniwg: Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 spot, the market's own account posting its own Winter Garden Haunted Mangoni menu. Not an independent creator voice.",
  }),
  helenamodernriviera: Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 spot, the venue's own account posting its own ICON Park Sirens of Helena pop-up. Not an independent creator voice.",
  }),

  // WO7 (2026-09-02) — "everything available everywhere" out-of-state batch.
  timspumpkinpatch: Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 spot, the patch's own account posting its own Marietta, New York grounds. Not an independent creator voice.",
  }),
  harvestmoonorchard: Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "4 spots, the orchard's own account posting its own North Salem, New York grounds across the fall season. Not an independent creator voice.",
  }),
  whats_in_westchester_ny: Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 spot, a Westchester-focused roundup account naming Harvest Moon Farm & Orchard's Fall Festival weekends. Insufficient evidence for a role.",
  }),
  "_queen.sav_": Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 spot (Brother Bruno's Pizza, Wayne, New Jersey). Insufficient evidence for a role.",
  }),
  cakeyourway: Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 spot, the bakery's own account posting its own Vaughan, Ontario shop. Not an independent creator voice.",
  }),
  bates_farm: Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 spot, the farm's own account posting its own Croft, England pumpkin patch. Not an independent creator voice.",
  }),
  "ryanbros.cityheights": Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "2 spots, the cafe's own City Heights account posting its own San Diego counter. Not an independent creator voice.",
  }),
  blackhawkhardware: Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 spot, the store's own account posting its own Charlotte Halloween decor collection. Not an independent creator voice.",
  }),
  splashartuk: Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 spot, the studio's own account posting its own Liverpool space. Not an independent creator voice.",
  }),
  horrorvibescoffee: Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 spot, the cafe's own account posting its own North Hollywood fall menu. Not an independent creator voice.",
  }),
  conazucarcafelosangeles: Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 spot (Con Azucar Cafe, Sylmar). A second, brand-level post covering multiple Los Angeles-area locations was held rather than attached to one venue. Insufficient evidence for a role.",
  }),
  halloweendiet: Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 spot (Disneyland Park's fall Halloween decor). Insufficient evidence for a role.",
  }),
  anoctobersunday: Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 spot (Georgetown Drive-In's Slasher Fest, shot on 35mm). Insufficient evidence for a role.",
  }),
  the_bagel_nook: Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 spot, the shop's own account posting its own seasonal pumpkin bagels. Not an independent creator voice.",
  }),

  // 2026-09-07 — second fall Instagram batch, rebuilt fresh from current main.
  // cheatdayorlando already has a row above (2 spots) and is left untouched —
  // this batch gives them a third spot (SeaWorld Orlando) but the rule is
  // leave an existing row alone, not keep its count current.
  thingstodotampabay: Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 spot (Good Fortune, St. Petersburg). Insufficient evidence for a role.",
  }),
  foodbytiana: Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 spot (Nueva Cantina, Palm Harbor). Insufficient evidence for a role.",
  }),
  thefloridaplayground: Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 spot (Corazon by Baires, Orlando). Insufficient evidence for a role.",
  }),
  theghoulishmortal: Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 spot (Villatel Resort Orlando). Insufficient evidence for a role.",
  }),
  jackspumpkinpopup: Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 spot, the pop-up's own account posting its own downtown Chicago corn maze and carnival. Not an independent creator voice — a venue account will not become an independent voice however many posts arrive.",
  }),
  adventureparkmd: Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 spot, the park's own account posting its own Sandy Spring, Maryland climbing and zipline course. Not an independent creator voice — a venue account will not become an independent voice however many posts arrive.",
  }),
  halloweenvilleuk: Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 spot, the organiser's own account posting its own Warrington light trail. Not an independent creator voice — a venue account will not become an independent voice however many posts arrive.",
  }),
  whatrvdoing: Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 spot (Buffalo Phil's, Wisconsin Dells). Insufficient evidence for a role.",
  }),
  kalenawhite: Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 spot (Georgetown Drive-In). Insufficient evidence for a role.",
  }),
  melissagasia: Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 spot (Coffinated Coffee, La Puente). Insufficient evidence for a role.",
  }),

  // 2026-09-10 owner-submitted Instagram associations. Every live handle gets
  // an explicit unassigned decision; one intake is not enough to infer a role.
  "josyinorlando": Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "3 reviewed venue associations from the 2026-09-10 owner-submitted Instagram intake. Role intentionally unassigned until a broader independent body of work is reviewed.",
  }),
  "tampavida": Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "3 reviewed venue associations from the 2026-09-10 owner-submitted Instagram intake. Role intentionally unassigned until a broader independent body of work is reviewed.",
  }),
  "toddlerfriendlytampabay": Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "3 reviewed venue associations from the 2026-09-10 owner-submitted Instagram intake. Role intentionally unassigned until a broader independent body of work is reviewed.",
  }),
  "atthediner": Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "2 reviewed venue associations from the 2026-09-10 owner-submitted Instagram intake. Role intentionally unassigned until a broader independent body of work is reviewed.",
  }),
  "addyabnormal": Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 reviewed venue association from the 2026-09-10 owner-submitted Instagram intake. Role intentionally unassigned until a broader independent body of work is reviewed.",
  }),
  "blackcraft": Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 reviewed venue association from the 2026-09-10 owner-submitted Instagram intake. Role intentionally unassigned until a broader independent body of work is reviewed.",
  }),
  "brevardbanana": Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 reviewed venue association from the 2026-09-10 owner-submitted Instagram intake. Role intentionally unassigned until a broader independent body of work is reviewed.",
  }),
  "clewithkids": Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 reviewed venue association from the 2026-09-10 owner-submitted Instagram intake. Role intentionally unassigned until a broader independent body of work is reviewed.",
  }),
  "eatlocalflorida": Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 reviewed venue association from the 2026-09-10 owner-submitted Instagram intake. Role intentionally unassigned until a broader independent body of work is reviewed.",
  }),
  "koryaversa": Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 reviewed venue association from the 2026-09-10 owner-submitted Instagram intake. Role intentionally unassigned until a broader independent body of work is reviewed.",
  }),
  "kulturas.pasadena": Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 reviewed venue association from the 2026-09-10 owner-submitted Instagram intake. Role intentionally unassigned until a broader independent body of work is reviewed.",
  }),
  "lemosfarmhmb": Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 reviewed venue association from the 2026-09-10 owner-submitted Instagram intake. Role intentionally unassigned until a broader independent body of work is reviewed.",
  }),
  "linvillaorchards": Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 reviewed venue association from the 2026-09-10 owner-submitted Instagram intake. Role intentionally unassigned until a broader independent body of work is reviewed.",
  }),
  "lumleysfarm": Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 reviewed venue association from the 2026-09-10 owner-submitted Instagram intake. Role intentionally unassigned until a broader independent body of work is reviewed.",
  }),
  "marin_mommies": Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 reviewed venue association from the 2026-09-10 owner-submitted Instagram intake. Role intentionally unassigned until a broader independent body of work is reviewed.",
  }),
  "maymont_rva": Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 reviewed venue association from the 2026-09-10 owner-submitted Instagram intake. Role intentionally unassigned until a broader independent body of work is reviewed.",
  }),
  "midwesttravelmama": Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 reviewed venue association from the 2026-09-10 owner-submitted Instagram intake. Role intentionally unassigned until a broader independent body of work is reviewed.",
  }),
  "miriaminspired": Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 reviewed venue association from the 2026-09-10 owner-submitted Instagram intake. Role intentionally unassigned until a broader independent body of work is reviewed.",
  }),
  "mrs.motivateyofitness": Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 reviewed venue association from the 2026-09-10 owner-submitted Instagram intake. Role intentionally unassigned until a broader independent body of work is reviewed.",
  }),
  "pintosfarm": Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 reviewed venue association from the 2026-09-10 owner-submitted Instagram intake. Role intentionally unassigned until a broader independent body of work is reviewed.",
  }),
  "raglanroadpub": Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 reviewed venue association from the 2026-09-10 owner-submitted Instagram intake. Role intentionally unassigned until a broader independent body of work is reviewed.",
  }),
  "santasfarm": Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 reviewed venue association from the 2026-09-10 owner-submitted Instagram intake. Role intentionally unassigned until a broader independent body of work is reviewed.",
  }),
  "somehowimeverywhere": Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 reviewed venue association from the 2026-09-10 owner-submitted Instagram intake. Role intentionally unassigned until a broader independent body of work is reviewed.",
  }),
  "table4onesocially": Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 reviewed venue association from the 2026-09-10 owner-submitted Instagram intake. Role intentionally unassigned until a broader independent body of work is reviewed.",
  }),
  "tazacafefm": Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 reviewed venue association from the 2026-09-10 owner-submitted Instagram intake. Role intentionally unassigned until a broader independent body of work is reviewed.",
  }),
  "thelittleleopardcoffee": Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 reviewed venue association from the 2026-09-10 owner-submitted Instagram intake. Role intentionally unassigned until a broader independent body of work is reviewed.",
  }),
  "travel_worth_telling": Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 reviewed venue association from the 2026-09-10 owner-submitted Instagram intake. Role intentionally unassigned until a broader independent body of work is reviewed.",
  }),
  "wanderlusttravelcouple": Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 reviewed venue association from the 2026-09-10 owner-submitted Instagram intake. Role intentionally unassigned until a broader independent body of work is reviewed.",
  }),
  "wekivaisland": Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 reviewed venue association from the 2026-09-10 owner-submitted Instagram intake. Role intentionally unassigned until a broader independent body of work is reviewed.",
  }),
  "whenintampa": Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 reviewed venue association from the 2026-09-10 owner-submitted Instagram intake. Role intentionally unassigned until a broader independent body of work is reviewed.",
  }),
  // ── 2026-09-23 — added with the Estefani Ruiz intake (#1374, three verified spots) ──
  // provisional:true on purpose: three curated spots is not a corpus, and this
  // row exists so a creator rendering in the app is a decision on record rather
  // than an oversight. The archetype is not guessed from the handle -- all three
  // verified spots are restaurants (Latin Grill Tampa, Darna Mediterranean Grill
  // in Temple Terrace, Yamashiro Miami), so the axis is the MEAL. A provisional
  // row renders nothing publicly; revisit when the next batch lands.
  "estefani.ruizruiz": Object.freeze({
    summary: "Tampa Bay and Miami restaurant reels, one dish at a time.",
    archetype: "food_expert",
    provisional: true,
    evidence: "Three verified spots at intake: Latin Grill Tampa, Darna Mediterranean Grill (Temple Terrace) and Yamashiro Miami. All three are restaurants; three spots is not yet a pattern, so this stays provisional.",
  }),
});
