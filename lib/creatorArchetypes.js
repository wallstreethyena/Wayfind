...
export const ASSIGNMENTS = Object.freeze({
  ...
  "xandra.orlando": Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 spot (Dead Coconut Club: Harvest at Universal CityWalk). Insufficient evidence for a role.",
  }),
  ...
  cheatdayorlando: Object.freeze({
    archetype: null,
    provisional: true,
    evidence: "1 spot (Rosallie Le French Cafe, Winter Garden). Insufficient evidence for a role.",
  }),
