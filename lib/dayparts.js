...
const NIGHT_ORDER = ['augtober', 'tonight', 'trending', 'datenight', 'season', 'today', 'events', 'eat', 'chef', 'locals', 'drive', 'birthday', 'family', 'beach', 'break', 'breakfast', 'cindy', 'blog'];
...
export const DAYPARTS = {
  ...
  morning: {
    ...
    order: ['augtober', 'breakfast', 'trending', 'season', 'today', 'eat', 'cindy', 'chef', 'beach', 'birthday', 'family', 'drive', 'locals', 'break', 'datenight', 'tonight', 'events', 'blog'],
  },
  lunch: {
    label: 'Lunch', from: 11.5, to: 13,
    why: 'Fall in Florida leads, then a quick lunch and the afternoon.',
    order: ['augtober', 'break', 'trending', 'season', 'today', 'eat', 'beach', 'chef', 'cindy', 'family', 'birthday', 'locals', 'drive', 'events', 'tonight', 'datenight', 'breakfast', 'blog'],
  },
  afternoon: {
