...
const NIGHT_ORDER = ['tonight', 'trending', 'datenight', 'season', 'events', 'eat', 'augtober', 'chef', 'locals', 'drive', 'birthday', 'family', 'today', 'beach', 'break', 'breakfast', 'cindy', 'blog'];
...
export const DAYPARTS = {
  ...
  morning: {
    ...
    order: ['breakfast', 'trending', 'season', 'eat', 'cindy', 'augtober', 'chef', 'today', 'beach', 'birthday', 'family', 'drive', 'locals', 'break', 'datenight', 'tonight', 'events', 'blog'],
  },
  lunch: {
    label: 'Lunch', from: 11.5, to: 13,
    why: 'A thirty-minute lunch, then the beach if you have the afternoon.',
    order: ['break', 'trending', 'season', 'eat', 'beach', 'today', 'augtober', 'chef', 'cindy', 'family', 'birthday', 'locals', 'drive', 'events', 'tonight', 'datenight', 'breakfast', 'blog'],
  },
  afternoon: {
