...
export const DAYPARTS = {
  ...
  morning: {
    ...
    order: ['breakfast', 'trending', 'season', 'today', 'eat', 'best', 'birthday', 'beach', 'family', 'drive', 'gems', 'locals', 'break', 'datenight', 'tonight', 'events', 'blog'],
  },
  lunch: {
    label: 'Lunch', from: 11.5, to: 14,
    why: 'Food leads. Nothing that needs an evening.',
    order: ['eat', 'trending', 'season', 'break', 'best', 'birthday', 'locals', 'gems', 'today', 'family', 'beach', 'tonight', 'datenight', 'drive', 'events', 'breakfast', 'blog'],
  },
  afternoon: {
    label: 'Afternoon', from: 14, to: 17.5,
    why: 'Now first, then tonight becomes the question.',
    order: ['today', 'trending', 'season', 'best', 'birthday', 'eat', 'beach', 'family', 'locals', 'gems', 'drive', 'tonight', 'datenight', 'events', 'break', 'breakfast', 'blog'],
  },
  night: {
    label: 'Night', from: 17.5, to: 6,
    why: 'Tonight leads, with dinner right behind it.',
    order: ['tonight', 'trending', 'season', 'eat', 'datenight', 'events', 'best', 'locals', 'gems', 'drive', 'birthday', 'family', 'today', 'beach', 'break', 'breakfast', 'blog'],
  },
};
