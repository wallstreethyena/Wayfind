...
// Date Night is who you are going with. Reading them side by side is the whole
// evening in two tiles, and on a phone showing ~1.3 tiles it means the second
// swipe is the other half of the same question instead of a category jump.
// trending and season give up one place each; they still lead nowhere else and
// test-seasonal-picks holds the rule that seasonal may never lead any band.
const NIGHT_ORDER = ['tonight', 'datenight', 'trending', 'season', 'events', 'eat', 'augtober', 'chef', 'best', 'locals', 'gems', 'drive', 'birthday', 'family', 'today', 'beach', 'break', 'breakfast', 'cindy', 'blog'];
