...
const NIGHT_ORDER = ['tonight', 'trending', 'datenight', 'season', 'today', 'events', 'eat', 'augtober', 'chef', 'locals', 'drive', 'birthday', 'family', 'beach', 'break', 'breakfast', 'cindy', 'blog'];
...
export const DAYPARTS = {
  ...
  morning: {
    ...
    order: ['breakfast', 'trending', 'season', 'today', 'eat', 'cindy', 'augtober', 'chef', 'beach', 'birthday', 'family', 'drive', 'locals', 'break', 'datenight', 'tonight', 'events', 'blog'],
  },
  lunch: {
    label: 'Lunch', from: 11.5, to: 13,
    why: 'A thirty-minute lunch, then the beach if you have the afternoon.',
    order: ['break', 'trending', 'season', 'today', 'eat', 'beach', 'augtober', 'chef', 'cindy', 'family', 'birthday', 'locals', 'drive', 'events', 'tonight', 'datenight', 'breakfast', 'blog'],
  },
  afternoon: {
