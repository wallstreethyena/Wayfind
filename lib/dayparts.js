...
export const DAYPARTS = {
  ...
  afternoon: {
    ...
    why: 'Tickets for tonight, while they last — then where to go.',
    order: ['events', 'trending', 'season', 'tonight', 'datenight', 'today', 'best', 'augtober', 'chef', 'beach', 'family', 'gems', 'locals', 'drive', 'birthday', 'eat', 'cindy', 'break', 'breakfast', 'blog'],
  },
  night: {
