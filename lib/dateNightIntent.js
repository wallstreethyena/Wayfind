...
//
// A `deck` is the rail's quick promise. The site-wide contract now lives in
// scripts/check-rail-deck-copy.mjs: 5–8 words, one positive sentence, no count,
// no disclaimer, and short enough to remain one visual line.
export const DATE_NIGHT_RAIL_DEFS = [
  { id: "dinner", title: "Dinner", group: "dinner",
    deck: "Conversation-worthy rooms for an unhurried evening." },
  { id: "dessert", title: "Dessert", group: "dessert",
    deck: "The sweet stop that completes the night." },
  { id: "speakeasies", title: "Speakeasies", group: "nightlife",
    deck: "Hidden doors, low light, excellent drinks." },
  { id: "livemusic", title: "Live Music", group: "nightlife",
    deck: "Bands that carry the night." },
  { id: "clubs", title: "Clubs", group: "nightlife",
    deck: "High-energy rooms made for dancing." },
  { id: "together", title: "Things To Do Together", group: "together",
    deck: "Hands-on plans made for two." },
  { id: "beach", title: "Beach", group: "outdoor",
    deck: "Good weather puts sand on tonight's menu." },
  { id: "museums", title: "Museum", group: "outdoor",
    deck: "Beautiful indoor stops for unpredictable weather." },
  ...
  { id: "shopping", title: "Shopping", group: "shopping",
    deck: "A stylish browse before or after dinner." },
];
