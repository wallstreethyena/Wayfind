...
export const PHOTO_URI_VALIDATE_GRACE_MS = 6 * 60 * 60 * 1000;
// Once validated, trust the verdict for this long before asking again.
export const PHOTO_URI_REVALIDATE_MS = 24 * 60 * 60 * 1000;
...
// revalidation cadence, so a row we evict stops being replayed within a day.
export const PHOTO_REDIRECT_TTL_SECONDS = 60 * 60 * 24;
