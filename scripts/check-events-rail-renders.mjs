...
// RENDERED there. Every hop is where the last one broke.
{
  ...
  ok(/selRail\.id === "datenight" \|\| selRail\.id === "birthday" \|\| selRail\.id === "events"/.test(rail),
    "Date Night, Birthday, and Events own their answers and cannot fall through into generic venue place cards");
}
