...
const CHIP_BLOCK = [
  ...
  ["attractions", "beaches", "The Frog Pond North Redington Beach", ["breakfast_restaurant", "brunch_restaurant", "restaurant"], "breakfast_restaurant"],
...
const CHIP_KEEP = [
  ...
  ["food", "breakfast", "The Frog Pond North Redington Beach", ["breakfast_restaurant", "brunch_restaurant", "restaurant"], "breakfast_restaurant"],
