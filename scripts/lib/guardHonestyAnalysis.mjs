// scripts/lib/guardHonestyAnalysis.mjs — shared static-analysis engine behind
// scripts/check-guard-honesty.mjs (the meta-guard from the 2026-09-04
// guard-honesty audit) AND the audit's own census tooling, so the two never
// drift into answering slightly different questions about the same file.
//
