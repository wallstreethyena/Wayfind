...
if (!s.includes("Pick your mood")) fail("concise mood kicker copy missing");
if (s.includes('toplineLeft="What are you in the mood for?"')) fail("the retired long mood label returned");
if (s.includes("signals.map((signal)")) fail("local-culture signal chips returned to the compact guide card");
...
if (!s.includes("Show me the best matches")) fail("moment recommendation CTA missing");
...
if (!s.includes("linear-gradient(180deg,rgba(5,16,24,.08)")) fail("hero readability gradient missing");
if (!s.includes(".wf-intro-cta span{color:var(--wf-intro-accent)")) fail("brand-accent CTA treatment missing");
...
if (!s.includes("return greetingForHour(siteHourFloat())")) fail("live intelligence greeting missing");
