...
const proposal = read("docs/proposals/owned-library-no-rebuy-law.md");
ok(/# The owned library never re-buys/.test(proposal) && /lib\/ownedLibrary\.js/.test(proposal), "the owner law is recorded in the lane-safe proposal area and points to its executable contract");
