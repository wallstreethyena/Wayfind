...
//
//     node scripts/make-rail-art.mjs <source.png> <rail-id>
//
...
if (!src || !id) {
  console.error("usage: node scripts/make-rail-art.mjs <source.png> <rail-id>");
  process.exit(2);
}
...
for (const w of WIDTHS) {
  ...
  const resized = () => base.clone().resize(w, h, { fit: "cover", position: "centre", kernel: "lanczos3" });
