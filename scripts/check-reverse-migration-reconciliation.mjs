...
import { reconcileProduction } from './lib/migrationReconciliation.mjs';
...
try {
  ...
  console.log(`check-reverse-migration-reconciliation: OK — ${cases} real CLI exit-code controls, manifest and canary wiring passed`);
