...
{
  const now = new Date("2026-07-15T16:00:00Z"); // Wed Jul 15 2026
...
{
  const wed = new Date("2026-07-15T16:00:00Z"); // Wed Jul 15
...
{
  const sat = new Date("2026-07-18T16:00:00Z"); // Sat Jul 18
...
{
  const wed = new Date("2026-07-15T16:00:00Z");
