...
ok(!bn.includes("earn a commission"), "no inline commission disclosure renders with the tours (one footer disclosure plus one on true detail pages is the law now)");
