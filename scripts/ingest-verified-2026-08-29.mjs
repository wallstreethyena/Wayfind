 ...
 * never calls Google Places / Place Details / photo backfill. ADD rows
 * already carry a public ChIJ + coords in the batch. hold_google_id rows
 * (Meacham Urban Farm, The Dancing Goat Dairy, Fat Beet Farm Kitchen &
 * Bakery) write nothing — official address / OSM coords stay on the batch
 * until a real ChIJ is found on a public page. HOLDs write nothing:
 * Monarch Kitchen & Bar, Urban Brews & Creamery, Skinny Burger Food
 * Truck, The Founders Club. S.O.B. Burgers is already_in — no second
 * row, no invented two-beat.
 *
...
console.log(`\ningest-verified-2026-08-29 ${COMMIT ? "(COMMIT)" : "(DRY RUN)"} — Places API off\n`);
