...
assert.equal(stockRejected.places[0].photo, "/api/photo?ref=places%2Froost%2Fphotos%2Fexact&g=2&w=640", "event Stays must reject a shared stock URL and retain the place-bound ref");
