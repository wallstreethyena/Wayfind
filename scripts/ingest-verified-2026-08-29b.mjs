#!/usr/bin/env node
/**
 * ingest-verified-2026-08-29b — owner Florida pin batch (Gabe, 2026-08-29b).
 *
 ...
 * a ChIJ is copied from a public Maps share URL / OSM / official page /
 * the repo: SoFresh Lakewood Ranch, Mobius Sarasota, Icy-N-Spicy,
 * Belladukes Gourmet Market, Chicken Guy Cypress Creek, La Birra Bar
 * Coral Gables, Canelita Cheesecake Coral Gables, Canelita Cheesecake
 * Miami, Divilma Clermont. HOLDs write nothing: SoFresh Bradenton
 * (Coming Soon), Dirty Sara-Soda, Happy Hands World, Sloan's St.
 * Armands, Divilma Orlando. Earlier farm HOLDs stay on the 2026-08-29
 * batch.
 *
 *   node scripts/ingest-verified-2026-08-29b.mjs            # DRY RUN
 *   node scripts/ingest-verified-2026-08-29b.mjs --commit   # write wf_inventory
 */
...
console.log(`\ningest-verified-2026-08-29b ${COMMIT ? "(COMMIT)" : "(DRY RUN)"} — Places API off\n`);
