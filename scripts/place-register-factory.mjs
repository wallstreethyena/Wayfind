...
export const NOTABLE_SKIPS = [
  ...
  { name: "Weeki Wachee Springs State Park", why: "Viator attraction page has no park/mermaid tickets; river kayaks are Mary's Fish Camp, not the park" },
  { name: "The Ernest Hemingway Home and Museum", why: "tickets at the gate only; no bookable partner product" },
  { name: "Honeymoon Island State Park", why: "attraction listing only; Caladesi kayak must not inherit this card" },
  { name: "Yacht StarShip Cruises & Events", why: "Viator lists StarLite Majesty, wrong operator" },
  { name: "Silver Springs State Park Glass Bottom Boat Tours", why: "only glass-bottom kayak rentals; card asks for the boat. empty stays empty" },
  ...
  { name: "Tarpon Springs Sponge Docks", why: "nearby kayak title does not name Sponge Docks" },
  { name: "Siesta Beach", why: "mangrove kayaks do not name this beach card" },
  { name: "Lido Beach", why: "mangrove kayaks do not name this beach card" },
  { name: "Lido Key Beach", why: "mangrove kayaks do not name this beach card" },
  { name: "Pier 60", why: "nearby dolphin/jet-ski titles do not name Pier 60" },
  ...
  { name: "Everglades City Airboat Tours", why: "no product names this operator; Naples/Sawgrass airboats are other venues" },
