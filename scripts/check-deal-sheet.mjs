  ...
  "the coupon wallet renders exactly ONE data-driven venue thumb and no poster/artwork pipeline");
{
  ...
  for (const c of COUPONS) {
    ...
    const venueArt = c.venuePlaceId ? "/api/photo?place=" + encodeURIComponent(c.venuePlaceId) + "&g=2&w=800" : null;
  ...
  ok(D.dealArtwork({ venuePlaceId: "ChIJ6y2dx9g_w4gRWoZIRhLk-JI" }) === "/api/photo?place=ChIJ6y2dx9g_w4gRWoZIRhLk-JI&g=2&w=800",
  ...
  ok(D.dealArtwork({ image: "https://remote.example/x.jpg", venuePlaceId: "ChIJ6y2dx9g_w4gRWoZIRhLk-JI" }) === "/api/photo?place=ChIJ6y2dx9g_w4gRWoZIRhLk-JI&g=2&w=800",
