...
}
{
  ...
  ok(dn && /location\.assign\(/.test(dn[0]), "datenight tap navigates (location.assign)");
  ok(dn && /dateNightIntentHref\(/.test(dn[0]), "datenight tap builds the intent URL, not a generic list");
