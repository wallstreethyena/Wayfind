...
def markdown(report):
    ...
    lines = [
        ...
        "",
        "## Reviewed distinct venues",
        "",
        "These identity-matched pairs have sourced distinct-venue decisions. Changed names or categories return to review.",
        "",
        table(
            report["duplicates"].get("reviewed_distinct_pairs", []),
            ["left_id", "right_id", "reason", "reviewed_at", "sources"],
        ),
        "",
